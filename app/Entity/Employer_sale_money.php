...
class Employer_sale_money extends Model
{
//    use SoftDeletes;
//
...
//    protected $dates = ['deleted_at'];
    ...
    protected $table = 'employer_sale_money';
    ...
    public static function getMonthView($employer_id,$employe_id,$day_date_static)
    {
        $post_sale_money_model = new Employer_sale_money();
