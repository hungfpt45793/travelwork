...
class Voucher_sale_money extends Model
{
//    use SoftDeletes;
//
...
//    protected $dates = ['deleted_at'];
    ...
    protected $table = 'voucher_sale_money';
    ...
    public static function getMonthView($voucher_id,$employe_id,$day_date_static)
    {
        $post_sale_money_model = new Voucher_sale_money();
