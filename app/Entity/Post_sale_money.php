...
class Post_sale_money extends Model
{
//    use SoftDeletes;
//
...
//    protected $dates = ['deleted_at'];
    ...
    protected $table = 'post_sale_money';
    ...
    public static function getMonthView($post_id,$employe_id,$day_date_static)
    {
        $post_sale_money_model = new Post_sale_money();
