...
class EmployerSelectResponseController extends AdminController
{
    /**
    ...
    public function detail_feedback_employer(Request $request, $employer_select_response_id)
    {
        ...
        $list_response_cv = Employer_select_response_cv::select('employer_select_response_cv.*', 'employer_response_cv.employer_id', 'employer_response_cv.employee_id', 'employees.employee_name',
            ...
            ->orderBy('employer_select_response_cv.status_response', 'asc')
            ->paginate(20);
//        echo '<pre>';
//        print_r($employer_select_response);die;
    ...
    public function employer_feedback_coin($employer_response_cv_id, $cojn_view_profile)
    {
        ...
        $employer_select_response_id = Employer_select_response_cv::where('employer_response_cv_id', $response_cv->employer_response_cv_id)->value('employer_select_response_id');
        ...
        return redirect(route('detail_feedback_employer', ['employer_select_response_id' => $employer_select_response_id]))->with('success','Trả điểm cho NTD thành công');;
