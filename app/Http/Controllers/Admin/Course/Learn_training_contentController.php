...
class Learn_training_contentController extends AdminController
{
    ...
    {
       $list_training_content = Learn_training_content::select('*')->paginate(20);
        $list_training_content->appends(request()->query());
        return view('admin.course.training_content.list', compact('list_training_content'));
