...
class AdvisoryEmployeeController extends SiteStaffController
{
    ...
    public function index(Request $request)
    {
        ...
        $total_ntd = ResAdvisory::where('status_res',1)->pluck('id_res')->toArray();
        ...
        return view('staff_admin.advisory.employee_advisory', compact('res_ads','count'));
    }
    ...
    public function edit($id_res)
    {
        ...
        return view('staff_admin.advisory.edit_employee_advisory', compact('res','id_res','interactives'));
    }
    ...
    public function update(Request $request, $id_res)
    {
        ...
        return redirect(route('staff_advisory_employee.index'));
    }
