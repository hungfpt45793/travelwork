...
class TeacherStarController extends SiteController
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $insertTeacher = $star_teacher->insertGetId([
                'id_user' => $id_user,
...
//            echo $insertTeacher;die();
            return redirect()->back()->with('alert_star', 'Đánh giá  giáo viên thành công');
        } catch (\Exception $e) {
            return redirect()->back()->with('alert_star', 'Đánh giá  giáo viên thất bại');
        }
    }
