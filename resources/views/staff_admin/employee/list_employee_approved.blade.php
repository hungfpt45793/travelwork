...
@section('title', 'Danh sách ứng viên đã duyệt' )
                                ...
                                <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="lid_7">
                                                <p class="crop">{{ $employee->name }}</p>
                                            </td>
                                            <td class="lid_8">
                                            @if($employee->day_handling != null)
                                                <?php
                                                    $date=date_create($employee->day_handling);
                                                    echo date_format($date,"d/m/Y");
                                                ?>
                                            @else
                                                {{ '' }}
