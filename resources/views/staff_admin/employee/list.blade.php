                                        ...
                                        ?>
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="container-fluid">
                                                        {{-- trang thai uv đi làm --}}
                                                        <div class="form-group row">
                                                            <label class="col-md-3 control-label mb-0 mt-2 text-right">Trạng thái UV đi làm</label>
                                                            <div class="col-md-9">
                                                                <select name="status" class="select2 form-control">
                                                                    <option value="" @if(isset($_GET['status']) && $_GET['status']==="" )selected @endif>--Trạng thái--</option>
                                                                    <option value="0" @if(isset($_GET['status']) && $_GET['status']==="0") selected @endif>--Chưa đi làm--</option>
                                                                    <option value="1" @if(isset($_GET['status']) && $_GET['status']==="1") selected @endif>--Đã đi làm--</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        {{-- tim trang thai uv --}}
                                                        <div class="form-group row">
                                                            <label class="col-md-3 control-label mb-0 mt-2 text-right">Trạng thái UV</label>
                                                            <div class="col-md-9">
                                                                <select name="status_employee" class="select2 form-control">
                                                                    <option value="" @if(isset($_GET['status_employee']) && $_GET['status_employee']==="" )selected @endif>--Trạng thái--</option>
                                                                    <option value="0" @if(isset($_GET['status_employee']) && $_GET['status_employee']==="0") selected @endif>--Chưa duyệt--</option>
                                                                    <option value="1" @if(isset($_GET['status_employee']) && $_GET['status_employee']==="1") selected @endif>--Đã duyệt--</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        {{-- tim nam sinh --}}
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col" class="lid_5">
                                                <p style="width:70px"><i class="fas fa-cog"></i><button
                                            ...
                                            <td scope="col" class="lid_16">
                                                <p style="width:166px">Mức lương mong muốn<button
                                                        class="lockButton btn btn-sm btn-success" id="lid_16">L</button>
                                                </p>
                                            </td>
                                            <td scope="col" class="lid_17">
                                                <p style="width:62px">Địa chỉ<button
                                                        class="lockButton btn btn-sm btn-success" id="lid_17">L</button>
                                                </p>
                                            </td> -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="remove_clicked">
                                            ...
                                            <td class="lid_5">
                                                ...
                                                {{--</a>/--}}
                                                <a target="_blank" href="{{ route('staff_employee.show', $employee->employee_id) }}" class="text-danger a_click">CV</a>
                                            </td>
    ...
    $('.reload_cv').on('click', function() {
        ...
        $.ajax({
            ...
            'beforeSend': function() {
                ...
                $('.loading_cv').css('display', 'block');
                $('.loading_cv').css('position', 'absolute');
            },
            'success': function(res) {
                if (res.link_cv) {
                    let col_pdf = $('#detailEmployee .col_pdf');
