...
@section('title', 'Danh sách ứng viên chưa giao' )
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="modal fade" id="timkiem" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        ...
                                        //quân /huyện
                                        $array_district_get = isset($_GET['array_district']) ? $_GET['array_district'] : array();
                                        ...
                                        $district_id = isset($_GET['district_id']) ? $_GET['district_id'] : array();
                                        $career_category_id = isset($_GET['career_category_id']) ? $_GET['career_category_id'] : array();
                                        $business_id = isset($_GET['business_id']) ? $_GET['business_id'] : array();
                                        $salary_id_get = isset($_GET['salary_id']) ? $_GET['salary_id'] : '';
                                        ...
                                        ?>
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="container-fluid">
                                                       <input type="hidden" name="all" value="{{ isset($_GET['all']) ? $_GET['all'] : '' }}">
                                                        {{-- tim trang thai uv --}}
                                ...
                                <a href="{{ route('employee_no_task') }}"
                                    class="btn btn-sm btn-success mr-1 text-white">Làm tươi</a>
                                <a href="{{ route('employee_no_task') }}?all=true"
                                    class="btn btn-sm btn-success mr-1 text-white">Xem tất cả</a>
                                ...
                                <button type="submit" class="btn btn-sm btn-info un_approved_all_employee mr-1">Bỏ
                                    duyệt</button>
                                <button type="button" class="btn btn-sm btn-primary task_all" data-toggle="modal"
                                    data-target="">
                                    Giao việc
                                </button>
                                <div class="modal fade" id="task_all" role="dialog"
                                    aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Giao việc</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            ...
                                            <div class="modal-body">
                                                <?php
                                                    $staffs = \App\Entity\Staff::select(
                                                        'staff_name',
                                                        'staff_id',
                                                        'user_id'
                                                    )->get();
                                                ?>
                                                <select name="ajax_recipient_id" class="select22 form-control">
                                                ...
                                                <div class="form-group mt-2">
                                                    ...
                                                    <textarea class="form-control" name="ajax_note" id="ajax_note"
                                                        cols="30" rows="5">

                                                    </textarea>
                                                </div>
                                                <div class="form-group mt-2">
                                                    <label for="">Thời gian giao việc</label>
                                                    <?php  
                                                     $date = new DateTime();
                                                     $date->setTimezone(new DateTimeZone('GMT+7')); //Time Zone GMT+7
                                                     $dt= $date->format('Y-m-d\TH:i:s');
                                                    ?>
                                                    <input class="form-control" max="9999-12-31T00:00"
                                                        value="{{ $dt }}" type="datetime-local"
                                                        name="ajax_giver_day">
                                                </div>
                                                <div class="form-group mt-2">
                                                    <label for="">Hạn hoàn thành</label>
                                                    <input class="form-control" max="9999-12-31" value="" type="datetime-local"
                                                        name="ajax_finish_day">
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">Đóng</button>
                                                <button type="submit" class="btn btn-primary" id="button_task_all">Giao
                                                    việc</button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row mr-1">
                        <div class="col-md-12">
                                ...
                                <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col" class="lid_2">
                                                <p style="width:90px">Giao việc<button
                                            ...
                                            @endif
                                            <td scope="col" class="lid_18">
                                                <p style="width:250px">Email<button
                                                        class="lockButton btn btn-sm btn-success" id="lid_18">L</button>
                                                </p>
                                            </td>
                                            <td scope="col" class="lid_19">
                                                <p style="width:78px">Năm sinh<button
                                                        class="lockButton btn btn-sm btn-success" id="lid_19">L</button>
                                                </p>
                                            </td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr class="remove_clicked">
                                            ...
                                            <td class="lid_2 td_{{ $employee->employee_id }}">
                                                <button type="button"
                                                    class="btn btn-sm btn-{{ !empty($employee->task_detail_id) ? 'success' : 'primary' }} task_giver"
                                                    data-employee-id="{{ $employee->employee_id }}" data-toggle="modal"
                                                    data-target="#task_giver">
                                                    {{ !empty($employee->task_detail_id) ? 'Đã giao' : 'Giao việc' }}
                                                </button>
                                            </td>
                                            <td class="lid_3">
                                                <?php
                            ...
                            ?>
                                            ...
                                            <td class="lid_16 text-center lid_8">
                                                @if(!empty($employee->employee_image))
                                                <i class="fas fa-check-circle text-success"></i>
                                                @endif
                                            </td>
                                            <td class="lid_9 employee_name">
                                                <p class="crop">{{ $employee->employee_name }}</p>
                                            </td>
                                            <td class="lid_10 custom_table_td_profile profile text-center">
                                                {{ round($employee->profile) }}%
                                            </td>
                                            <td class="lid_11 status_employee">
                                            ...
                                            <td class="lid_18">
                                                <p class="crop text-success">{{ $employee->email }}</p>
                                            </td>
                                            <td class="lid_19 text-center">
                                                <?php
...
<!-- modal giao viec -->
<div class="modal fade" id="task_giver"list role="dialog" aria-labelledby="exampleModalLongTitle"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('task_job') }}" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Giao việc</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <table class="task_giver_info table table-bordered">

                    </table>
                    <select name="recipient_id" class="select22 form-control">
                        @foreach($staffs as $staff)
                    ...
                    <div class="form-group mt-2">
                        <label for="">Ghi chú</label>
                        <textarea class="form-control" name="note" cols="30" rows="1">

                        </textarea>
                    </div>
                    <div class="form-group mt-2">
                        <label for="">Thời gian giao việc</label>
                        <input class="form-control" max="9999-12-31" value="{{ $dt }}" type="datetime-local"
                            name="giver_day">
                    </div>
                    <div class="form-group mt-2">
                        <label for="">Hạn hoàn thành</label>
