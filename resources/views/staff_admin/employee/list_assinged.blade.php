...
@section('title', 'Danh sách ứng viên được giao' )
                    ...
                    <div class="custom-order container-fluid">
                        ...
                        <div class="second-order row d-flex justify-content-between"
                            ...
                            <div class="col-xs-12">
                                ...
                                <a href="{{ route('employee_assigned') }}"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col" class="lid_3">
                                                <p style="width:50px">Loại<button
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="remove_clicked">
                                            ...
                                            <td class="lid_2 td_{{ $employee->employee_id }}">
                                                <button type="button"
                                                    class="btn-sm btn btn-{{ !empty($employee->task_completed_id) ? 'success' : 'primary' }} staff_report"
                                                    data-task-detail-id="{{ $employee->task_detail_id }}" data-toggle="modal"
                                                    data-target="#report">
                                                    {{ !empty($employee->task_completed_id) ? 'Đã báo cáo' : 'Báo cáo' }}
                                            ...
                                            <td class="lid_3 employee_name">
                                            @if(!empty($employee->removed) && $employee->removed == 1)
                                                    <button class="btn-sm btn btn-warning">
                                                    loại
                                                    </button>
                                                @endif
                                            </td>
                                            <td class="lid_4 employee_name">
                                            ...
                                            <td class="lid_8 custom_table_td_profile profile text-center">
                                                {{ round($employee->profile) }}%
                                            </td>
                                            <td class="lid_9 status_employee">
                                            ...
                                            <td class="lid_10 text-center">
                                                <?php
                                                    $updated_at=date_create($employee->updated_at);
                                                    echo date_format($updated_at,"d/m/Y");
                                                ?>
                                            </td>
                                        </tr>
                                        @endforeach
...
<!-- modal bao cao -->
<div class="modal fade" id="report" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('task_completed_job') }}" method="POST">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <select name="removed" class="form-control select22">
                            <option value="0">Không loại</option>
                    ...
                    <input type="hidden" name="task_detail_id">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
