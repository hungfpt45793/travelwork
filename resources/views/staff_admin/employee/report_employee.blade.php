                ...
                <div class="contentJobsInteresting  col-f14 ">
                    ...
                    <div class="custom-order">
                        ...
                        <div class="d-flex justify-content-start second-order">
                            ...
                            <a href="{{ route('staff_employee.index') }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="locker" data-fl-scrolls class="custom-table table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                <div class="lockedWrap lockedWrap-first">
                                    ...
                                    <input type="hidden" name="career_category_id" value="{{ (isset($_GET['career_category_id'])) ? $_GET['career_category_id'] : '' }}">
                                    <input type="hidden" name="salary_id" value="{{ (isset($_GET['salary_id'])) ? $_GET['salary_id'] : '' }}">
                                    ...
                                    <input type="hidden" name="status_employee" value="{{ (isset($_GET['status_employee'])) ? $_GET['status_employee'] : '' }}">
                                </div>
                            </div>
                            </form>
