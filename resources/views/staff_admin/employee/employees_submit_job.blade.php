                ...
                <div class="contentJobsInteresting  col-f14 ">
                    ...
                    <div class="custom-order">
                        <div class="custom-paginate first-order row mt-1 ml-1">
                            ...
                            | xem 1-{{ isset($_GET['num']) ? $_GET['num'] : '30' }}/{{ $employees_submit->total() }} bản ghi
                        </div>
                        <div class="d-flex justify-content-start second-order">
                            ...
                            <a href="{{ route('staff_employee_submit_job') }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a>
                                ...
                                <table  data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col" class="lid_3"><p style="width:150px">Ứng viên<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                            <td scope="col" class="lid_4"><p style="width:101px">Số điện thoại<button class="lockButton btn btn-sm btn-success" id="lid_4">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:250px">Email<button class="lockButton btn btn-sm btn-success" id="lid_5">L</button></p></td>
                                            <td scope="col" class="lid_6"><p>Hồ sơ<button class="lockButton btn btn-sm btn-success" id="lid_6">L</button></p></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($employees_submit as $employee)
                                        <tr>
                                            ...
                                            <td class="lid_3"><p class="crop"><a target="_blank" href="{{ route('staff_employee_edit_form',$employee->employee_id) }}">{{ $employee->employee_name }}</a></p></td>
                                            <td class="lid_4">{{ $employee->phone }}</td>
                                            <td class="lid_5">{{ $employee->email }}</td>
                                            <td class="lid_6">
                                                <a href="{{ route('list_staff_employee_submit_job',['employee_id'=> $employee->employee_id]) }}">
                                                    <button class="btn btn-primary btn-sm"><i class="fa fa-newspaper-o" aria-hidden="true"></i>
                                                    Tin (<span>
                                                            <?php
                                                            $total = 0;
                                                            $total = \App\Entity\Employee_submit_job_faacebook::get_total_employer_submit($employee->employee_id);
                                                            echo $total;
                                                            ?>
                                                        </span>)
                                                    </button>
