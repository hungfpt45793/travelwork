                ...
                <div class="contentJobsInteresting  col-f14 ">
                    ...
                    <div class="custom-order">
                        ...
                        <div class="d-flex justify-content-between second-order" style="width:-webkit-fill-available">
                            ...
                            <a href="{{ route('order_sales_statistics_staff') }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a>
                        ...
                        <div class="col-md-12">
                            <div id="locker" data-fl-scrolls class="custom-table table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                ...
                                <table  data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                    <thead>
                                        <tr>
                                            <td scope="col" class="lid_1"><p style="width:95px">ID đơn hàng<button class="lockButton btn btn-sm btn-success" id="lid_1">L</button></p></td>
                                            <td scope="col" class="lid_3"><p style="width:500px">Khóa học<button class="lockButton btn btn-sm btn-success" id="lid_1">L</button></p></td>
                                            <td scope="col" class="lid_4"><p style="width:200px">Hình thức học<button class="lockButton btn btn-sm btn-success" id="lid_2">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:160px">Giá khóa học(lúc mua)<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                            <td scope="col" class="lid_6"><p style="width:145px">Chiết khấu ứng viên<button class="lockButton btn btn-sm btn-success" id="lid_5">L</button></p></td>
                                            <td scope="col" class="lid_7"><p style="width:145px">Chiết khấu giáo viên<button class="lockButton btn btn-sm btn-success" id="lid_6">L</button></p></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($list_order as $order)
                                        <tr>
                                            <td scope="row" class="lid_1 text-center">{{ $order->course_order_id }}</td>
                                            ...
                                            <td class="lid_5 text-center">
                                                {{ !empty($order->course_cost) ? number_format($order->course_cost, 0, ',', '.') : 0 }} VNĐ
                                            </td>
                                            <td class="lid_5 text-center">
                                                {{ !empty($order->course_price_employee) ? number_format($order->course_price_employee, 0, ',', '.') : 0 }} VNĐ
                                            </td>
                                            <td class="lid_5 text-center">
                                                {{ !empty($order->course_price_teacher) ? number_format($order->course_price_teache, 0, ',', '.') : 0 }} VND
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
