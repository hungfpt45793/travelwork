                ...
                <div class="contentJobsInteresting  col-f14 ">
                    ...
                    <div class="custom-order">
                        <div class="custom-paginate first-order ml-1 mt-1 row">
                            ...
                            | xem 1-{{ isset($_GET['num']) ? $_GET['num'] : '30' }}/{{ $list_order->total() }} bản ghi
                        </div>
                                                ...
                                                <div class="modal-body">
                                                    <div class="container-fluid">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 control-label mb-0 mt-2 text-right">Trạng thái đơn hàng</label>
                                                            <div class="col-md-9">
                                                                <select class="form-control select2" name="course_order_status">
                                                                    <option value="" selected>-- Trạng thái đơn hàng --</option>
                                                                    <option value="0" @if($course_order_status == '0') selected @endif>-- Chưa thanh toán --</option>
                                                                    <option value="1" @if($course_order_status == '1') selected @endif>-- Đã thanh toán --</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" value="{{ !empty($activation_code) ? $activation_code : '' }}" name="activation_code" placeholder="Mã kích hoạt khóa học...">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" value="{{ !empty($course_title) ? $course_title : '' }}" name="course_title" placeholder="Tên khóa học..." >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-md-12">
                            <div id="locker" data-fl-scrolls class="custom-table table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                <div class="lockedWrap lockedWrap-first">
                                    ...
                                    @foreach ($list_order as $employee)
                                    <div class="cellWrap">
                                ...
                                <table  data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col" class="lid_2"><p style="width:85px">Thao tác<button class="lockButton btn btn-sm btn-success" id="lid_9">L</button></p></td>
                                            ...
                                            <td scope="col" class="lid_4"><p style="width:150px">Ứng viên giới thiệu<button class="lockButton btn btn-sm btn-success" id="lid_2">L</button></p></td>
                                            ...
                                            <td scope="col" class="lid_6"><p style="width:100px">Giá khóa học<button class="lockButton btn btn-sm btn-success" id="lid_5">L</button></p></td>
                                            <td scope="col" class="lid_7"><p style="width:140px">Trạng thái khóa học<button class="lockButton btn btn-sm btn-success" id="lid_6">L</button></p></td>
                                            <td scope="col" class="lid_8"><p style="width:450px">Thông tin user đăng ký<button class="lockButton btn btn-sm btn-success" id="lid_7">L</button></p></td>
                                            <td scope="col" class="lid_9"><p style="width:150px">Mã kích hoạt<button class="lockButton btn btn-sm btn-success" id="lid_8">L</button></p></td>
                                            <td scope="col" class="lid_10"><p style="width:105px">Admin<button class="lockButton btn btn-sm btn-success" id="lid_9">L</button></p></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($list_order as $order)
                                        <tr>
                                            <td scope="row" class="lid_1">{{ $order->course_order_id }}</td>
                                            <td class="lid_3">
                                                <div class="dropdown show">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <a class="dropdown-item" href="{{ route('courseOrder.edit',['course_order_id'=> $order->course_order_id]) }}">Sửa</a>
                                                        <a class="dropdown-item" href="{{ route('courseOrderDestroy',['course_order_id'=> $order->course_order_id]) }}">Xóa</a>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="lid_5 text-center">
                                                ...
                                                @endphp
                                                <span class="crop">
                                                    {{ !empty($employee->employee_id) ? $employee->employee_id : '' }} - {{ !empty($employee->employee_name) ? $employee->employee_name : '' }}
                                                </span>
                                            </td>
                                            <td class="lid_2">
                                                @php
                                            ...
                                            <td class="lid_6 text-center">
                                                {{ !empty($order->course_cost) ? number_format($order->course_cost, 0, ',', '.') : '' }} VNĐ
                                            </td>
                                            <td class="lid_7 text-center">
                                            ...
                                            <td class="lid_8">
                                                <span class="crop">
                                                    Họ và tên: {{ !empty($order->course_name) ? $order->course_name : '' }} - {{ !empty($order->course_phone) ? $order->course_phone : '' }} - {{ !empty($order->course_email) ? $order->course_email : '' }}
                                                </span>
                                            </td>
                                            <td class="lid_9 text-center">
                                                <span class="crop">
