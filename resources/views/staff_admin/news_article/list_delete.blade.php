...
@section('title', 'Danh sách bài viết xóa' )
                                    ...
                                    <div class="modal fade" id="timkiem" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog custom-modal-dialog modal-dialog-centered" role="document">
                                            ...
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Tìm kiếm bài viết xóa</h5>
                                ...
                                <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                        <thead>
                                            <tr>
                                                ...
                                                <td scope="col " class="lid_8"><p style="width:100px">Thao tác<button class="lockButton btn btn-sm btn-success" id="lid_8">L</button></p></td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="lid_8" scope="col ">
                                                    <a href="{{ route('delete_hard_post', $post->post_id) }}" onclick="confirm('Bạn chắc chắn muốn xóa!')" class="btn btn-sm btn-danger">Xóa</a>
                                                    <a href="{{ route('reset_post', $post->post_id) }}" class="btn btn-sm btn-success">RS</a>
                                                </td>
