...
<div class="container-fluid">
    <div class="row row-content">
        ...
        <div class="col-xl-9 col-lg-9 col-md-12 d-THScontent createProfileOnline col-content">
            <section class="jobsInteresting bgrWhite bdLightGray radius5 ">
                <div class="contentJobsInteresting col-f14 ">
                    <h5 class="text-info">Danh sách chương của khóa học : {{ $course->course_code }} - {{ $course->course_title }}</h5>
                    <div class="row ">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-start">
                                ...
                                {{-- <a href="{{ route('course_chapter_staff', $course->course_id) }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a> --}}
                                ...
                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-xl">Thêm mới chương cho khóa học</button>
                                <div class="modal fade" id="modal-xl">
                                    <div class="modal-dialog modal-xl">
                                        <form role="form" action="{{ route('store_course_chapter_staff') }}" method="POST">
                                            {!! csrf_field() !!}
                                            <div class="modal-content">
                                                <div class="modal-header">
                                    ...
                                    <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                        <thead>
                                            <tr>
                                                ...
                                                <td scope="col" class="lid_3"><p>Mô tả<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                                <td scope="col" class="lid_4"><p style="width:145px">Danh sách nội dung<button class="lockButton btn btn-sm btn-success" id="lid_4">L</button></p></td>
                                                <td scope="col" class="lid_5"><p style="width:135px">Trạng thái chương<button class="lockButton btn btn-sm btn-success" id="lid_5">L</button></p></td>
                                                <td scope="col" class="lid_5"><p style="width:91px">Thao tác<button class="lockButton btn btn-sm btn-success" id="lid_5">L</button></p></td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="lid_1">
                                                    {{ $chapter->course_chapter_id }}
                                                </td>
                                                <td class="lid_2 crop">
                                                    {{ $chapter->course_chapter_name }}
                                                </td>
                                                <td class="lid_3 crop">{{ $chapter->course_chapter_descript }}</td>
                                                <td class="lid_4 text-center">
                                                    <a href="{{ route('list_chapters_staff',['course_chapter_id'=> $chapter->course_chapter_id]) }}">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('delete_course_chapter_staff',['course_chapter_id'=> $chapter->course_chapter_id]) }}"
        ...
        <div class="modal fade" id="modal_{{$chapter->course_chapter_id}}">
            <div class="modal-dialog modal-xl">
                <form role="form" action="{{ route('update_course_chapter_staff') }}" method="POST">
                    {!! csrf_field() !!}
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <label style="margin-left: 20px">
                                    <input type="radio" name="course_chapter_status" value="1" checked=""
