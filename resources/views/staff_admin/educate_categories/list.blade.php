                ...
                <div class="contentJobsInteresting  col-f14 ">
                    ...
                    <div class="custom-order">
                        <div class="custom-paginate first-order ml-1 mt-1 row">
                            ...
                            | xem 1-{{ isset($_GET['num']) ? $_GET['num'] : '30' }}/{{ $educate_categories->total() }} bản ghi
                        </div>
                        <div class="d-flex justify-content-between second-order" style="width:-webkit-fill-available">
                            ...
                            <a href="{{ route('educateCategories.index') }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a>
                            <a href="{{ route('educateCategories.create') }}" class="btn btn-sm btn-success mr-1 text-white">Thêm mới</a>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div id="locker" data-fl-scrolls class="custom-table table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                <div class="lockedWrap lockedWrap-first">
                                    ...
                                    @foreach ($educate_categories as $employee)
                                    <div class="cellWrap">
                                ...
                                <table  data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col" class="lid_3"><p style="width:180px">Tiêu đề<button class="lockButton btn btn-sm btn-success" id="lid_1">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:400px">Mô tả<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:100px">User tạo<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:75px">Ngày tạo<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($educate_categories as $categorie)
                                        <tr>
                                            <td scope="row" class="lid_1">{{ $categorie->edu_cate_id }}</td>
                                            <td class="lid_3">
                                                <div class="dropdown show">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <a class="dropdown-item" href="{{ route('educateCategories.edit',['edu_cate_id'=>$categorie->edu_cate_id]) }}">Sửa</a>
                                                        <a href="{{ route('educateCategoriesDestroy',['edu_cate_id'=> $categorie->edu_cate_id]) }}"
                                            ...
                                            <td class="lid_8">
                                                {{ $categorie->edu_cate_title }}
                                            </td>
                                            <td class="lid_8">
                                                {{ $categorie->edu_cate_des }}
                                            </td>
                                            <td class="lid_8">
                                                <?php
