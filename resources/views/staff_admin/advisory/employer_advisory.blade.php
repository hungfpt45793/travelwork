...
@section('title', 'Danh sách ntd đăng ký tư vấn' )
            ...
            <section class="jobsInteresting bgrWhite bdLightGray radius5 ">
                <div class="contentJobsInteresting  col-f14 ">
                    <div class="d-flex justify-content-start">
                                    ...
                                    <div class="form-row employee-search ">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <?php $name = !empty($_GET['name_search']) ? $_GET['name_search'] : '';
                                                    ?>
                                                <input type="text " placeholder="Họ và tên" class="form-control" value="{{ isset($_GET['name_search'])  ? $name : '' }}" name="name_search">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <?php $email = !empty($_GET['email_search']) ? $_GET['email_search'] : '';
                                                    ?>
                                                <input type="text " placeholder="Email" class="form-control" value="{{ isset($_GET['email_search'])  ? $email : '' }}" name="email_search">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group form-check">
                                                ...
                                                <input class="form-check-input" type="checkbox" {{ ( isset($_GET['not_interactive']) ) ? 'checked' : '' }} name="not_interactive"> NTD chưa tương tác
                                                </label>
                                            </div>
                                        </div>
                                      </div>
                        ...
                        <a  class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-lock text-warning"></i> Khóa cột</a>
                        <a href="{{ route('staff_advisory_employer.index') }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a>
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="table-wrapper tableFixHead" style="padding-bottom:100px;overflow-x:auto;">
                                <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                    <thead>
                                        <tr>
                                            <td scope="col" class="lid_1"><p style="width:55px">TT<button class="lockButton btn btn-sm btn-success" id="lid_1">L</button></p></td>
                                            <td scope="col" class="lid_7"><p style="width:55px">id<button class="lockButton btn btn-sm btn-success" id="lid_7">L</button></p></td>
                                            <td scope="col" class="lid_2"><p style="width:75px">Ngày LH<button class="lockButton btn btn-sm btn-success" id="lid_2">L</button></p></td>
                                            <td scope="col" class="lid_3"><p style="width:160px;"> Họ và tên<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                            <td scope="col" class="lid_4"><p style="width:90px">SĐT<button class="lockButton btn btn-sm btn-success" id="lid_4">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:250px">Email<button class="lockButton btn btn-sm btn-success" id="lid_5">L</button></p></td>
                                            <td scope="col" class="lid_17"><p style="width:260px">Nội dung liên hệ<button class="lockButton btn btn-sm btn-success" id="lid_7">L</button></p></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="lid_1">
                                                <a class="text-dark" href="{{ route('staff_advisory_employer.edit', ['id_res' => $res->id_res]) }}">
                                            ...
                                            <td class="lid_7"> <a class="text-dark" href="{{ route('staff_advisory_employer.edit', ['id_res' => $res->id_res]) }}">{{ $res->id_res }}</a></td>
                                            {{-- <td>
                                                <div class="button-group">
                                                    <button type="button" class="btn btn-sm btn-info dropdown-toggle">Thao tác</button>
                                                    <div class="button-dropdown">
                                                        <a href="{{ route('staff_advisory_employer.edit', ['id_res' => $res->id_res]) }}">Sửa</a>
                                                        <a  href="{{ route('staff_advisory_employer.destroy', ['id_res' => $res->id_res]) }}" class="btn btn-sm btn-danger btnDelete" data-toggle="modal" data-target="#myModalDelete" onclick="return submitDelete(this);">
                                                            Xóa
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="lid_3">
                                                    <p class="crop" style="width:160px">{{ $res->name_res }}</p>
                                            </td>
                                            <td class="lid_4">
                                                {{ $res->phone_res }}
                                            </td>
                                            ...
                                            <td class="lid_17">
                                                @php
                                                    ...
                                                    $replace = array('<p>','</p>','<h2>','<h1>','<h3>','<h4>','<h5>','<h6>','</h2>','</h1>','</h3>','</h4>','</h5>','</h6>');
                                                    $text =  str_replace($replace,'',$text);
                                                @endphp
                                              <p class="crop" style="width:260px">
                                                   {!! $text !!}
                                                </p>
                                            </td>
