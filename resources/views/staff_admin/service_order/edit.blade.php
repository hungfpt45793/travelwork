                    ...
                    <div class="row p-3">
                        <div class="col-md-12 col-12">
                            ...
                            {!! csrf_field() !!}
                                <div class="row">
                                    <div class="col-12">
                                        <input type="hidden" value="1" name="type_order">
                                        <input type="hidden" value="{{$service_order->service_order_id}}" name="order_id">
                            ...
                            <div class="table-responsive" style="padding-bottom: 20px;">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                    @php
                                    $order_interactives = App\Entity\Order_interactive::where('type_order', 1)->where('order_id', $service_order->service_order_id)->get();
                                    @endphp
                            ...
                            <form action="{{ route('staff_service_order.update', $service_order->service_order_id) }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="form-group">
                                    ...
                                    <select name="service_price_id" class="select22 form-control" id="service_price_id">
                                        ...
                                        <option value="{{ $service_price->service_price_id }}"
                                            {{ ($service_order->service_price_id==$service_price->service_price_id) ? 'selected' : '' }}
                                ...
                                <div class="form-group">
                                    <label for="service_table_price_id">Chọn tất cả gói dịch vụ</label>
                                    <select name="service_table_price_id" class="select22 form-control" id="service_table_price_id">
                                        ...
                                        <option value="{{ $service_table_price->service_table_price_id }}"
                                            {{ ($service_order->service_table_price_id==$service_table_price->service_table_price_id) ? 'selected' : '' }}
                                            >
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="select22 form-control" id="status">
                                        ...
                                        <option value="0" {{ ($service_order->status==0) ? 'selected' : '' }} >Chưa TT</option>
                                        <option value="1" {{ ($service_order->status==1) ? 'selected' : '' }} >Đã TT</option>
                                    </select>
                                </div>
                                {{-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="service_order_content" class="editor" name="service_order_content" cols="80"
                                        rows="10">
                                          {{ old('service_order_content', $service_order->service_order_content ?? '') }}  </textarea>
                                </div>
