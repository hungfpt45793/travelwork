                ...
                <div class="contentJobsInteresting  col-f14 ">
                    ...
                    <div class="custom-order">
                        <div class="custom-paginate first-order ml-1 mt-1 row">
                            ...
                            | xem 1-{{ isset($_GET['num']) ? $_GET['num'] : '30' }}/{{ $course_questions->total() }} bản ghi
                        </div>
                        <div class="d-flex justify-content-between second-order" style="width:-webkit-fill-available">
                            ...
                            <a href="{{ route('courseQuestions.index') }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a>
                        ...
                        <div class="col-md-12">
                            <div id="locker" data-fl-scrolls class="custom-table table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                <div class="lockedWrap lockedWrap-first">
                                    ...
                                    @foreach ($course_questions as $employee)
                                    <div class="cellWrap">
                                ...
                                <table  data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col" class="lid_3"><p style="width:135px">Ứng viên bình luận<button class="lockButton btn btn-sm btn-success" id="lid_1">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:300px">Nội dung bình luận<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:500px">Khóa học bình luận<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:142px">Trạng thái bình luận<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($course_questions as $questions)
                                        <tr>
                                            <td scope="row" class="lid_1">{{ $questions->course_comments_id }}</td>
                                            <td class="lid_3">
                                                <div class="dropdown show">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <a class="dropdown-item" href="{{ route('courseQuestions.edit',['course_comments_id'=>$questions->course_comments_id]) }}">Sửa</a>
                                                        <a href="{{ route('courseQuestionsDestroy',['course_comments_id'=> $questions->course_comments_id]) }}"
                                            ...
                                            <td class="lid_8">
                                                <span style="width: 300px">
                                                    {!! $questions->course_comments_content !!}
                                                </span>
                                            </td>
                                            <td class="lid_8">
                                                <span class="crop">
                                                    {{ $questions->course_title }}
                                                </span>
                                            </td>
                                            <td class="lid_8 text-center">
                                                @if ($questions->course_comments_status == 0)
                                                    Ẩn bình luận
                                                @else
                                                    Hiện bình luận
                                                @endif
