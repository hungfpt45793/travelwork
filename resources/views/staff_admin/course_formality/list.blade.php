...
<div class="container-fluid">
    <div class="row row-content">
                ...
                <div class="contentJobsInteresting  col-f14 ">
                    ...
                    <div class="custom-order">
                        <div class="custom-paginate first-order ml-1 mt-1 row">
                            ...
                            | xem 1-{{ isset($_GET['num']) ? $_GET['num'] : '30' }}/{{ $list_course_formality->total() }} bản ghi
                        </div>
                        <div class="d-flex justify-content-between second-order" style="width:-webkit-fill-available">
                            ...
                            <a href="{{ route('courseFormality.index') }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a>
                            <button data-toggle="modal" data-target="#modal-xl" class="btn btn-sm btn-success mr-1 text-white">Thêm mới</button>
                            <div class="modal fade" id="modal-xl">
                                <div class="modal-dialog modal-lg">
                                    <form role="form" action="{{ route('courseFormality.store') }}" method="POST">
                                        {!! csrf_field() !!}
                                        <div class="modal-content">
                                            <div class="modal-header">
                        ...
                        <div class="col-md-12">
                            <div id="locker" data-fl-scrolls class="custom-table table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                <div class="lockedWrap lockedWrap-first">
                                    ...
                                    @foreach ($list_course_formality as $employee)
                                    <div class="cellWrap">
                                ...
                                <table  data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col" class="lid_3"><p style="width:100px">Tiêu đề<button class="lockButton btn btn-sm btn-success" id="lid_1">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:100px">Mô tả<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($list_course_formality as $formality)
                                        <tr>
                                            <td scope="row" class="lid_1">{{ $formality->course_formality_id }}</td>
                                            <td class="lid_3">
                                                <div class="dropdown show">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <a class="dropdown-item" data-toggle="modal" data-target="#modal_{{$formality->course_formality_id}}">Sửa</a>
                                                        <a href="{{ route('courseFormalityDestroy',['course_formality_id'=> $formality->course_formality_id]) }}"
                                            ...
                                            <td class="lid_8">
                                                <span class="crop">
                                                    {{ $formality->course_formality_title }}
                                                </span>
                                            </td>
                                            <td class="lid_8">
                                                <span class="crop">
                                                    {{ $formality->course_formality_des }}
                                                </span>
                                            </td>
                                        </tr>
                                        @endforeach
        ...
        <div class="modal fade" id="modal_{{$formality->course_formality_id}}">
            <div class="modal-dialog modal-lg">
                <form role="form" action="{{ route('courseFormality.update',['course_formality_id'=> $formality->course_formality_id]) }}" method="POST">
                    {!! csrf_field() !!}
                    {{ method_field('PUT') }}
                    <div class="modal-content">
                        <div class="modal-header">
