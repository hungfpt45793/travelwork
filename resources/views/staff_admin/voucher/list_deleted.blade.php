                                ...
                                <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                    <thead>
										<tr>
											...
											<td class="lid_8"><p style="width:80px">Sửa<button class="lockButton btn btn-sm btn-success" id="lid_8">L</button></p></td>
									...
									<tbody>
										...
										<tr>
											...
											<td class="lid_8">
												<a href="{{ route('delete_voucher_hard', $voucher->id_voucher) }}">
                                                    <button type="button" class="btn btn-sm btn-danger">Xóa</button>
                                                </a>
                                                <a href="{{ route('staff_voucher_restore', $voucher->id_voucher) }}">
        ...
        $('.delete_all').on('click', function(e) {
            ...
            if(allVals.length <=0)
            {
                ...
                if(check == true){
                    ...
                    $.ajax({
                        url: '{{ route('delete_all_voucher_hard') }}',
                        type: 'DELETE',
