...
@section('title', 'Danh sách việc làm NTD thường' )
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            ...
                            <div class="d-flex justify-content-start">
                                ...
                                <a href="{{ route('staff_job_ntd_job_casual') }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a>
