...
@section('title', 'Danh sách việc làm NTD hết hạn' )
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            ...
                            <div class="d-flex justify-content-start">
                                ...
                                <a href="{{ route('staff_job_ntd_list_date_end') }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a>
                                ...
                                <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="lid_10"><p style="width: 104px;">TT<button class="lockButton btn btn-sm btn-success" id="lid_10">L</button></p></td>
