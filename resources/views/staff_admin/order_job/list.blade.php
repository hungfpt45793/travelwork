                                ...
                                <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="lid_3">
                                                <a href="{{ route('staff_order_job.edit', $order_job->order_job_id) }}"
                                                    class="btn btn-sm btn-primary">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <a href="{{ route('manager_order_job', $order_job->order_job_id) }}"
                                                    class="btn btn-sm btn-primary">
                                                    <i class="fas fa-tasks"></i>
                                                </a>
                                                <a href="{{ route('staff_order_job.destroy', $order_job->order_job_id) }}" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#myModalDelete" onclick="return submitDelete(this);">
