                ...
                <div class="contentJobsInteresting col-f14 ">
                    ...
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between second-order">
                            ...
                            <a href="{{ route('staff_teacher.create') }}" class="btn btn-success btn-sm mr-1 ">Thêm mới</a>
                            <button  type="button" class="btn mr-1 btn-sm btn-warning response" >Phản hồi</button>
                            <!-- <button  type="button" class="btn mr-1 btn-sm btn-danger delete_request">Đề nghị xóa</button> -->
                                ...
                                <form action="" class="">
                                    <div class="group-form border border-primary">
                                        <input class="border-0 input-lg" type="text"
                                            name="teacher_id" style="width:80px"
                                            value="{{ (!empty($_GET['teacher_id'])) ? $_GET['teacher_id'] : ''  }}"
                        ...
                        <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                            <thead>
                                <tr>
                                    ...
                                    <td class="lid_2"><p style="width:75px">Thao tác<button class="lockButton btn btn-sm btn-success" id="lid_2">L</button></p></td>
                            ...
                            <tbody class="tbody">
                                ...
                                <tr>
                                    ...
                                    <td class="lid_2">
                                        <a class="btn btn-sm btn-primary" href="{{ route('interactive_index', ['teacher_id' => $teacher->teacher_id]) }}">thao tac</a>
                                    </td>
                                    <td class="lid_3">
        ...
        $('.delete_all').click(function(){
            ...
            if (x){
                ...
                if(Ids.length == 0){
                    ...
                    $.ajax({
                        type: 'post',
                        url: '{{route("staff_teacher_delete_all")}}',
                        data: 'Ids='+Ids,
                        success: function (data) {
                            if (data) {
                                changeHtml+= '<div class="col-12 col-xs-12 col-md-12 col-lg-12  pd-0 pd-t-15">';
