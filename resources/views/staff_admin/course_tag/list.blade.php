                ...
                <div class="contentJobsInteresting  col-f14 ">
                    ...
                    <div class="custom-order">
                        <div class="custom-paginate first-order ml-1 mt-1 row">
                            ...
                            | xem 1-{{ isset($_GET['num']) ? $_GET['num'] : '30' }}/{{ $list_tag->total() }} bản ghi
                        </div>
                        <div class="d-flex justify-content-between second-order" style="width:-webkit-fill-available">
                            ...
                            <a href="{{ route('courseTag.index') }}" class="btn btn-sm btn-secondary mr-1 text-white"><i class="fas fa-sync-alt text-success"></i> Làm tươi</a>
                            <a href="{{ route('courseTag.create') }}" class="btn btn-sm btn-success mr-1 text-white">Thêm mới</a>
                            </div>
                                ...
                                <table  data-fl-scrolls class="custom-table table-scroll table-bordered table-striped" style="overflow: scroll;height:100vh;display:block;table-layout:fixed;">
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col" class="lid_3"><p style="width:100px">Tên từ khóa<button class="lockButton btn btn-sm btn-success" id="lid_1">L</button></p></td>
                                            <td scope="col" class="lid_5"><p style="width:100px">Slug từ khóa<button class="lockButton btn btn-sm btn-success" id="lid_3">L</button></p></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($list_tag as $tag)
                                        <tr>
                                            <td scope="row" class="lid_1">{{ $tag->tag_id }}</td>
                                            <td class="lid_3">
                                                <div class="dropdown show">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <a class="dropdown-item" href="{{ route('courseTag.edit',['tag_id'=>$tag->tag_id]) }}">Sửa</a>
                                                        <a href="{{ route('courseTagDestroy',['tag_id'=> $tag->tag_id]) }}"
