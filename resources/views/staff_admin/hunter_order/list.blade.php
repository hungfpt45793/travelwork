                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            <div class="">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3 ">
                                                            <select class=" form-control select2"
                                                                name="hunter_regis_status">
                                                                <option value="">--Thanh toán--</option>
                                                                <option value="1"
                                                                    @if(isset($_GET['hunter_regis_status']) &&
                                                                    $_GET['hunter_regis_status']==1) selected @endif>Đã
                                                                    thanh toán</option>
                                                                <option value="2"
                                                                    @if(isset($_GET['hunter_regis_status']) &&
                                                                    $_GET['hunter_regis_status']==2) selected @endif>
                                                            ...
                                                            <div class="form-group form-check">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        {{ ( isset($_GET['not_interactive']) ) ? 'checked' : '' }}
                                                                        name="not_interactive"> Đơn hàng chưa tương tác
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <a href="{{ route('staff_hunter_order.index') }}"
                                ...
                                <div class="lockedWrap lockedWrap-first">
                                    ...
                                    <div class="cellWrap">
                                        <input type="checkbox" class="sub_chk"
                                            data-id="{{ $hunter_order->hunter_regis_code }}">
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                            <div class="tableFixHead" style="padding-bottom:100px;overflow-x:auto;">
                                <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped"
                                    ...
                                    <thead>
                                        <tr>
                                            <td class="lid_2">
                                                <p style="width:150px">TT<button
                                                        class="lockButton btn btn-sm btn-success" id="lid_2">L</button>
                                                </p>
                                            </td>
                                            <td class="lid_3">
                                                <p style="width:110px">Mã đơn đặt<button
                                            ...
                                            <td class="lid_9">
                                                <p style="width:80px">Chi phí<button
                                                        class="lockButton btn btn-sm btn-success" id="lid_9">L</button>
                                                </p>
                                            </td>
                                            <td class="lid_10">
                                                <p style="width:300px">Tên NTD<button
                                            ...
                                            <td class="lid_12">
                                                <p style="width:400px">Email NTD<button
                                        ...
                                        <tr>
                                            <td class="lid_2">
                                                <a class="btn btn-sm btn-primary"
                                                    href="{{ route('staff_hunter_order.edit',$hunter_order->hunter_regis_id ) }}">
                                                    Sửa
                                                </a>
                                                <?php
                                                    $order_request = \App\Entity\Order_request::where('hunter_regis_id', $hunter_order->hunter_regis_id)->first();
                                                    $order_job = \App\Entity\Order_job::where('hunter_regis_id', $hunter_order->hunter_regis_id)->first();
                                                    if(!empty($order_request)){
                                                        if(!empty($order_job)){
                                                            $status_order = 'Đã tạo ĐH';
                                                            $color = "btn-success";
                                                        }
                                                        else{
                                                            $status_order = 'Đã tạo YC';
                                                            $color = "btn-primary";
                                                        }
                                                    }
                                                    else{
                                                        if(!empty($order_job)){
                                                            ...
                                                            $status_order = 'Y/C ĐHàng';
                                                            $color = "btn-warning";
                                                        }
                                                    }
                                                ?>
                                                <a class="btn btn-sm {{$color}}"
                                                    href="{{ route('staff_create_order_request',$hunter_order->hunter_regis_id ) }}">
                                            ...
                                            <td class="lid_3">
                                                {{ $hunter_order->hunter_regis_code }}
                                            </td>
                                            <td class="lid_4">
                                                {{ date('d/m/Y', strtotime($hunter_order->created_at)) }}
                                            </td>
                                            <td class="lid_5">
                                            ...
                                            <td class="lid_7">
                                                <p class="crop" style="width:200pxpx">
                                                    {{ $hunter_order->hunter_pos_name }}</p>
                                            </td>
                                            <td class="lid_8">
                                                <p class="crop" style="width:110px">
                                                    {{ $hunter_order->hunter_time_name }}</p>
                                            </td>
                                            <td class="lid_9">
                                                <p class="crop" style="width:80px">
                                                    {{ $hunter_order->hunter_price_name }}</p>
                                            </td>
                                            <td class="lid_10">
                                                <p class="crop" style="width:300px">
                                                    {{ $hunter_order->hunter_regis_name }} </p>
                                                <p>
                                                   - MST : {{ !empty($hunter_order->hunter_tax_code) ? $hunter_order->hunter_tax_code : '' }}
                                                </p>
                                            </td>
                                            <td class="lid_11">
                                                <p class="crop" style="width:100px">
                                                    {{ $hunter_order->hunter_regis_phone }}</p>
                                            </td>
                                            <td class="lid_12">
                                                <p class="crop" style="width:400px">
                                                    {{ $hunter_order->hunter_regis_email }}</p>
                                            </td>
                                            <td class="lid_13">
                                                <p class="crop" style="width:500px">
                                                    {{ $hunter_order->hunter_regis_note }}</p>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
    ...
    $('.delete_all').on('click', function(e) {
        ...
        if (allVals.length <= 0) {
            ...
            if (check == true) {
                ...
                $.ajax({
                    url: '{{ route("delete_all_hunter_order") }}',
                    type: 'DELETE',
