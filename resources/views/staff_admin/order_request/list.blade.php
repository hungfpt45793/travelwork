                        ...
                        <div class="col-md-12">
                            <div class="">
                                ...
                                <a class="btn btn-sm btn-success mr-1 text-white"
                                    href="{{ route('staff_order_request.create') }}">Thêm mới</a>
                                ...
                                <a href="{{ route('staff_order_request.index') }}"
                                ...
                                <table data-fl-scrolls class="custom-table table-scroll table-bordered table-striped"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="lid_3">
                                                <p style="width:150px"><i class="fas fa-cog"></i><button
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="lid_3">
                                                <a href="{{ route('staff_create_order_job', $order_request->order_request_id) }}"
                                                    class="btn btn-sm btn-primary">
                                                    Tạo ĐH
                                                </a>
                                                <a href="{{ route('staff_order_request.edit', $order_request->order_request_id) }}"
                                                    class="btn btn-sm btn-primary">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <a href="{{ route('staff_order_request.destroy', $order_request->order_request_id) }}" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#myModalDelete" onclick="return submitDelete(this);">
