        ...
        <div class="row">
            ...
            @endif
                <div class="box">
                            ...
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-4">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        ?>
                                        <input type="text" style="height: 28px" placeholder="Tên việc làm"
                                               class="form-control" name="title" value="{{ $title_get }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="col-xs-12 col-md-12">
                            ...
                            <div class="row" style="margin-top: 15px">
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <select class="form-control select2" name="employer_id" aria-label="Quận/Huyện"
                                            ...
                                            @foreach($employer as $eplo)
                                                <option value="{{ $eplo->employer_id }}"
                                                        @if($employer_id_get == $eplo->employer_id ) selected @endif > {{ $eplo->enterprise_name }} </option>
                                            @endforeach
                                ...
                                <div class="col-md-4">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        ?>
                                        <input type="text" style="height: 28px" placeholder="Email nhà tuyển dụng"
                                ...
                                <div class="col-md-4">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        ?>
                                        <input type="text" style="height: 28px" placeholder="Mã tin"
                                               class="form-control" name="job_code" value="{{ $job_code_get }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-control select2" name="sale_money">
                                            ...
                                            <option value="0" @if($sale_money_get == '0') selected @endif>-- Không --
                                            </option>
                                            <option value="1" @if($sale_money_get == '1') selected @endif>-- Có--
                                            </option>  <option value="1" @if($sale_money_get == '2') selected @endif>-- Tam dừng--
                                            </option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div>
                        <a href="{{ route('update_job_code') }}"
                           style="color:#fff;background: orange;padding: 5px 10px;display: inline-block;margin-bottom: 10px"
                           class="btnOrang">Cập nhật mã tin</a>
                    </div>

                    <div>
                        <a href="{{ route('job.create') }}" style="color:#fff;background: orange;padding: 5px 10px"
                           class="btnOrang">Thêm mới việc làm NTD</a>
                    </div>
                            ...
                            @if(!empty($jobs))
                                @foreach($jobs as $job)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('job_detail',['slug'=> $job['slug']]) }}" target="_blank">Link </a>
                                        </td>
                                        <td>
                                            @if($job->sale_money == 0)
                                            ...
                                            @endif
                                                @if($job->sale_money == 2)
                                                    <span class="red" style="font-weight: bold">Tạm dừng</span>
                                                @endif
                                        </td>
                                        <td>
                                            <a href="{{ route('Job_delete_with_admin',$job->job_id) }}" class="btn btn-danger delete_job">
                                                Xóa
                                            </a>
                                            <a href="{{ route('Job_undelete_with_admin',$job->job_id) }}" class="btn btn-info undelete_job">
                                                Hủy
                                            </a>
                                        </td>
