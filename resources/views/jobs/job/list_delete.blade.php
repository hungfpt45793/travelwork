...
@section('title', 'Danh sách công việc đã xóa')
...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Việc làm đã xóa</a></li>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div>
                        <a href="{{ route('update_job_code') }}" style="color:#fff;background: orange;padding: 5px 10px;display: inline-block;margin-bottom: 10px" class="btnOrang">Cập nhật mã tin</a>
                    </div>
