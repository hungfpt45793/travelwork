                                ...
                                @foreach($jobFacebooks as $job)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                @if(!empty($empoyer['enterprise_name']))
                                                    {{ $empoyer['enterprise_name'] }}
                                                @else
                                                    Admin
                                                @endif
                                            </td>
                                        <td>
                                            @if(!empty($job['emailNTD']))
                                                {{ $job['emailNTD'] }}
                                                @else
                                                Admin
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('job-facebook.destroy',['job_facebook_id' => $job->job_facebook_id]) }}"
