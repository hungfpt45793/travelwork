                            ...
                            <div class="col-xs-6 col-md-2 col-lg-1">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                        <li><a href="{{ route('rose-setting.create') }}">Thêm cài đặt hoa hồng</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xs-6 col-md-2 col-lg-1">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                        <li><a href="{{ route('rose-setting.index') }}">Danh sách cài đặt hoa hồng</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
