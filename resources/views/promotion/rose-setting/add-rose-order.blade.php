...
@section('title', 'hoa hồng theo giá trị hóa đơn')

@section('content')
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            Hoa hồng theo giá trị hóa đơn
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Hoa hồng theo giá trị hóa đơn</a></li>
        </ol>
    </section>
                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Hoa hồng theo giá trị hóa đơn</h3>
                        </div>
                        <!-- /.box-header -->
