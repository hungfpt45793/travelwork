...
@section('title', 'Khuyến mại theo nhóm mã affiliate')

@section('content')
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            Khuyến mại theo nhóm mã affiliate
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Khuyến mại theo nhóm mã affiliate</a></li>
        </ol>
    </section>
                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Khuyến mại theo nhóm mã affiliate</h3>
                        </div>
                        <!-- /.box-header -->
