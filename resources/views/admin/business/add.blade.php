...
@section('title', 'Thêm mới nhóm loại hình kinh doanh')
...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <form role="form" action="{{ route('business.store') }}" method="POST">
                {!! csrf_field() !!}
                {{ method_field('POST') }}
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="business_type_name" placeholder="Loại hình kinh doanh" required>
                            </div>
                            <div class="form-group">
