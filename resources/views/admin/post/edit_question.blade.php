...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Chỉnh sửa câu hỏi và câu trả lời trong bài viết
            </br>
            {{ $post->title }}
        </h1>
        <p></p>
        <ul class="breadcrumb">
            ...
            <li class="active">Chỉnh sửa câu hỏi và câu trả lời trong bài viết</li>
        </ul>
    </section>
    ...
    <section class="content">
        <div class="row">
            <!-- form start -->
            <form role="form" action="{{ route('update_question') }}" method="POST">
                {!! csrf_field() !!}
                {{ method_field('POST') }}
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="question" placeholder="Tiêu đề" required value="{{ $post_question->post_ques }}">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Câu trả lời(thường nhập khoảng 2- 3 dòng)</label>
                                <textarea class="editor" id="content" name="answer" rows="10" cols="80"/>{!! $post_question->post_answer !!}</textarea>
                            </div>
                            <input type="hidden" name="post_id" value="{{ $post->post_id }}">
                            <input type="hidden" name="post_ques_id" value="{{ $post_question->post_ques_id }}">
