...
@section('title', 'Danh sách nhà tuyển dụng đã bị xóa')
...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="#">Danh sách đã bị xóa</a></li>
        </ol>
    </section>
                            ...
                            <table id="employers" class="table table-bordered table-striped">
                                ...
                                @foreach($employers as $employer)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('Employerestore', ['id' => $employer->user_id]) }}">
                                                <button class="btn btn-primary"><i class="fa fa-share xoayicon mgr5" aria-hidden="true"></i> Khôi phục</button>
                                            </a>
                                            <a  href="{{ route('EmployerForceDelete', ['id' => $employer->user_id]) }}" class="">
