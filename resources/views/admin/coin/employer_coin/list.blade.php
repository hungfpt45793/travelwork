                            ...
                            <tbody>
                                ...
                                @foreach($employers as $employer)
                                    <tr>
                                        ...
                                        <td style="width: 120px;text-align: left">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{ route('list_coin_employer',['employer_id'=>$employer->employer_id]) }}">Nạp xu</a></li>
                                                    <li><a href="{{ route('history_transaction_employer',['employer_id'=>$employer->employer_id]) }}">Lịch sử GD</a></li>
                                                    <li><a href="{{ route('history_employee_employer',['employer_id'=>$employer->employer_id]) }}">Hồ sơ UV đã xem</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td><img class="lazy" src="{{ isset($employer['image']) ? $employer['image'] : '' }}" width="50px;"></td>
                                        ...
                                        <td style="width: 120px;text-align: center">
                                            <span class="green">{{ isset($employer->total_employer_coin) ? number_format($employer->total_employer_coin) : '' }} xu</span>
                                        </td>
                                        <td style="width: 120px;text-align: center">
                                            <span class="red">{{ isset($employer->employer_coin) ? number_format($employer->employer_coin) : '' }} xu</span>
                                        </td>
