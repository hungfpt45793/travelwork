...
@section('title', ' Cập nhât xu  cho nhà tuyển dụng')
@section('content')

    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            Cập nhât xu  cho nhà tuyển dụng
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Cập nhât xu  cho nhà tuyển dụng</a></li>
    ...
    <section class="content">
        <div class="row">
            <!-- form start -->
            <form role="form" action="{{ route('update_coin_employer',['coin_money_id'=>$coin_money_employer->coin_money_id]) }}" method="POST">
                {!! csrf_field() !!}
                {{ method_field('POST') }}
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control formatPrice" name="coint_money" placeholder="Số tiền nạp" value="{{ $coin_money_employer->coint_money }}"  >
                                <!-- /.input group -->
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Số xu nhận được</label>
                                <input type="text" class="form-control formatPrice" name="coint" placeholder="Số xu nhận được" value="{{ $coin_money_employer->coint }}" >
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="w-100 editor" id="content_coin" name="coin_content">{!! isset($coin_money_employer->coin_content) ? $coin_money_employer->coin_content : '' !!}</textarea>
                                <!-- /.input group -->
                            </div>
