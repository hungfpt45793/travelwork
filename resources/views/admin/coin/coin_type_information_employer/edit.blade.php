...
@section('title', 'Chỉnh sửa '.$typeInformation->title )
...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <!-- form start -->
            <form role="form" action="{{ route('coin_type_information_employer.update', ['type_infor_id' => $typeInformation->type_infor_id]) }}" method="POST">
                {!! csrf_field() !!}
                {{ method_field('PUT') }}
