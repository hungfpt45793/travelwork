...
@section('title', 'Danh sách Cam kết gắn bó với công ty')
    ...
    <script>
        $(function() {
            $('#job_career').DataTable({
                ...
                serverSide: true,
                type: 'GET',
                ajax: '{{route('dt_type_com')}}',
                columns: [
                    { data: 'com_id', name:'com_id' },
                    { data: 'com_name', name:'com_name' },
                    { data: 'com_salary', name:'com_salary' },
                    { data: 'com_give', name:'com_give' },
