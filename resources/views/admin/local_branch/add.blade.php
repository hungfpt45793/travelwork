...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Thêm mới chi nhánh</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <!-- form start -->
            <form role="form" action="{{ route('local_branch.store') }}" method="POST">
                {!! csrf_field() !!}
                {{ method_field('POST') }}
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Tên chi nhánh">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="local_id" aria-label="" id="province">
                                    ...
                                    @foreach(\App\Entity\LocationArea::getAll() as $location)
                                        <option value="{{$location->local_id}}"
                                                {{ $location->local_id == old('province') ? 'selected' : '' }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="link" placeholder="Link tới website chi nhánh">
                            </div>
