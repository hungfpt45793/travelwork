...
@section('content')
    ...
    <section class="ListQuestionExam ListQuestionScroll content" id="ListQuestionExam" style="background: #fff">
        <div class="">
            <div class="row">
                <div class="col-lg-12">
                    <a href="{{ route('createQuestionAdmin',['id_exam' => $exam->id_exam]) }}?type=1" class="btnOrang mgTB10 dsInline" style="margin-bottom: 15px;"><i class="fa fa-plus mgRight5" aria-hidden="true"></i>Thêm
                        mới câu hỏi</a>
