...
@section('content')
    ...
    <section class="ListQuestionExam content" id="ListQuestionExam" style="background: #fff;">
        <div class="">
            <form role="form" action="{{ route('question.update',['id_ques' => $question->id_ques]) }}" method="POST"
                  class="formQuestion">
                {!! csrf_field() !!}
                {{ method_field('PUT') }}
                @if($type == 0)
                ...
                @if($type == 1)
                    <div class="row bg-white">
                        <div class="col-lg-12">
                            <h3 class="text-center f22 mgTop15  ">Sửa câu hỏi đúng sai</h3>
                        </div>
                        <div class="col-lg-6">
                            <div class="addQuestionZelo">
                                <div class="form-group">
                ...
                @if($type == 2)
                    <div class="row bg-white">
                        <div class="col-lg-12">
                            <h3 class="text-center f22 mgTop15  ">Sửa câu hỏi tự luận</h3>
                        </div>
                        <div class="col-lg-6">
                            <div class="addQuestionZelo">
                                <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="addQuestionZelo">
                                <div class="form-group  mgBottom0 pdTop0">
                                    ...
                                    <textarea rows="15" cols="50" name="correct_answer" class="w100 pd10" id="" style="padding: 10px;">{{ $question->correct_answer }}
                                    </textarea>
                                </div>
                            </div>
                        </div>
