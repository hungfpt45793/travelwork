...
@section('title', 'Thêm mới tuyển dụng thuê' )

@section('content')
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>
        Thêm mới tuyển dụng thuê
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row box">
        <div class="col-md-12">
            ...
            <form action="{{ route('service_hunter.store') }}" method="POST">
                {{ csrf_field() }}
                <div class="form-group">
                    <label for="service_hunter_name">Tiêu đề</label>
                    <input type="text" id="service_hunter_name" value="{{ old('service_hunter_name') }}" name="service_hunter_name" class="form-control">
                </div>
                <div class="form-group">
                    ...
                    <input name="service_hunter_image" type="hidden" />
                </div>
                <div class="form-group">
                    ...
                    <textarea id="service_hunter_info" class="editor" name="service_hunter_info" cols="80" rows="10">
                           {{ old('service_hunter_info') }} </textarea>
                </div>
                <div class="form-group">
                    ...
                    <textarea id="service_hunter_pay" class="editor" name="service_hunter_pay" cols="80" rows="10">
                        {{ old('service_hunter_pay') }}   </textarea>
                </div>
                <div class="form-group">
                    ...
                    <textarea id="service_hunter_fee" class="editor" name="service_hunter_fee" cols="80" rows="10">
                        {{ old('service_hunter_fee') }}    </textarea>
                </div>
                <div class="form-group">
                    ...
                    <textarea id="service_hunter_contact" class="editor" name="service_hunter_contact" cols="80" rows="10">
                        {{ old('service_hunter_contact') }}   </textarea>
                </div>
                <div class="form-group">
