...
@section('content')
    ...
    <section class="ListQuestionExam content" id="ListQuestionExam" style="background: #fff;">
        <div class="">
            <form role="form"
                  action="{{ route('create_question_content',['course_content_id'=>$course_content->course_content_id]) }}"
                  method="POST" id=""
                  class="formQuestion">
                {!! csrf_field() !!}
                {{ method_field('POST') }}
                    ...
                    <div class="col-lg-6">
                        <div class="addQuestionZelo">
                            <div class="form-group">
                                ...
                                <textarea rows="10" cols="50" name="name_ques" class="editor w checkeditor" id="addzero"
                                          required>
                                        {!!  old('name_ques') !!}
                                    </textarea>
