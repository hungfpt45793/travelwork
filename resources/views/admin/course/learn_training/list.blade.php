...
@section('title', 'Danh sách đào tạo khóa học' )

@section('content')
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            Danh sách đào tạo khóa học
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <p>
                        Cập nhật đào tạo khóa học : {{ !empty($course->course_title) ? $course->course_title : '' }}
                    </p>
                        ...
                        <table id="salaries" class="table table-bordered table-striped">
                            ...
                            @foreach($learn_training  as $training)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('edit_learn',['learn_id'=> $training->learn_id]) }}">
                                            <button class="btn btn-primary"><i class="fa fa-pencil"
                                                                               aria-hidden="true"></i></button>
                                        </a>
                                        <a href="{{ route('delete_learn',['learn_id'=> $training->learn_id]) }}"
