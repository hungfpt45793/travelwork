                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="course_descript"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <label style="margin-left: 20px">
                                    <input type="radio" name="course_status" value="1" checked style="width: 25px">Đã
                                    duyệt
                                </label>
