...
@section('title', 'Danh sách giáo viên bị đề nghị xóa')

@section('content')
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            Giáo viên bị đề nghị xóa
        </h1>
        <ol class="breadcrumb">
                            ...
                            <table id="jobs" class="table table-bordered table-striped">
                                ...
                                @foreach($teachers as $teacher)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('Teacher_delete_with_admin',$teacher->teacher_id) }}" class="btn btn-danger delete_teacher">
                                                Xóa
                                            </a>
                                            <a href="{{ route('Teacher_undelete_with_admin',$teacher->teacher_id) }}" class="btn btn-info undelete_teacher">
                                                Hủy
                                            </a>
                                        </td>
                                    </tr>
...
@push('scripts')
    <script>
        ...
        $('.undelete_teacher').click(function(){
