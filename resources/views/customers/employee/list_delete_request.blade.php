...
@section('title', 'Danh sách ứng viên bị đề nghị xóa')
@section('content')
                            ...
                            <table id="jobs" class="table table-bordered table-striped">
                                ...
                                @foreach($employees as $employee)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('Employee_delete_with_admin',$employee->employee_id) }}" class="btn btn-danger delete_employer">
                                                Xóa
                                            </a>
                                            <a href="{{ route('Employee_undelete_with_admin',$employee->employee_id) }}" class="btn btn-info undelete_employer">
                                                Hủy
                                            </a>
                                        </td>
                                    </tr>
...
@push('scripts')
    <script>
        ...
        $('.undelete_employer').click(function(){
