...
<script src="https://unpkg.com/axios/dist/axios.min.js"></script>
    ...
    <section class="content">
        <div class="row">
            <!-- form start -->
            <form role="form" action="{{ route('employer.update',['employer'=>$employer->employer_id]) }}" method="POST">
                {!! csrf_field() !!}
                {{ method_field('PUT') }}
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="website" placeholder="website" value="{{$employer->website}}" >
                            </div>
                                    ...
                                    <div class="images_list">
                                        @if(!empty($employer->images_list))
                                            @foreach(explode(',',$employer->images_list) as $image)
                                                <img src="{{$image}}" width="80" height="" style="margin-left: 10px; margin-bottom: 5px;"/>
                                            @endforeach
                                        @endif
                                    </div>
                    ...
                    <div class="box box-primary boxCateScoll">
                        ...
                        <div class="box-body ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="button" onclick="return uploadImage(this);" value="Chọn ảnh"
                                       size="20"/>
                                <img src="{{$employer->banner_intership}}" width="80" height=""/>
                    ...
                    <div class="form-group">
                        <label style="margin-right: 10px">
                            <input type="radio" name="status_agency" value="0"
                                   class="flat-red" @if($employer->status_agency == 0)checked @endif>
                           Không phải là đại lý
                        </label>
                        <label>
                            <input type="radio" name="status_agency" value="1"
                                   class="flat-red" @if($employer->status_agency == 1)checked @endif>
                            Đại lý
                        </label>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea class="editor" id="service_agency" name="service_agency" rows="5" cols="80"/>{!!
                                 $employer->service_agency !!}</textarea>
                    </div>
