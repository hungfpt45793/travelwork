...
@section('title', 'Danh sách Cộng tác viên đã xóa')
@section('content')
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
           Cộng tác viên đã xóa
        </h1>
        <ol class="breadcrumb">
                            ...
                            <table id="jobs" class="table table-bordered table-striped">
                                ...
                                @foreach($list_staff as $staff)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('Staff_member_restore', ['staff_member_id' => $staff->staff_member_id]) }}">
                                                <button class="btn btn-primary"><i class="fa fa-share xoayicon mgr5" aria-hidden="true"></i> Khôi phục</button>
                                            </a>
                                            <a  href="{{ route('Staff_member_forceDelete', ['staff_member_id' => $staff->staff_member_id]) }}" class=""><button class="btn btn-danger btnDelete"> <i class="fa fa-trash-o mgr5" aria-hidden="true"></i> Xóa vĩnh viễn</button>
