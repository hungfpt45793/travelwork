...
@section('title', 'Cập nhật nhân viên ' . $staff->staff_name)

@section('content')
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            Cập nhật nhân viên {{$staff->staff_name}}
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <form role="form" action="{{ route('staff.update',['staff_id'=>$staff->staff_id]) }}" method="POST" enctype="multipart/form-data">
                {!! csrf_field() !!}
                {{ method_field('PUT') }}
