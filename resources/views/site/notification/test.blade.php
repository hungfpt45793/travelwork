...
@section('meta_description') thong bao @endsection
@section('keywords', 'thong bao')
        ...
        shownoti.addEventListener('click', function (e) {
            ...
            else
            {
                ...
                notify = new Notification(
                    'Bạn có một thông báo mới từ Sanketoan', // Tiêu đề thông báo
                    {
                        body: 'SAnketoan vừa đăng một bài viết mới.', // Nội dung thông báo
                        icon: 'http://sanketoan.local/public/library/images/logo/logo2.png', // Hình ảnh
                        tag: 'http://sanketoan.local/' // Đường dẫn
                    }
                );
