...
@section('title', 'Thêm mới chương khóa học')
@section('meta_description', 'Thêm mới chương khóa học')
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 dcontent col-12 col-12">
                    ...
                    <div class="link_breakcrum mbdsNone">
                        <ul class="nav">
                            ...
                            <li class="nav-item pd8">
                                <a href="{{ route('list_course_chapter',['courses_id' => $course->course_id])  }}">Danh sách chương</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="col-xs-12 col-md-12">
                                    ...
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <h3 class="box-title f22">Thêm mới chương khóa học : {{ $course->course_title }}</h3>
                                        </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <label> <input checked="" type="radio" name="course_chapter_status" value="0" style="width: 25px">Học thử </label>
                                                <label style="margin-left: 20px"> <input type="radio" name="course_chapter_status" value="1" checked="" style="width: 25px">Không học thử </label>
                                            </div>
    ...
    <script>
        ...
        $('.js_btn_loadding').click(function () {
            if ($('#form_create_course').valid()) {
                $('.js_btn_loadding').html('<i class="fas fa-spinner fa-spin mgr5"></i>' + 'Đang thêm chương khóa học ...');
