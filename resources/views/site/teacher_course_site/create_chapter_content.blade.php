...
@section('title', 'Thêm mới bài học cho chương')
@section('meta_description', 'Thêm mới bài học cho chương')
@section('keywords', 'Thêm mới bài học cho chương')
                                ...
                                <div class="col-xs-12 col-md-12">
                                    ...
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <h3 class="box-title f22">Thêm mới bài học cho chương : {{ $course_chapter->course_chapter_name }}</h3>
                                        </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('course_content_title') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('course_link_youtuber') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id=""
                                                          ...
                                                          rows="3"> {{ old('course_content_descript') }}</textarea>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="box-footer">
                                            <input type="hidden" name="course_id"
                                                   value="{{ $course_chapter->course_id }}">
                                            <input type="hidden" name="course_chapter_id"
                                                   value="{{ $course_chapter->course_chapter_id }}">
    ...
    <script>
        ...
        $('.js_btn_loadding').click(function () {
            if ($('#form_create_course').valid()) {
                $('.js_btn_loadding').html('<i class="fas fa-spinner fa-spin mgr5"></i>' + 'Đang thêm bài học ...');
