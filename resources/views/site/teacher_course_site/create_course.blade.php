...
@section('meta_description', 'Thêm mới khóa học')
@section('keywords', 'Thêm mới khóa học')
            ...
            <div class="row ">
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 dcontent col-12 col-12">
                    ...
                    <div class="create_teacher_course" style="border: 1px solid #ccc;">
                        ...
                        <form role="form" action="{{ route('teacher_store_courses') }}" method="POST"
                                ...
                                <div class="col-xs-7 col-md-7">
                                    ...
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <h3 class="box-title f22">Thêm mới khóa học</h3>
                                        </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control js_courses_code error_border_course_code"
                                                       name="course_code"
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress2" class="fw6">Hình ảnh khóa học <span class="clRed">(*)</span> </label> <a
                                                ...
                                                <div class="">
                                                    <div class="form-group">
                                                        <input type="button" onclick="return uploadImage(this);" class="error_border_course_image"
                                                               value="Chọn ảnh"
                                                               size="20"/>
                                                        <img src="{{ old('courses_code') }}" width="80" height="70"/>
                                                        <input name="course_image" type="hidden"
                                                               value="{{ old('courses_code') }}"/>
                                                    </div>
                                                </div>
                                                <div class="error_message">
                                                    <div class="mess_notice_course_image clearfix note_text_course_image"></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control editor_basic" id="course_descript"
                                                          name="course_descript"
                                                          rows="5"> {{ old('course_descript') }}</textarea>
                                                <div class="error_message">
                                                    <div class="mess_notice_course_descript clearfix note_text_course_descript"></div>
                                                    <div class="error_reg_mess clearfix error_text_course_descript"></div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Khóa học này dành cho ai <span class="clRed">(*)</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="mess_notice_course_benefit clearfix note_text_course_benefit"></div>
                                                <div class="error_reg_mess clearfix error_text_course_benefit"></div>
                                            </div>

                                        </div>

                                        <div class="box-footer">
                                            <button type="submit" class="btn_submit_course js_btn_loadding">Thêm mới
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="activation_code"
                                                       placeholder="Mã kích hoạt khóa học"
                                                       value="{{ old('activation_code') }}">

                                                <div class="mess_notice_activation_code clearfix note_text_activation_code"></div>
                                                <div class="error_reg_mess clearfix error_text_activation_code"></div>
                                            </div>


                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Danh mục khóa học <span class="clRed">(*)</span></label>
                                                <select class="select2" name="category_course_id">
                                                    @foreach($list_category as $category)
                                                        <option value="{{ !empty($category->category_course_id) ? $category->category_course_id : '' }}"
                                                                @if(old('category_course_id') == $category->category_course_id) selected @endif>{{ !empty($category->category_course_title) ? $category->category_course_title : '' }} </option>
                                                    @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2" name="tag_id[]" multiple>
                                                    ...
                                                    <div class="mess_notice_tag_id clearfix note_text_tag_id"></div>
                                                    <div class="error_reg_mess clearfix error_text_tag_id"></div>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="mess_notice_course_price clearfix course_price"></div>
                                                <div class="error_reg_mess clearfix error_text_course_price"></div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="mess_notice_course_discount clearfix note_course_discount"></div>
                                                <div class="error_reg_mess clearfix error_text_course_discount"></div>
                                            </div>
    ...
    <script>
        ...
        $('.js_btn_loadding').click(function () {
            if ($('#form_create_course').valid()) {
                $('.js_btn_loadding').html('<i class="fas fa-spinner fa-spin mgr5"></i>' + 'Đang thêm khóa học ...');
