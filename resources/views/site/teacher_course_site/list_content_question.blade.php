                ...
                <div class="col-xl-9 col-lg-8 col-md-12 ">
                    ...
                    <section class="jobsInteresting bgrWhite  radius5 mgt20">
                        <div class="titleJobs  fw6 f20 bg-white mgb20 pd010 pd10 border_1px ">
                            ...
                            Danh sách câu hỏi : {{ $course_content->course_content_title }}
                            <p class="mgb10">
                                <a class="btnOrange f14 dsInline" href="{{ route('create_content_question',['course_content_id' =>$course_content->course_content_id]) }}"> Thêm mới </a>
                                <a class="btnOrange f14 dsInline" href="{{ route('select_content_question',['course_content_id' =>$course_content->course_content_id]) }}"> Chọn câu hỏi </a>
                            </p>
                        </div>
