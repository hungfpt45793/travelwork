...
@section('title', 'Cập nhật  chương khóa học')
@section('meta_description', 'Cập nhật chương khóa học')
@section('keywords', 'Cập nhật khóa học')
                                ...
                                <div class="col-xs-12 col-md-12">
                                    ...
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <h3 class="box-title f22">Cập nhật chương  : {{ $course_chapter->course_chapter_name }}</h3>
                                        </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Tiêu đề chương khóa học <span
                                                            class="clRed">(*)</span></label>
                                                <input type="text" class="form-control error_border_course_chapter_name"
                                                       name="course_chapter_name"
                                                       placeholder="Tiêu đề chương khóa học"
                                                       value="{{ $course_chapter->course_chapter_name }}">

                                                <div class="error_message">
                                                    <div class="mess_notice_course_chapter_name clearfix note_textcourse_chapter_name"></div>
                                                    <div class="error_reg_mess clearfix error_text_course_chapter_name"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id=""
                                                          name="course_chapter_descript"
                                                          rows="3"> {{ $course_chapter->course_chapter_descript }} </textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Khóa học này dành cho ai </label>
                                                <textarea class="form-control editor_basic" id="course_content"
                                                          name="course_chapter_content">{!! $course_chapter->course_chapter_content !!}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <label>
                                                    <input checked="" type="radio" name="course_chapter_status" value="0" style="width: 25px"
                                                    @if($course_chapter->course_chapter_status == 0) checked @endif>Học thử
                                                </label>
                                                <label style="margin-left: 20px">
                                                    <input type="radio" name="course_chapter_status" value="1" checked="" style="width: 25px"
                                                           @if($course_chapter->course_chapter_status == 1) checked @endif>Không học thử
                                                </label>
                                            </div>
                                        ...
                                        <div class="box-footer">
                                            <input type="hidden" name="course_chapter_id" value="{{ $course_chapter->course_chapter_id }}">
