...
@section('meta_description', 'Thêm mới câu hỏi')
            ...
            <div class="row ">
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 dcontent col-12 col-12">
                    ...
                    <div class="create_teacher_course mgt20 mgb20" style="border: 1px solid #ccc;">
                        ...
                        <form role="form" action="{{ route('store_content_question') }}" method="POST"
                                ...
                                <div class="col-xs-6 col-md-6">
                                    ...
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <h3 class="box-title f22">Thêm mới bài học
                                                : {{ $course_content->course_content_title }}</h3>
                                        </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control editor_basic" id="name_ques"
                                                          name="name_ques">{!! old('name_ques') !!}</textarea>
                                        ...
                                        <div class="box-footer">
                                            <input type="hidden" name="course_content_id"
                                                   value="{{ $course_content->course_content_id }}">
                                                ...
                                                <div class="form-group mgBottom0">
                                                    ...
                                                    <label class="mgRight10">
                                                        <input type="radio" name="correct_answer" class="flat-red"
                                                               value="answer1"
                                                               @if(old('correct_answer') == 'answer1') checked
                                                               @else checked @endif>
                                                        <!--  <input type="radio" name="r1" checked="checked"> -->
                                                        <span>Đáp án A </span>
                                                    </label>
    ...
    <script>
        ...
        $('.js_btn_loadding').click(function () {
            if ($('#form_create_course').valid()) {
                $('.js_btn_loadding').html('<i class="fas fa-spinner fa-spin mgr5"></i>' + 'Đang thêm câu hỏi ...');
