...
<section class="main" id="toTop">
    <div class="container">
        <form action="{{ route('createResultDetailRoom') }} " method="POST" id="submitQuenstionRoom">
            {!! csrf_field() !!}
            {{ method_field('POST') }}
...
<section>
    ...
    <script>
        ...
        $('.question_number').click(function(){
            ...
            // $('.listquestion .question-item .panel-body').css('margin-top','55px');
        });
    </script>
</section>
    ...
    $(document).ready(function () {
        ...
        $(window).scroll(function () {
            ...
            if (windowpos > pos.top) {
                ...
                $('#ContentExam').css('margin-top', '100px');
...
<script>
    ...
    // var time = 10;
    var id = 'roomtime' + '<?php echo $exam['id_exam'] . \Illuminate\Support\Facades\Auth::user()->id; ?>';
