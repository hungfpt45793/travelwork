                                            ...
                                            @foreach($jobs as $job)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{--</br>--}}
                                                        {{--<button><a href="{{ route('job-user.edit',['job_user'=>$job['job_id']]) }}" title="Sửa tin"></a></button>--}}
                                                        {{--<button><a href="{{ route('update_stop_job',['job_id'=>$job['job_id']]) }}" title="Tạm dừng" class="clred" style="color: red !important;"></a></button>--}}

                                                        {{--<button><a href="{{ route('job-user.destroy',['job_user'=>$job['job_id']]) }}" title="Xóa" data-toggle="modal" data-target="#myModalDelete" onclick="return submitDelete(this);"><i class="fas fa-trash-alt clorange"></i></a></button>--}}
                                                        {{--</div>--}}
                                                    </td>
                                                </tr>
                                            </tbody>
