...
@section('title', 'Sửa việc làm từ nhà tuyển dụng')
@section('meta_description', 'Sửa việc làm từ nhà tuyển dụng')
...
@section('content')
                        ...
                        <div class="titleJobs f18 white  pd10-20 col-f14">
                            <div class="link bgrWhite md-mgt20 disOnMobile">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item pd8">
                                        <a href="{{ route('getAllJobs') }}" class=" f18 md-f14 mgb0">Danh sách tin tuyển
                                            dụng</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="contentJobsInteresting pdl15 pdr15 col-f14">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12 col-12">
                                    ...
                                    <div class="CV bgrWhite radius5  pd20">
                                        ...
                                        <div class="supporter textCenter radius5 pd5 bdLightGray mgb10">
                                            ...
                                            <p class="mg0"> Các trường <span class="red fw6">(*)</span> bắt buộc phải
                                                nhập</p>
                                        </div>
                                        <div class="content">
                                            @if(!empty($errors->all()))
                                            ...
                                            <form role="form"
                                                    ...
                                                    <div class="col-md-4 gruopRadio">
                                                        ...
                                                        <div class="form-check"
                                                            ...
                                                            <input class="form-check-input" type="radio" name="gender"
                                                                   id="exampleRadios2"
                                                                   value="1" @if($job->gender == 1) checked @endif>
                                                        ...
                                                        <div class="form-check"
                                                            ...
                                                            <input class="form-check-input" type="radio" name="gender"
                                                                   id="exampleRadios3"
                                                                   value="2" @if($job->gender == 2) checked @endif>
                                                        ...
                                                        <div class="form-check"
                                                            ...
                                                            <input class="form-check-input" type="radio" name="gender"
                                                                    id="exampleRadios3"
                                                                    value="3" @if($job->gender == 3) checked @endif>
                                                            <label class="form-check-label" for="exampleRadios3">
                                                                Cả nam và nữ
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group borderSelect2">
                                                            ...
                                                            <input type="date"
                                                                   ...
                                                                   value="{{ $job->deadline_submit_profile }}" max="9999-12-31" />
                                                            <div class="error_message">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group borderSelect2">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                   ...
                                                                   value="{{ isset($job->number_recruit) ? $job->number_recruit : '' }}"/>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group borderSelect2">
                                                            ...
                                                            <select class="form-control select2  error_border_district" name="district"
                                                                    aria-label="Quận/Huyện" id="county">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea rows="2"
                                                                  ...
                                                                  name="address_work"
                                                                  placeholder="Địa chỉ nơi làm việc">{{ isset($job->address_work) ? $job->address_work : '' }}</textarea>
                                                        <div class="error_message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" class="editor" id="description"
                                                              rows="5" cols="80">{!!   isset($job->description) ? $job->description : ''  !!}</textarea>
                                                    <div class="error_message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="content" class="editor" id="content" rows="5"
                                                              cols="80">{!!   isset($job->content) ? $job->content : ''  !!}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="welfare" class="editor" id="welfare"
                                                              rows="10" cols="80">{!!   isset($job->welfare) ? $job->welfare : ''  !!}</textarea>
                                                    <div class="error_message">
    ...
    <script>
        $('.js_add_question').click(function () {
            var text = '<div class="js_input_delete"><input type="text" class="form-control mgt10 " name="job_qes_id[]" placeholder="Tạo câu hỏi cho phần tuyển dụng" /> <span class=""><i class="far fa-minus-square item_delete js_item_delete"></i></span></div>';
            $('.js_result_input').append(text);
        });
        //xoa phân tạo câu hỏi
        $('.js_result_input').on('click', '.js_item_delete', function (e) {
            e.preventDefault();
            $(this).parent().parent().remove();
        });
        $('.js_result_input_edit').on('click', '.js_item_delete', function (e) {
            e.preventDefault();
            $(this).parent().parent().remove();
        });
        $('#career_category_id').change(function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    // $('#editor_description').html();

                    $('#editor_description').val(result['content']);
