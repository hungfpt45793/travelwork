...
<section class="main" id="toTop">
    <div class="container">
        <form action="{{ route('createResultJobExam') }} " method="POST" id="submitQuenstion">
            {!! csrf_field() !!}
            {{ method_field('POST') }}
                ...
                <div class="col-lg-12 col-md123 leftSidebar" id="timeHeader">
                    <div class="row bgTopQueestion">
                        ...
                        <div class="panelBox col-lg-4 col-md-4 col-sm-6 col-6">
                            ...
                            <button type="button" name="" class="btn bgHome" onclick="nv_save_test(0);">
...
<script>
    ...
    60;
    // var time = 10;
    var id = 'time' + '<?php echo $exam['id_exam'] . \Illuminate\Support\Facades\Auth::user()->id; ?>';
