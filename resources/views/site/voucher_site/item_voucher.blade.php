<div class="News Voucher">
    <div class="itemVoucher">
        ...
        <div class="info">
            <h5 class="title_voucher js_matchHeight_title_voucher"><a href="{{ route('getVoucher',['slug_voucher'=> $voucher['slug_voucher']])}}"
                                           class="f18 clHome">{{ isset($voucher['name_voucher']) ? \App\Ultility\Ultility::textLimit($voucher['name_voucher'], 10) : '' }} </a>
            </h5>
            <div class="itemIcon">
