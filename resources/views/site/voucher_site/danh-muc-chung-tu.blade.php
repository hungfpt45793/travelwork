                ...
                <div class="link_breakcrum mbdsNone">
                    <ul class="nav">
                        ...
                        <li class="nav-item pd8">
                            <a href="{{ route('getAllCategoryVoucher',['slugCategoryVoucher'=> $cate_voucher->slug_cate_voucher]) }}">{{ isset($cate_voucher->name_cate_voucher) ? $cate_voucher->name_cate_voucher : '' }}</a>
                        </li>
                    </ul>
                </div>
            ...
            <section class="section_box_content mgt20">
                <div class="header_box">
                    <h2 class="title_box  fw6 f20 mgb0 col-f14">
                        <a>
                            {{ isset($cate_child_voucher->name_cate_child) ? $cate_child_voucher->name_cate_child : '' }}
                        </a>
                    </h2>
                ...
                <div class="content_box">
                    ...
                    <div class="row">
                        ...
                        <div class="row pagePostSale text-center">
                            <div class="col-12 text-center">
                                @include('site.default.item_pani',['page_link' => $vouchers])
                            </div>
                        </div>
