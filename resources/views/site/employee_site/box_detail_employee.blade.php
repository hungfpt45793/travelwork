...
@section('content')
    <section class="content bgrGray pdt5">
        <div class="container-fluid ">
            <div class="row ">
                <div class="col-lg-8 div_width pr-0" style="background-color: #fff;position:relative">



                    <div class="box_item_cv">
                        <?php
                        ...
                        <div class="box_item_cv_content">
                            <div class="box_cv_left bg_cv_home">
                                ...
                                <div class="box_cv_info item_content_left">
                                    ...
                                    <div class="item_cv_info item_cv_info item_cv_info_textare bg_cv_info cl_cv_textarea item_cv_link">
                                          <textarea disabled>{{ isset($employee->my_facebook) ? $employee->my_facebook : '' }}</textarea>
                                    ...
                                    @if($or_left == 2)
                                        ...
                                        @if($or_left == 3)
                                            <div class="item_content_left box_career_goals " @if(!empty($show_hidden_left[2])) style="display: none" @endif>
                                                ...
                                                <div class="content_content_left cl_box_content_left content_career">
                                        <textarea disabled>{{!empty($cv_employee->cv_prize) ? $cv_employee->cv_prize : '' }}</textarea>
                                                </div>
                                            </div>
                                        @endif
                                        @if($or_left == 4)
                                            <div class="item_content_left box_career_goals " @if(!empty($show_hidden_left[3])) style="display: none" @endif>
                                                ...
                                                <div class="content_content_left cl_box_content_left content_career">
                                        <textarea disabled>{{!empty($cv_employee->cv_card) ? $cv_employee->cv_card : '' }}</textarea>
                                                </div>
                                            </div>
                                        @endif
                                        @if($or_left == 5)
                                            <div class="item_content_left box_career_goals " @if(!empty($show_hidden_left[4])) style="display: none" @endif>
                                                ...
                                                <div class="content_content_left cl_box_content_left content_career">
                                        <textarea disabled>{{!empty($cv_employee->cv_interests) ? $cv_employee->cv_interests : '' }}</textarea>
                                                </div>
                                            </div>
                                        @endif
                                        @if($or_left == 6)
                                            <div class="item_content_left box_career_goals " @if(!empty($show_hidden_left[5])) style="display: none" @endif>
                                                ...
                                                <div class="content_content_left cl_box_content_left content_career">
                                        <textarea disabled>{{!empty($cv_employee->cv_reference_person) ? $cv_employee->cv_reference_person : '' }}</textarea>
                                                </div>
                                            </div>
                                        @endif
                                @endforeach
                            ...
                            <div class="box_cv_right bg_cv_home" >
                                ...
                                <div class="box_cv_right_header">
                                    <h1 class="cl_cv_name">
                                        {{!empty($cv_employee->cv_name) ? $cv_employee->cv_name : '' }}
                                    </h1>
...
<style>
    ...
    /*.box_item_cv_content*/
    /*{*/
        /*border: 1px solid rgb(0, 150, 165);*/
    /*}*/
    /*.bg_cv_home*/
    /*{*/
        /*background: rgb(0, 150, 165);*/
    /*}*/
    .cl_box_content_left textarea
    {
        color: #fff !important;
    }
</style>
...
@section('show_js')
    <script>
        ...
        $('.left_content_textarea').css('color', cl_cv_6);
