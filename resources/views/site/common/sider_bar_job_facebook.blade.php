...
<div class="col-xl-3 col-lg-4 col-md-12 ">
    <div class="side-bar-left formJobLarge ">
        ...
        <div class="createNew text-center bgrBlueN" style="    padding: 4px 0;">
            <a href="" data-toggle="modal" data-target="#loginTiva" class="createNewButton white">
        ...
        <div class="tab-content mgb20" id="nav-tabContent">
            <div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <div class="createNew text-center">
                    <a href="{{ route('job-face-user.create') }}" class="f18 md-f14 btnOrange" ><i class="fas disInBlock fa-paper-plane "></i> Đăng tin nhanh miễn phí</a>
                </div>
                <hr>
                <hr>
