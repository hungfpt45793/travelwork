                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" name="name" value="{{old('name')}}"
                                                       class="form-control" placeholder="Tên công ty" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" name="address" id="location-input"
                                                       class="form-control" placeholder="Địa chỉ chi tiết công ty" value="{{old('address')}}" required>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" name="employer_name" value="{{old('employer_name')}}"
                                                       class="form-control" placeholder="Tên người phụ trách" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="number" name='phone' value="{{old('phone')}}"
                                                       class="form-control" placeholder="Số điện thoại liên hệ" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" name='email' value="{{old('email')}}"
                                                       class="form-control" placeholder="Email là tài khoản đăng nhập" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
