                                ...
                                @foreach($listroom as $id_room=>$room)
                                    <tr>
                                        ...
                                        <td class="text-center" width="15%">
                                            <a target="_blank" href="{{ route('detai_result_student_room',['id_room' => $room->id_room]) }}" class="btn btn-primary btnSmall mgBottom5" title="Sửa phòng thi " data-toggle="tooltip" data-placement="bottom">
                                                <i class="far fa-edit"></i> Kết quả của phòng thi
                                            </a>
