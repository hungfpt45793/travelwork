                        ...
                        <div class="col-lg-9 maxHeightcol">
                            ...
                            <div class="listQuestion bg-white">
                                @if(!empty($list_question))
                                    ...
                                    <form action="{{ route('updateSchoolResultDetailRoom') }} " method="POST"
                                          id="submitQuenstionRoom">
                                        {!! csrf_field() !!}
                                        {{ method_field('POST') }}
                                                        ...
                                                        @endif" id="">
                                                            ...
                                                            @else
                                                                <div class="answer_question text-left  col-md-12">
                                                                    ...
                                                                    <p class="mgb0">Nhận xét câu trả lời cho đáp án của
                                                                        sinh viên :
                                                                    </p>
                                                                    <textarea class="form-control w100" rows="5"
                                                                              name="answer_teacher[{{$question['id_ques']}}]">
{{ isset($anser->teacher_correct) ? $anser->teacher_correct : '' }}
                                                                        </textarea>
                                                                </div>
                                                            @endif
                                        ...
                                        @endforeach
                                        <div>
                                            <button type="submit" class="infoStudent_button">Lưu câu trả lời</button>
                                            </br>
                                            <i class="f13">(Lưu câu trả lời và gửi kết quả câu trả lời tự luận cho sinh
                                                viên)</i>
                                        </div>
                                        <div class="clearfix"></div>
                                    </form>
