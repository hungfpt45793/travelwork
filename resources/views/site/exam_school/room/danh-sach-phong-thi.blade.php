                                ...
                                @foreach($listroom as $id_room=>$room)
                                    <tr>
                                        ...
                                        <td class="text-center" width="15%">
                                            <a href="{{ route('room_school.edit',['id_room' => $room->id_room]) }}" class="btn btn-primary btnSmall mgBottom5" title="Sửa phòng thi " data-toggle="tooltip" data-placement="bottom">
                                            ...
                                            {{--</a>--}}
                                            <a href="{{ route('settingRoom',['id_room' => $room->id_room]) }}" class="btn btn-primary btnSmall mgBottom5" title="Cấu hình phòng thi" data-toggle="tooltip" data-placement="bottom">
                                                <i class="fas fa-wrench"></i>
                                            </a>


                                            <a  href="{{ route('room_school.destroy' ,['id_room' => $room->id_room]) }}" class="btn btn-danger  btnSmall mgBottom5"
