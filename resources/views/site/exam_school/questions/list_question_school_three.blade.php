...
@section('title', 'Danh sách câu hỏi tự luận')
@section('meta_description',  'Danh sách tự luận')
                            ...
                            <div class="link bgrWhite md-mgt20 disOnMobile">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item pd8">
                                        ...
                                        ?>
                                        <a href="{{ $link_url }}" class="f18 md-f14 blueDN hvBlueDN"> Danh sách câu hỏi (tự luận)</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="contentJobsInteresting pdl15 pdr15 col-f14">
                            <div class="CV bgrWhite radius5 pd20  mgb20 pdb5 pdt10">
                                ...
                                <div class="arror bgrWhite radius5 pd5 bdLightGray  mgb15 pd10 row">
                                    <div class="col-md-4">
                                        Có tất cả {{ !empty($total_zero) ? $total_zero  : '0' }} câu hỏi (tự luận)
                                    </div>
                                    <div class="col-md-8">
                                        <?php
                                        ...
                                        @foreach($school_subject as $sub)
                                            <?php
                                            $count_total = 0;
                                            $count_total  = \App\Exam\School_subject::getTotal(3,$teacher_school->teacher_sc_id,$sub->sub_id);
                                ...
                                <div class="content">
                                    <a href="{{ route('create_question_school',['type_question'=> 3]) }}"
                                        ...
                                        <div class="col-lg-9 maxHeightcol">
                                            <div class="listQuestion bg-white">
                                                ...
                                                @if(!empty($question_zero))
                                                    <h3 class="f18 text-left pd10 ds-inline" style="background: #ddd">Nội dung câu
                                                        hỏi</h3>
                                                            ...
                                                            <div id="questionshow{{ $question['id_ques'] }}" class="">
                                                                ...
                                                                <div class="answers_question ">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <p class="text-left f16 answer_succcess mgBottom5"> Đáp án câu hỏi là :  </p>
                                                                        <p class="mgBottom5">
