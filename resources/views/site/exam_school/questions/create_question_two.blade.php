...
@section('title', 'Thêm mới câu hỏi khó')
@section('meta_description',  'Thêm mới câu hỏi khó')
                            ...
                            <div class="link bgrWhite md-mgt20 disOnMobile">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item pd8">
                                        ...
                                        ?>
                                        <a href="{{ $link_url }}" class="f18 md-f14 blueDN hvBlueDN"> Thêm mới câu hỏi khó</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                            ...
                                            <section class="ListQuestionExam" id="ListQuestionExam">
                                                <div class="container">
                                                    ...
                                                    <div class="row bg-white">
                                                        <div class="col-lg-12">
                                                            <h3 class="text-center f22 mgTop15  ">Thêm mới câu hỏi (khó)</h3>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="">
