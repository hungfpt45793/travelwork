                                                                        ...
                                                                        <div class="form-group  mgBottom0 pdTop0">
                                                                            ...
                                                                            <div class="">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    <label for="inputEmail3" class="col-sm-2 control-label">Đáp án A <span
                                                                                                class="clred">(*)</span>
                                                                                    </label>
                                                                                    <div class="col-sm-10 mgBottom5 ">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    <label for="inputEmail3" class="col-sm-2 control-label">Đáp án B <span
                                                                                                class="clred">(*)</span>
                                                                                    </label>
                                                                                    <div class="col-sm-10 mgBottom5 ">
                                                                                ...
                                                                                <div class="clearfix"></div>
                                                                                <div class="form-group row">
                                                                                    <label for="inputEmail3" class="col-sm-2 control-label">Đáp án C
                                                                                    </label>
                                                                                    <div class="col-sm-10 mgBottom5 ">
                                                                                ...
                                                                                <div class="clearfix"></div>
                                                                                <div class="form-group row">
                                                                                    <label for="inputEmail3" class="col-sm-2 control-label">Đáp án D
                                                                                    </label>
                                                                                    <div class="col-sm-10 mgBottom5 ">
