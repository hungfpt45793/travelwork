...
@section('title', 'Danh sách trung bình')
@section('meta_description',  'Danh sách trung bình')
                            ...
                            <div class="link bgrWhite md-mgt20 disOnMobile">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item pd8">
                                        ...
                                        ?>
                                        <a href="{{ $link_url }}" class="f18 md-f14 blueDN hvBlueDN"> Danh sách câu hỏi (trung bình)</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12 col-12">
                                    <div class="CV bgrWhite radius5 pd20  mgb20 pdb5 pdt10">
                                        ...
                                        <div class="arror bgrWhite radius5 pd5 bdLightGray  mgb15 pd10 row">
                                            <div class="col-md-4">
                                                <p>Có tất cả {{ !empty($total_zero) ? $total_zero  : '0' }} câu hỏi (trung bình)</p>
                                                <p class="mgb5">
                                                    <a href="{{ route('list_type_question_school',['type_question'=> 1]) }}" class="infoStudent_button">Chuyển câu hỏi trung bình</a>
                                                </p>
                                            </div>
                                            <div class="col-md-8">
                                                <?php
                                                ...
                                                @foreach($school_subject as $sub)
                                                    <?php
                                                    $count_total = 0;
                                                    $count_total  = \App\Exam\School_subject::getTotal(1,$teacher_school->teacher_sc_id,$sub->sub_id);
                                        ...
                                        <div class="content">
                                            <a href="{{ route('create_question_school',['type_question'=> 1]) }}"
...
@endif" id="">
                                                ...
                                                <div class="col-lg-3  bg-white" id="sidebar_menu_fixel" style="">
