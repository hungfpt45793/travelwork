                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12 col-12">
                                    ...
                                    <div class="CV bgrWhite radius5  pd20">
                                        ...
                                        <div class="title">
                                            <h1 class="">
                                                Cập nhật tin tuyển dụng : {{ !empty($job->title) ? $job->title : '' }}
                                            </h1>
                                        </div>
                                            ...
                                            <form role="form"
                                                ...
                                                <div class="form-group borderSelect2 row mgb0">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select class="js-example-basic-single select2 form-control error_border_career_category_id"
                                                            ...
                                                            <option value=""
                                                                    @if(old($job->career_category_id) == 0) selected @endif>
                                                                -- Chọn vị trí --
                                                            </option>
                                                ...
                                                <div class="form-group row mgb0">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea rows="2"
                                                                  ...
                                                                  name="address_work"
                                                                  placeholder="Địa chỉ nơi làm việc">{{ !empty($job->address_work) ? $job->address_work : '' }}</textarea>
                                                        <div class="error_message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" class="editor_basic" id="description"
                                                              rows="5" cols="80">{!!  !empty($job->description) ? $job->description : ''  !!}</textarea>
                                                    <div class="error_message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="content" class="editor_basic" id="content" rows="5"
                                                              cols="80">{!!  !empty($job->content) ? $job->content : ''  !!}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="welfare" class="editor_basic" id="welfare"
                                                              rows="10" cols="80">{!!  !empty($job->welfare) ? $job->welfare : ''  !!}</textarea>
                                                    ...
                                                    <select style="width: 100%;" name="tags[]"
                                                        ...
                                                        @if (!empty($input_tags))
                                                            @foreach ($input_tags as $job_tag)
                                                                <option value="{{ $job_tag->tag_title }}" @if(in_array($job_tag->tag_title, $tag_array)) selected @endif>
                                                                    {{ $job_tag->tag_title }}
                                                                </option>
                                                            @endforeach
                                                        @endif
