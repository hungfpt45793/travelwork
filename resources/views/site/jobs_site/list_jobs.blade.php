                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12 col-12 borderTop">
                                    ...
                                    <div class="CV bgrWhite radius5 pd20 mgb20 pdb5">
                                        ...
                                        <a href="{{ route('job-user.create') }}"
                                           ...
                                           style="padding: 5px 15px;">Đăng tuyển tin tuyển dụng</a>
                                                ...
                                                @foreach($jobs as $job)
                                                    <tr>
                                                        ...
                                                        <td>{{ $job['job_code'] }}
                                                            ...
                                                            @if($job['active_job'] == 1)
                                                                @if($job['vip'] == 1)
                                                                    <p class="mg0  clRed"><i class="fas fa-check"></i>
                                                                        Đã đăng tin Vip</p>
                                                                @else
                                                                    <p class="mg0  clGreen"><i class="fas fa-check"></i>
                                                                        Đã đăng tin </p>
                                                                @endif
                                                            @else
                                                                <p class="mg0 clRed ">
                                                                    <i class="fas fa-exclamation mgr5"></i>Chưa đăng tin
                                                                </p>
                                                            @endif
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?php $total_submit_file = \App\Entity\Employee_submit_job_faacebook::getTotalsubmitJonCV($job['job_id'], 1)?>
