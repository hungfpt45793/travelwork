    ...
    <div class="itemQuestion">
        ...
        @if(\Illuminate\Support\Facades\Auth::check())
            <div class="buttonRoom hidden_show_live">
                <a href="#" data-toggle="modal" data-target="#room{{ $room->id_room }}">Vào phòng thi</a>
            </div>
        @else
            <div class="buttonRoom hidden_show_live">
                <a href="#" data-toggle="modal" data-target="#loginTiva">Vào phòng thi</a>
            </div>
        @endif
        @if(\Illuminate\Support\Facades\Auth::check())
            <?php
            ...
            //         \App\Ultility\Ultility::checkPrint($check_result);
            //        die();
            ?>
            ...
            @endif
            {{--<div class="buttonRoom hidden_show_live">--}}
            {{--<a href="#" data-toggle="modal" data-target="#{{ $room->id_room }}">Vào phòng thi</a>--}}
            {{--</div>--}}
        @endif
