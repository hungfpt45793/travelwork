...
@section('title', 'Danh sách bài viết chia sẻ')
@section('meta_description', 'Danh sách bài viết chia sẻ')
@section('keywords', 'Danh sách bài viết chia sẻ')
                                                        ...
                                                        <a class="z-depth-1"
                                                           ...
                                                           title="{{ isset($post_view->title) ? $post_view->title : '' }}">
                                                            <div class="CropImg CropImg60 CropImgMB60">
                                                                <div class="thumbs">
                                                                    <img class="responsive-img lazy"
                                                                    data-src="{{ isset($post_view->image) ? $post_view->image : '' }}"
