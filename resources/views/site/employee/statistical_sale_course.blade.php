                                    ...
                                    <div class="CV bgrWhite radius5 pd20  mgb30 pdb5 mbpd0">
                                        ...
                                        <div class="title mgb20">
                                            <h5 class="lt-f18  fw7 bdLeftBlueN5x pdl10 blueN mgb0">
                                                Bảng tổng hợp thống kê chia sẻ khóa học
                                            </h5>
                                        </div>
                                            ...
                                            <table id="jobfb" class="table table-hover table-bordered mbdsNone">
                                                ...
                                                @foreach($list_course as $id_stt=>$course)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if(!empty($course->total_money_view))
                                                                {{ number_format($course->total_money_view) }} VND
                                                            @endif
                                                ...
                                                <tr>
                                                    <td colspan="2" class="text-center">
                                                        <p class="f20 fw6 mgb0">
                                                            Tổng số chia sẻ : {{ !empty($employee_coint->total_sale_course) ?number_format($employee_coint->total_sale_course) : '' }} lượt
                                                        </p>
                                                    </td>
                                                    <td colspan="2" class="text-center">
                                                        <p class="f20 fw6 mgb0">
                                                            Tổng số lượt xem : {{ !empty($employee_coint->total_view_course) ? number_format($employee_coint->total_view_course) : '' }} lượt
                                                        </p>
                                                    </td>
                                                    <td colspan="3" class="text-center">
                                                        <p class="f20 fw6 mgb0">
                                                            <?php
                                                            $total_money_course = \App\Course\Course_sale_statistical::Employee_TotalMoney($employee_coint->employee_id)
                                                            ?>
                                                            Tổng tiền : {{ !empty($total_money_course) ? number_format($total_money_course) : '' }} VND
                                                        </p>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            ...
                                            <table id="jobfb" class="table table-hover table-bordered dsNone mbdsBlock">
                                                ...
                                                <tr>
                                                    <td colspan="2" class="text-left">
                                                        <p class="f20 fw6 mgb0">
                                                            Tổng số chia sẻ : {{ !empty($employee_coint->employee_total_sale) ?number_format($employee_coint->employee_total_sale) : '' }} lượt
                                                        </p>
                                                        <p class="f20 fw6 mgb0">
                                                            Tổng số lượt xem : {{ !empty($employee_coint->employee_total_view) ? number_format($employee_coint->employee_total_view) : '' }} lượt
                                                        </p>
                                                        <p class="f20 fw6 mgb0">
                                                            Tổng tiền : {{ !empty($total_money_course) ? number_format($total_money_course) : '' }} VND
                                                        </p>
