    ...
    <div class="container" >
        <div class="left" style="background:{{ $color->code_color }}">
            ...
            <div id="sortable">
                ...
                <?php
                    $can_watch_contact = 0;
                    if(Illuminate\Support\Facades\Auth::check() && Illuminate\Support\Facades\Auth::user()->id == $user_id)
                    {
                        $can_watch_contact = 1;
                    }
                ?>
                    ...
                    <div class="exp content-edit skill">
                        ...
                        <div class="ctbx">
                            ...
                            <div class="bar-value-exp" style="position: relative;width:271px;margin:auto;margin-bottom: 12px;">
                                ...
                                <div class="thanhtrang" style="width:{{ $skill->cv_skill_value }}%;background:rgb(0, 164, 210);height:10px;position: absolute;top:0;left:0;z-index:2;border-radius:4px"></div>
                            </div>
                        </div>
                        @endforeach
                        @endif
