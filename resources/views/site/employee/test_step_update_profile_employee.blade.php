                                ...
                                <div class="col-md-12">
                                 ...
                                 <i class="f12 fw5">(hệ thống sẽ tính năm KN theo thời gian thực)</i>
                                                ...
                                                <div class="col-sm-4 col-lg-5">
                                                    ...
                                                    <div class="form-group mgb0" style="padding:.3rem;border:1px solid #ccc;border-radius:5px">

                                                        <div class="form-group" id="upload_pc">
                                                            @if(!empty($employee->employee_image))
                                                                <img style="width:60px; height:40px; object-fit:cover"  id="image_employee_uplade_preview" src="{{ asset($employee->employee_image) }}">
                                                                <label for="check_upload_file" id="label_check_upload_file" class="btn btn-sm btn-primary mb-0">
                                                                    Chọn ảnh
                                                                    <input type="hidden" name="check_file_image" value="0" class="js_check_file_image">
                                                                </label>
                                                                <input style="visibility:hidden;height:1px;width:1px" type="file" class="error_text_image"
                                                                       name="images"
                                                                       placeholder="Chọn ảnh" id="check_upload_file">
                                                                <br>
                                                                <i class="f12 fw5">(Vui lòng chọn ảnh đại diện)</i>
                                                                {{--<input type="hidden" name="images" value="{{ $employee->employee_image }}">--}}
                                                            @else
                                                                <input type="file" size="20" class="error_text_image"
                                                                       name="images" placeholder="Chọn ảnh" />

                                                                <label>
                                                                    <input type="hidden" name="check_file_image" value="1" checked>
                                                                </label>
                                                            @endif
                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        if(res.status == 'success'){
                            ...
                            setTimeout(function(){$('.ctrl_nortification_success').addClass('d-none'); }, 4000);
                        ...
                        if(res.status == 'error'){
                            ...
                            setTimeout(function(){$('.ctrl_nortification_danger').addClass('d-none'); }, 4000);
