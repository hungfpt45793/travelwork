            ...
            {{--<div class="row ">--}}
                ...
                {{--<div class="col-xl-9 col-lg-8 col-md-12 col-12 col-12">--}}
                        ...
                        {{--<div class="link bgrWhite md-mgt20 disOnMobile">--}}
                            {{--<ul class="nav">--}}
                                ...
                                {{--<li class="nav-item pd8">--}}
                                    ...
                                    {{--<a href="{{ route('get_job_facebook') }}" class=" f18 md-f14 mgb0">Tin đăng tuyển hộ</a>--}}
                                {{--</li>--}}
                                {{--<li class="nav-item pd8">--}}
                                    {{--<p class="mgb0 md-f13 md-mgt2 blueDN"><i class="fas fa-chevron-right"></i></p>--}}
                                {{--</li>--}}
                    ...
                    {{--<div class="CV bgrWhite radius5 mgt20 mgb20 pdb5 pdt10" style="border: 1px solid #ccc;">--}}
                        {{--<div class="content">--}}
                            {{--<div class="col-md-12 pd20" style="border-bottom: 1px solid #ccc">--}}
                                    ...
                                    {{--<div class="slideNews submit_job_slide">--}}
                                        {{--<div class="text-center">--}}
                                            ...
                                            {{--<div class="submit_job_img">--}}
                                                ...
                                                {{--@if(!empty($cv_employee))--}}
                                                    {{--<a target="_blank"--}}
                                                       {{--href="{{ route('show_cv_Employee',['submit_job_fb_id'=>$submit_job_fb_id]) }}">Xem--}}
                                                        {{--CV</a>--}}
                                                {{--@else--}}
                                                    {{--<a href="#">Đang cập--}}
                                                        {{--nhật</a>--}}
                                        ...
                                        {{--<div class="text-center">--}}
                                            ...
                                            {{--<div class="submit_job_img">--}}
                                                ...
                                                {{--@if(!empty($check_syll))--}}
                                                    {{--<a target="_blank"--}}
                                                       {{--href="{{ route('show_syll_Employee',['submit_job_fb_id'=>$submit_job_fb_id]) }}">Xem--}}
                                                        {{--sơ yếu lý lịch</a>--}}
                                                {{--@else--}}
                                                    {{--<a href="#">Đang cập--}}
                                                        {{--nhật</a>--}}
