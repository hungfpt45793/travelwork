                    ...
                    {{--
                                        <div class="link bgrWhite md-mgt20 disOnMobile">
                                            <ul class="nav">
                                                ...
                                                <li class="nav-item pd8">
                                                    <a href="#" class=" f18 md-f14 mgb0">Lưu CV</a>
                                                </li>
                                            </ul>
                                        </div> --}}
                                        ...
                                        <div class="item" id="toolbar-color">
                                            ...
                                            <div class="options">
                                                ...
                                                @foreach($cv_color as $id_cl=>$color)
                                                    <span class="color @if($id_cl == 0) active @endif my_color_cv{{$id_cl + 1}}"
                            ...
                            <div class="blog-hd" id="page-taocv">
                                ...
                                <div class="ctr" id="scollProduct">
                                    ...
                                    <div id="page-cv" class="">
                                        <input type="hidden" name="cv_id" value="{{ $cv_template->cv_id  }}">
                                        <input type="hidden" name="cv_template_id"
                                               value="{{ $cv_template->cv_template_id  }}">
                                        <input type="hidden" name="cv_color_template" id="cv_color"
                                               value="{{ $cv_template->cv_color  }}">
                                        <input id="cv-title" name="cv_title" class="non-printable" contenteditable=""
                                               cvo-validatable=""
                                               placeholder="Tiêu đề CV"
                                               value="CV {{!empty($employee->employee_name) ? $employee->employee_name : '' }}">
                                                    ...
                                                    <div class="box-01">
                                                        <div id="cvo-profile-avatar-wraper">
                                                            ...
                                                            <input name="images" type="text"
                                                                   value="{{ isset($employee->employee_image) ? $employee->employee_image : asset('public/assets/image/no_avatar.jpg') }}"
                                                        ...
                                                        <div id="box-hvt" data_show="note_title_reference_person"
                                                             ...
                                                             class="js_click_box">
                                                            <h1><input id="cv-profile-fullname" name="cv_name"
                                            ...
                                            <div id="cv-main">
                                                <div id="cv-content">
                                                    <div class="ir" id="sort_block">
                                                        <?php
                                                        $order_right = array();
                                                        $order_right = explode(',', $cv_template->cv_order_join);
                                                        $show_hidden_right = array();
                                                        $show_hidden_right = explode(',', $cv_template->show_hidden_cv_order_join);
                                                        ?>
                                                        @foreach($order_right as $or_right)
                                                            @if($or_right == 1)
                                                                {{--trình độ học vấn--}}
                                                                <div id="block01" data_show="note_title_cv_specialize"
                                                                     data_title="{{ !empty($cv_template->title_cv_specialize) ? $cv_template->title_cv_specialize : 'Trình độ học vấn' }}"
                                                                     data_box="block01"
                                                                     class="js_click_box cvo-block"
                                                                     @if(!empty($show_hidden_right[0])) style="display: none" @endif >
                                                                    <input type="hidden" name="cv_order_join[]"
                                                                           value="1">
                                                                    <input type="hidden"
                                                                    ...
                                                                    border-radius: 5px;
                                                                    padding: 5px;
                                                                    margin-top: 6px;" class="title_cv_specialize_plus">
                                                                            <i
                                                                    ...
                                                                    <p class="head">
                                                                        <input id="" class="block-title"
                                                                               ...
                                                                               contenteditable="true"
                                                                               value="{{ !empty($cv_template->title_cv_specialize) ? $cv_template->title_cv_specialize : 'Trình độ học vấn' }}"
                                                                               name="title_cv_specialize">
                                                                    </p>
                                                                    <div id="experience-table1">
                                                                        <?php
                                                                        $list_cv_spe = \App\Entity\Cv_specialize::get_template_id($cv_template->cv_template_id);
                                                                        ?>
                                                                        {{-- {{ dd($specialize[0]) }} --}}
                                                                        @if(!empty($specialize[0]))
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <h3>
                                                                                        <input class="exp-title"
                                                                                               contenteditable="true"
                                                                                               placeholder="{{ isset($spec->school) ? $spec->school : '' }} ({{ isset($spec->star_specialize_time) ? $spec->star_specialize_time : '' }}-{{ isset($spec->end_specialize_time) ? $spec->end_specialize_time : '' }})"
                                                                                               name="cv_spec_title[]"
                                                                                               value="">
                                                                                    </h3>
                                                                                    <p class="h3">
                                                                                        @php
                                                                                            $bc = \App\Entity\Literacy::where('literacy_id', $spec->leve)->value('literacy_name');
                                                                                        @endphp
                                                                                        <input
                                                                                                name="cv_spec_name[]"
                                                                                                class="exp-subtitle"
                                                                                                placeholder="Bằng cấp: {{ $bc }}"
                                                                                                contenteditable="true"
                                                                                                value="">
                                                                                    </p>
                                                                                    <textarea class="exp-content"
                                                                                              contenteditable="true"
                                                                                              placeholder="- Ngành học: {{ isset($spec->majors) ? $spec->majors : '' }}
                                                                                                      - Tình trạng: {{ isset($spec->specialize_status) ? $spec->specialize_status : '' }}"
                                                                                              name="cv_spec_desc[]">
                                                                            </textarea>
                                                                            ...
                                                                            @foreach($list_cv_spe as $id_spec=>$spec)
                                                                                <div id="exp{{ $id_spec + 1 }}"
                                                                                    ...
                                                                                    <h3>
                                                                                        <input class="exp-title"
                                                                                               contenteditable="true"
                                                                                               placeholder="{{ !empty($spec->cv_spec_title) ? $spec->cv_spec_title : '' }}"
                                                                                               name="cv_spec_title[]"
                                                                                               value="">
                                                                                    </h3>
                                                                                    <p class="h3"><input
                                                                                                name="cv_spec_name[]"
                                                                                                class="exp-subtitle"
                                                                                                placeholder="{{ !empty($spec->cv_spec_name) ? $spec->cv_spec_name : '' }}"
                                                                                                contenteditable="true"
                                                                                                value="">
                                                                                    </p>
                                                                                    <textarea class="exp-content"
                                                                                              contenteditable="true"
                                                                                              placeholder="{{ !empty($spec->cv_spec_desc) ? $spec->cv_spec_desc : '' }}"
                                                            ...
                                                            @if($or_right == 2)
                                                                ...
                                                                <div id="block02" data_show="note_title_cv_experience"
                                                                     data_title="{{ !empty($cv_template->title_cv_experience) ? $cv_template->title_cv_experience : 'Kinh nghiệm làm việc' }}"
                                                                     data_box="block02"
                                                                     class="js_click_box cvo-block"
                                                                    ...
                                                                    border-radius: 5px;
                                                                    padding: 5px;
                                                                    margin-top: 6px;" class=" title_cv_experience_plus">
                                                                            <i
                                                                                    class="fa fa-plus"></i> Thêm
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <p class="head">
                                                                        <input id="" class="block-title"
                                                                               placeholder="Tiêu đề mục lớn"
                                                                               contenteditable="true"
                                                                               value="{{ !empty($cv_template->title_cv_experience) ? $cv_template->title_cv_experience : 'Kinh nghiệm làm việc' }}"
                                                                               name="title_cv_experience">
                                                                    </p>
                                                                    <div id="experience-table2">
                                                                        <?php
                                                                        $list_cv_ex = \App\Entity\Cv_experience::get_template_id($cv_template->cv_template_id);
                                                                        ?>
                                                                        @if(!empty($experience[0]))

                                                                            @foreach($experience as $ex)
                                                                                <div class="ctbx experience">
                                                                                    <div class="fieldgroup_controls">
                                                                                        <div class="clone"><i
                                                                                                    class="fa fa-plus"></i>
                                                                                            Thêm
                                                                                    ...
                                                                                    <h3>
                                                                                        <input class="exp-title"
                                                                                               contenteditable="true"
                                                                                               placeholder="{{ !empty($ex->company) ? $ex->company : '' }} ({{ isset($ex->star_working_time  ) ? $ex->star_working_time : '...' }} - {{ isset($ex->end_working_time ) ? $ex->end_working_time   : '...' }})"
                                                                                               name="cv_ex_title[]"
                                                                                               value="">
                                                                                    </h3>
                                                                                    ...
                                                                                    <p class="h3"><input
                                                                                                class="exp-subtitle"
                                                                                                placeholder="Vị trí: {{ !empty($ex->position) ? $ex->position : '' }}"
                                                                                                contenteditable="true"
                                                                                                name="cv_ex_name[]"
                                                                                                value="">
                                                                                    </p>
                                                                                    ...
                                                                                    <?php
                                                                                    $listtype = \App\Entity\TypeOfBusiness::getIdTypeBusiness($ex->type_of_business_id);
                                                                                    $business = \App\Entity\Business::getId($ex->business)
                                                                                    ?>
                                                                                    <textarea name="cv_ex_desc[]"
                                                                                              class="exp-content"
                                                                                              contenteditable="true"
                                                                                              placeholder="- Mô tả công việc : {!! strip_tags($ex->des_position) !!}"></textarea>


                                                                                </div>
                                                                            @endforeach
                                                                        @elseif(!empty($list_cv_ex))
                                                                            @foreach($list_cv_ex as $id_ex=>$ex)
                                                                                <div id="exp{{$id_ex + 1}}"
                                                                                    ...
                                                                                    <h3>
                                                                                        <input class="exp-title"
                                                                                               contenteditable="true"
                                                                                               placeholder="{{ !empty($ex->cv_ex_title) ? $ex->cv_ex_title : '' }}"
                                                                                               name="cv_ex_title[]"
                                                                                               value="">
                                                                                    </h3>
                                                                                    <p class="h3"><input
                                                                                                class="exp-subtitle"
                                                                                                placeholder="{{ !empty($ex->cv_ex_name) ? $ex->cv_ex_name : '' }}"
                                                                                                contenteditable="true"
                                                                                                name="cv_ex_name[]"
                                                                                                value="">
                                                                                    </p>
                                                                                    <textarea name="cv_ex_desc[]"
                                                                                              class="exp-content"
                                                                                              contenteditable="true"
                                                                                              placeholder="{{ !empty($ex->cv_ex_desc) ? $ex->cv_ex_desc : 'Mô tả' }}"></textarea>
                                                                                </div>
                                                                            @endforeach
                                                            ...
                                                            @if($or_right == 3)
                                                                ...
                                                                <div id="block03" data_show="note_title_cv_work"
                                                                     data_title="{{ !empty($cv_template->title_cv_work) ? $cv_template->title_cv_work : 'Hoạt động' }}"
                                                                     data_box="block03"
                                                                     class="js_click_box cvo-block"
                                                                    ...
                                                                    <p class="head">
                                                                        <input name="title_cv_work" id=""
                                                                               ...
                                                                               placeholder="Tiêu đề mục lớn"
                                                                               contenteditable="true"
                                                                               value="{{ !empty($cv_template->title_cv_work) ? $cv_template->title_cv_work : 'Hoạt động' }}">
                                                                    </p>
                                                                    <div id="experience-table3">
                                                                        <?php
                                                                        $list_cv_work = \App\Entity\Cv_work::get_template_id($cv_template->cv_template_id);
                                                                        ?>
                                                                            ...
                                                                            @foreach($list_cv_work as $id_work=>$work)
                                                                                <div id="exp{{ $id_work + 1 }}"
                                                                                    ...
                                                                                    <h3>
                                                                                        <input class="exp-title"
                                                                                               contenteditable="true"
                                                                                               placeholder="{{ !empty($work->cv_work_title) ? $work->cv_work_title : '' }}"
                                                                                               name="cv_work_title[]"
                                                                                               value="">
                                                                                    </h3>
                                                                                    <p class="h3"><input
                                                                                                name="cv_work_name[]"
                                                                                                class="exp-subtitle"
                                                                                                placeholder="{{ !empty($work->cv_work_name) ? $work->cv_work_name : '' }}"
                                                                                                contenteditable="true"
                                                                                                value="">
                                                                                    </p>
                                                                                    <textarea class="exp-content"
                                                                                              contenteditable="true"
                                                                                              placeholder="{{ !empty($work->cv_work_desc) ? $work->cv_work_desc : 'Mô tả' }}"
                                                            ...
                                                            @if($or_right == 4)
                                                                ...
                                                                <div id="block04" data_show="note_title_cv_project"
                                                                     data_title="{{ !empty($cv_template->title_cv_project) ? $cv_template->title_cv_project : 'Dự án tham gia' }}"
                                                                     data_box="block04"
                                                                     class="js_click_box cvo-block"
                                                                    ...
                                                                    <p class="head">
                                                                        <input name="title_cv_project" id=""
                                                                               ...
                                                                               placeholder="Tiêu đề mục lớn"
                                                                               contenteditable="true"
                                                                               value="{{ !empty($cv_template->title_cv_project) ? $cv_template->title_cv_project : 'Dự án tham gia' }}">
                                                                    </p>
                                                                    <div id="experience-table4">
                                                                        <?php
                                                                        $list_cv_project = \App\Entity\Cv_project::get_template_id($cv_template->cv_template_id);
                                                                        ?>
                                                                                ...
                                                                                <div id="exp{{ $id_project + 1 }}"
                                                                                    ...
                                                                                    <h3>
                                                                                        <input name="cv_project_title[]"
                                                                                               class="exp-title"
                                                                                               contenteditable="true"
                                                                                               placeholder="{{ !empty($project->cv_project_title) ? $project->cv_project_title : '' }}"
                                                                                               value="">
                                                                                    </h3>
                                                                                    <p class="h3"><input
                                                                                                name="cv_project_name[]"
                                                                                                class="exp-subtitle"
                                                                                                placeholder="{{ !empty($project->cv_project_name) ? $project->cv_project_name : '' }}"
                                                                                                contenteditable="true"
                                                                                                value="">
                                                                                    </p>
                                                                                    <textarea name="cv_project_des[]"
                                                                                              class="exp-content"
                                                                                              contenteditable="true"
                                                                                              placeholder="{{ !empty($project->cv_project_des) ? $project->cv_project_des : 'Mô tả' }}">
                                        </textarea>
                                                                                </div>
                                                                            @endforeach
                                                                        @endif
                                                            ...
                                                            @if($or_right == 5)
                                                                ...
                                                                <div id="block05" data_show="note_title_cv_info"
                                                                     data_title="{{ !empty($cv_template->title_cv_info) ? $cv_template->title_cv_info : 'Thông tin thêm' }}"
                                                                     data_box="block05"
                                                                     class="js_click_box cvo-block"
                                                                    ...
                                                                    <p class="head">
                                                                        <input name="title_cv_info" id=""
                                                                               ...
                                                                               placeholder="Tiêu đề mục lớn"
                                                                               contenteditable="true"
                                                                               value="{{ !empty($cv_template->title_cv_info) ? $cv_template->title_cv_info : 'Thông tin thêm' }}">
                                                                    </p>
                                                                    <div id="experience-table5">
                                                                        <?php
                                                                        $list_cv_info = \App\Entity\Cv_info::get_template_id($cv_template->cv_template_id);
                                                                        ?>
                                                                                ...
                                                                                <div id="exp{{ $id_info + 1 }}"
                                                                                    ...
                                                                                    <h3>
                                                                                        <input name="cv_info_title[]"
                                                                                               class="exp-title"
                                                                                               contenteditable="true"
                                                                                               placeholder="{{ !empty($info->cv_info_title) ? $info->cv_info_title : '' }}"
                                                                                               value="">
                                                                                    </h3>
                                                                                    <p class="h3"><input
                                                                                                name="cv_info_name[]"
                                                                                                class="exp-subtitle"
                                                                                                placeholder="{{ !empty($info->cv_info_name) ? $info->cv_info_name : '' }}"
                                                                                                contenteditable="true"
                                                                                                value="">
                                                                                    </p>
                                                                                    <textarea name="cv_info_des[]"
                                                                                              class="exp-content"
                                                                                              contenteditable="true"
                                                                                              placeholder="{{ !empty($info->cv_info_des) ? $info->cv_info_des : 'Mô tả' }}"></textarea>
                                                                                </div>
                                                                            @endforeach
                                                                        @endif
                                                                    </div>
                                                    ...
                                                    <div class="ir">
                                                        <div id="sortable">
                                                            ...
                                                            <div id="box01" data_box="box01"
                                                                ...
                                                                <p class="icoweb cvi-envelope-square"><input
                                                                            type="email"
                                                                            id="cv-profile-email" readonly
                                                                            placeholder="Email"
                                                                            contenteditable="true"
                                                                            name="cv_email"
                                                                ...
                                                                ?>
                                                                <p class="icoweb cvi-date"><input
                                                                            id="cv-profile-birthday" readonly
                                                                            placeholder="Ngày sinh"
                                                                            contenteditable="true"
                                                                            name="cv_birthday"
                                                                            value="{{ !empty($date) ? date_format($date,"d/m/Y") : '' }}">
                                                                </p>


                                                                <p class="icoweb cvi-map-marker" readonly
                                                                   style="height:75px"><textarea
                                                                            id="cv-profile-address"
                                                                            placeholder="Địa chỉ"
                                                                            contenteditable="true"
                                                                            name="cv_address">{{!empty($employee->address) ? $employee->address : ''  }}</textarea>
                                                                </p>

                                                                <p class="icoweb cvi-info"><textarea style="height:60px"
                                                                                                     id="cv-profile-face"
                                                                                                     placeholder="Facebook"
                                                                                                     contenteditable="true"
                                                                                                     name="cv_facebook">{{ isset($employee->my_facebook) ? $employee->my_facebook : '' }}</textarea>
                                                                </p>
                                                            ...
                                                            <?php
                                                            $order_left = array();
                                                            $order_left = explode(',', $cv_template->cv_order);
                                                            $show_hidden_left = array();
                                                            $show_hidden_left = explode(',', $cv_template->show_hidden_cv_order);
                                                            ?>
                                                            @foreach($order_left as $or_left)
                                                                @if($or_left == 1)
                                                                    <div id="box02" data_box="box02"
                                                                         data_show="note_cv_title_career_goals"
                                                                         data_title="{{ !empty($cv_template->cv_title_career_goals) ? $cv_template->cv_title_career_goals : 'Thông tin thêm' }}"
                                                                         class="js_click_box block cvo-block"
                                                                         @if(!empty($show_hidden_left[0])) style="display: none" @endif>
                                                                        <input type="hidden" name="cv_order[]"
                                                                               value="1">
                                                                        <input type="hidden"
                                                                        ...
                                                                        <div class="blockControls">
                                                                            <div title="Di chuyển khối"
                                                                                 class="show-layout-editor"><i
                                                                                        class="fa fa-bars"></i></div>
                                                                            <div title="Chuyển mục này lên trên"
                                                                                 class="up">
                                                                                ▲
                                                                            </div>
                                                                            <div title="Chuyển mục này xuống dưới"
                                                                        ...
                                                                        <h3>
                                                                            <input
                                                                                    ...
                                                                                    value="{{!empty($cv_template->cv_title_career_goals) ? $cv_template->cv_title_career_goals : 'Mục tiêu nghề nghiệp' }}">
                                                                        </h3>
                                                                        <textarea name="cv_career_goals"
                                                                                  class="box-content"
                                                                                  contenteditable="true"
                                                                                  placeholder="{{!empty($cv_template->cv_career_goals) ? $cv_template->cv_career_goals : 'Mô tả mục tiêu nghề nghiệp' }}"></textarea>
                                                                ...
                                                                @if($or_left == 2)
                                                                    <div id="box03" data_box="box03"
                                                                         ...
                                                                         data_title="{{!empty($cv_template->title_cv_skills) ? $cv_template->title_cv_skills : 'Kỹ năng' }}"
                                                                        ...
                                                                        <h3><input name="title_cv_skills"
                                                                                   ...
                                                                                   placeholder="Kỹ năng"
                                                                                   class="box-title"
                                                                                   value="{{!empty($cv_template->title_cv_skills) ? $cv_template->title_cv_skills : 'Kỹ năng' }}">
                                                                        </h3>
                                                                        <div class="exp content-edit skill">
                                                                            <?php
                                                                            $list_cv_skill = \App\Entity\Cv_skills::get_template_id($cv_template->cv_template_id);
                                                                            ?>
                                                                                ...
                                                                                @foreach($list_cv_skill as $id_skill=>$skill)
                                                                                    <div class="ctbx">
                                                                                        ...
                                                                                        <input name="cv_skill_title[]"
                                                                                               ...
                                                                                               cv-form-field="true"
                                                                                               contenteditable="true"
                                                                                               placeholder="{{ !empty($skill->cv_skill_title) ? $skill->cv_skill_title : '' }}"
                                                                                               value="">
                                                                                        <div class="bar-exp">
                                                                ...
                                                                @if($or_left == 3)
                                                                    <div id="box04" data_box="box04"
                                                                         ...
                                                                         data_title="{{!empty($cv_template->cv_title_prize) ? $cv_template->cv_title_prize : 'Giải thưởng' }}"
                                                                         class="js_click_box block cvo-block"
                                                                        ...
                                                                        <h3>
                                                                            <input cv-form-field="true"
                                                                                   ...
                                                                                   class="box-title"
                                                                                   value="{{!empty($cv_template->cv_title_prize) ? $cv_template->cv_title_prize : 'Giải thưởng' }}"
                                                                                   name="cv_title_prize">
                                                                        </h3>
                                                                        <p><textarea class="box-content"
                                                                                     name="cv_prize"
                                                                                     placeholder="{{!empty($cv_template->cv_prize) ? $cv_template->cv_prize : '' }}"
                                                                ...
                                                                @if($or_left == 4)
                                                                    <div id="box05" data_box="box05"
                                                                         ...
                                                                         data_title="{{!empty($cv_template->cv_title_card) ? $cv_template->cv_title_card : 'Chứng chỉ' }}"
                                                                         class="js_click_box block cvo-block"
                                                                        ...
                                                                        <h3>
                                                                            <input cv-form-field="true"
                                                                                   ...
                                                                                   class="box-title"
                                                                                   value="{{!empty($cv_template->cv_title_card) ? $cv_template->cv_title_card : 'Chứng chỉ' }}"
                                                                                   name="cv_title_card">
                                                                        </h3>
                                                                        <p><textarea name="cv_card"
                                                                                     class="box-content"
                                                                                     contenteditable="true"
                                                                                     placeholder="{{!empty($cv_template->cv_card) ? $cv_template->cv_card : '' }}"
                                                                                     contenteditable="true"></textarea>
                                                                        </p>
                                                                    </div>
                                                                @endif
                                                                @if($or_left == 5)
                                                                    <div id="box06" data_box="box06"
                                                                         ...
                                                                         data_title="{{!empty($cv_template->cv_title_interests) ? $cv_template->cv_title_interests : 'Sở thích' }}"
                                                                         class="js_click_box block cvo-block"
                                                                        ...
                                                                        <h3>
                                                                            <input cv-form-field="true"
                                                                                   ...
                                                                                   class="box-title"
                                                                                   value="{{!empty($cv_template->cv_title_interests) ? $cv_template->cv_title_interests : 'Sở thích' }}"
                                                                                   name="cv_title_interests">
                                                                        </h3>
                                                                        <p><textarea name="cv_interests"
                                                                                     class="box-content"
                                                                                     placeholder="{{!empty($cv_template->cv_interests) ? $cv_template->cv_interests : '' }}"
                                                                                     contenteditable="true"></textarea>
                                                                        </p>
                                                                    </div>
                                                                @endif
                                                                @if($or_left == 6)
                                                                    <div id="box07" data_box="box07"
                                                                         ...
                                                                         data_title="{{!empty($cv_template->cv_title_reference_person) ? $cv_template->cv_title_reference_person : 'Người tham chiếu' }}"
                                                                         class="js_click_box block cvo-block"
                                                                        ...
                                                                        <h3>
                                                                            <input cv-form-field="true"
                                                                                   ...
                                                                                   class="box-title"
                                                                                   value="{{!empty($cv_template->cv_title_reference_person) ? $cv_template->cv_title_reference_person : 'Người tham chiếu' }}"
                                                                                   name="cv_title_reference_person">
                                                                        </h3>
                                                                        <p><textarea name="cv_reference_person"
                                                                                     class="box-content editor"
                                                                                     id="cv_reference_person"
                                                                                     placeholder="{{!empty($cv_template->cv_reference_person) ? $cv_template->cv_reference_person : '' }}"
                                                                                     contenteditable="true"></textarea>
                                                                        </p>
                                                                    </div>
                                                                @endif
                                        ...
                                        <div class="box-four make-me-sticky" id="">
                                            <div class="sidebar__inner">
                                                <div class="title_guide_cv">
                                                    <h4 class="mg0"><i
                                                                class="fa fa-info-circle"></i><span> Hướng dẫn</span>
                                                    </h4>
                                                    <p><i>Một số thông tin cơ bản sẽ lấy từ hồ sơ của bạn</i></p>
                                                </div>
                                                ...
                                                <div class="item item_cv_note note_cv_personal hidden_cv_guide">
                                                    <div class="item_title_gui_cv">
                                                        <h4><i class="fa fa-info-circle"></i>
                                                            <span>Thông tin cá nhân</span></h4>
                                                    </div>
                                                    <div class="content_guide_cv">
                                                ...
                                                <div class="item item_cv_note note_cv_title_career_goals hidden_cv_guide">
                                                    <div class="item_title_gui_cv">
                                                        <h4><i class="fa fa-check-circle"></i><span> Mục tiêu nghề nghiệp</span>
                                                        </h4>
                                                    </div>
                                                    <div class="content_guide_cv">
                                                ...
                                                <div class="item item_cv_note note_title_reference_person hidden_cv_guide">
                                                    <div class="item_title_gui_cv">
                                                        <h4><i class="fa fa-bookmark"></i><span> Liên hệ (người tham chiếu)</span>
                                                        </h4>
                                                    </div>
                                                    <div class="content_guide_cv">
                                                ...
                                                <div class="item item_cv_note note_title_cv_specialize hidden_cv_guide">
                                                    <div class="item_title_gui_cv">
                                                        <h4><i class="fa fa-graduation-cap"></i><span> Trình độ</span>
                                                        </h4>
                                                    </div>
                                                    <div class="content_guide_cv">
                                                ...
                                                <div class="item item_cv_note note_title_cv_experience hidden_cv_guide">
                                                    <div class="item_title_gui_cv">
                                                        <h4><i class="fa fa-briefcase"></i>
                                                            <span>Kinh nghiệm làm việc</span></h4>
                                                    </div>
                                                    <div class="content_guide_cv">
                                                ...
                                                <div class="item item_cv_note note_title_cv_work hidden_cv_guide">
                                                    <div class="item_title_gui_cv">
                                                        <h4><i class="fa fa-group"></i> <span>Hoạt động xã hội</span>
                                                        </h4>
                                                    </div>
                                                    <div class="content_guide_cv">
                                                ...
                                                <div class="item item_cv_note note_title_cv_project hidden_cv_guide">
                                                    <div class="item_title_gui_cv">
                                                        <h4>
                                                            <i class="fas fa-project-diagram"></i><span>Dự án tham gia</span>
                                                        </h4>
                                                    </div>
                                                    <div class="content_guide_cv">
                                                ...
                                                <div class="item item_cv_note note_title_cv_info hidden_cv_guide">
                                                    <div class="item_title_gui_cv">
                                                        <h4><i class="fa fa-pencil"></i> <span>Thông tin khác</span>
                                                        </h4>
                                                    </div>
                                                    <div class="content_guide_cv">
                ...
                @foreach($order_right   as $or_right)
                    @if($or_right == 1)
                        ...
                        @else active @endif " blockmain="experiences" blockkey="block01">
                            <div class="selector"><i class="fa fa-check"></i></div>
                            <span>{{ !empty($cv_template->title_cv_specialize) ? $cv_template->title_cv_specialize : 'Trình độ học vấn' }}</span>
                            <i class="fa fa-bars icon-order"></i>
                        </div>
                    @endif
                    @if($or_right == 2)
                        ...
                        @else active @endif" blockmain="experiences" blockkey="block02">
                            <div class="selector"><i class="fa fa-check"></i></div>
                            <span>{{ !empty($cv_template->title_cv_experience) ? $cv_template->title_cv_experience : 'Kinh nghiệm làm việc' }}</span>
                            <i class="fa fa-bars icon-order"></i>
                        </div>
                    @endif
                    @if($or_right == 3)
                        ...
                        @else active @endif" blockmain="experiences" blockkey="block03">
                            <div class="selector"><i class="fa fa-check"></i></div>
                            <span>{{ !empty($cv_template->title_cv_work) ? $cv_template->title_cv_work : 'Hoạt động' }}</span>
                            <i class="fa fa-bars icon-order"></i>
                        </div>
                    @endif
                    @if($or_right == 4)
                        ...
                        @else active @endif" blockmain="experiences" blockkey="block04">
                            <div class="selector"><i class="fa fa-check"></i></div>
                            <span>{{ !empty($cv_template->title_cv_project) ? $cv_template->title_cv_project : 'Dự án tham gia' }}</span>
                            <i class="fa fa-bars icon-order"></i>
                        </div>
                    @endif
                    @if($or_right == 5)
                        ...
                        @else active @endif" blockmain="experiences" blockkey="block05">
                            <div class="selector"><i class="fa fa-check"></i></div>
                            <span>{{ !empty($cv_template->title_cv_info) ? $cv_template->title_cv_info : 'Thông tin thêm' }}</span>
                            <i class="fa fa-bars icon-order"></i>
                        </div>
                    @endif
                @endforeach
