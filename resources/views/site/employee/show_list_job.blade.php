...
@section('title', 'Danh sách tin tuyển dụng chia sẻ')
@section('meta_description', 'Danh sách tin tuyển dụng chia sẻ')
@section('keywords', 'Danh sách tin tuyển dụng chia sẻ')
                    ...
                    <div class="link bgrWhite md-mgt20 mgb10">
                        <ul class="nav">
                            ...
                            <li class="nav-item pd8">
                                ...
                                <a href="{{ route('show_list_job') }}" class="f18 md-f14 blueDN hvBlueDN"> <i
                                            class="fas fa-donate mgr5"></i>Kiếm tiền từ chia sẻ tin tuyển dụng</a>
                            </li>
                        </ul>
                    </div>
