...
@section('content')
                        ...
                        <div class="contentJobsInteresting pdl15 pdr15 col-f14">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12 col-12">
                                    <div class="CV bgrWhite radius5 mgt20 mgb20 pdb5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 change_right">
                                                <h5 class="mgt15"> Đổi thẻ điện thoại </h5>
                                                ...
                                                <form method="post" action="{{ route('update_change_card') }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select  class="form-control" id="" name="transaction_card_name">
                                                            <option value="Vinaphone" @if(isset($transaction_card->transaction_card_name) && $transaction_card->transaction_card_name == 'Vinaphone') selected @endif>Vinaphone</option>
                                                            <option value="Viettel" @if(isset($transaction_card->transaction_card_name) && $transaction_card->transaction_card_name == 'Viettel') selected @endif>Viettel</option>
                                                            <option value="MobiFone" @if(isset($transaction_card->transaction_card_name) && $transaction_card->transaction_card_name == 'MobiFone') selected @endif>MobiFone</option>
                                                            <option value="Vietnamobile" @if(isset($transaction_card->transaction_card_name) && $transaction_card->transaction_card_name == 'Vietnamobile') selected @endif>Vietnamobile</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleFormControlSelect2">Lựu chọn mệnh giá thẻ<span
                                                                    class="clred">(*)</span></label>
                                                        <select  class="form-control" id="transaction_card_price" name="transaction_card_price">
                                                            ...
                                                            <option value="100000" @if(isset($transaction_card->transaction_card_price) && $transaction_card->transaction_card_price == 100000) selected @endif>100.000 VND</option>
                                                            <option value="200000" @if(isset($transaction_card->transaction_card_price) && $transaction_card->transaction_card_price == 200000) selected @endif>200.000 VND</option>
                                                            <option value="300000" @if(isset($transaction_card->transaction_card_price) && $transaction_card->transaction_card_price == 300000) selected @endif>300.000 VND</option>
                                                            <option value="500000" @if(isset($transaction_card->transaction_card_price) && $transaction_card->transaction_card_price == 500000) selected @endif>500.000 VND</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control"
                                                               ...
                                                               placeholder="Số điện thoại nạp" required value="{{ isset($transaction_card->transaction_card_phone) ? $transaction_card->transaction_card_phone : '' }}">
                                                    </div>
                                                    ...
                                                    <button type="submit" class="btn btnOrang"
                                                            @if($employee_coints->money < 20000 or empty($money_pay->money_surplus) ) disabled @endif>
                                                        Đổi thẻ
                                                        cào
                                                    </button>
                                                </form>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12 col-12 mbpd0">
                                    ...
                                    @if(!empty($transaction_history_card))
                                        ...
                                        <table id="jobfb" class="table table-hover table-bordered dsNone mbdsBlock">
                                            ...
                                            @foreach($transaction_history_card as $id_tran=>$transaction_history)
                                                <tr>
                                                    <td class="text-center" style="align-items: center"> {{ $id_tran + 1  }}</td>
                                                    <td>
                                                        <p class="mgb5">
                                                            Tên nhà mạng : {{ $transaction_history->transaction_card_name }}
                                                        </p>
                                                        <p class="mgb5">
                                                            Số tiền nạp :{{ number_format($transaction_history->transaction_card_price) }} VND
                                                        </p>
                                                        <p class="mgb5">
                                                            Số điện thoại nạp :{{ $transaction_history->transaction_card_phone }}
                                                        </p>
                                                        <p class="mgb5">
                                                            Ghi chú :{{ $transaction_history->transaction_content }}
                                                        </p>
                                                        <p class="mgb5">
                                                            Trạng thái : @if($transaction_history->transaction_status == 0)
                                                                <span class="btnOrang">Chưa duyệt </span>
                                                            @endif
                                                            @if($transaction_history->transaction_status == 1)
                                                                <span class="btnRed">Hủy giao dịch </span>
                                                        ...
                                                        <p class="mgb5">
                                                            Ngày đổi thẻ : <i class="far fa-clock"></i> <?php
                                                            $date = date_create($transaction_history->created_at);
                                                            echo date_format($date, "H:i:s");
                                                            ?>
                                                        ...
                                                        <p class="mgb5">
                                                            Admin trả lời : @if(!empty($transaction_history->transaction_admin_reply))
                                                                <span class="btnGreen dsInline" style="padding: 3px 10px;" data-toggle="modal" data-target="#transaction_card{{$id_tran}}">Xem nội dung </span>
                                                            @endif
                                                        </p>
                                                        <p class="mgb5">
                                                            @if(!empty($transaction_history->updated_at))
                                                            Ngày duyệt : <i class="far fa-clock"></i> <?php
                                                            $date = date_create($transaction_history->created_at);
                                                            echo date_format($date, "H:i:s");
                                                            ?>
                                                            <i class="far fa-calendar-times"></i> <?php
    ...
    <script>
        $('#submitChange').submit(function () {
            ...
            //check số dư trong tài khoản phải nhỏ hơn card và số tiền rút phải nhỏ hơn lượng tiền trong hệ thống
            if (money < card && card > max_money_month) {
                $('#message').modal('show');
