...
$cv_template = \App\Entity\Cv_template::get_template();
$cv_employee = \App\Entity\Cv_employee::get_cv_employee($employee->employee_id);
//    echo '<pre>';
                                                        ...
                                                        @foreach($list_cv_work as $id_work=>$work)
                                                            <div id="exp{{ $id_work + 1 }}"
                                                                ...
                                                                <div readonly class="exp-content div_textarea"
                                                                     ...
                                                                     placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
                                                                     name="cv_work_desc[]"> {{ !empty($work->cv_work_desc) ? $work->cv_work_desc : '' }}</div>
                                                            </div>
                                                        @endforeach
                                                    @endif
                                                </div>
                                                        ...
                                                        @foreach($list_cv_info as $id_info=>$info)
                                                            <div id="exp{{ $id_info + 1 }}"
                                                                ...
                                                                <div readonly name="cv_info_des[]"
                                                                     ...
                                                                     placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc.">{{ !empty($info->cv_info_des) ? $info->cv_info_des : '' }}</div>
                                                            </div>
                                                        @endforeach
                                                    @endif
                                                </div>
                                ...
                                <div class="ir">
                                    <div id="sortable">
                                        <div id="box01" data_box="box01"
                                            ...
                                            <p class="icoweb cvi-envelope-square"><input readonly
                                                                                         type="email"
                                                                                         id="cv-profile-email"
                                                                                         placeholder="Email"
                                            ...
                                            <p class="icoweb cvi-phone"><input readonly
                                                                               id="cv-profile-phone"
                                            ...
                                            <p class="icoweb cvi-map-marker div_input"
                                               style="color: black !important;">{{!empty($cv_employee->cv_address) ? $cv_employee->cv_address : $employee->address  }}
                                            </p>

                                            <p class="icoweb cvi-info div_input"
                                               style="color: black !important;">{{!empty($cv_employee->cv_facebook) ? $cv_employee->cv_facebook : $employee->my_facebook  }}
                                            </p>
                                        </div>
                                        ...
                                        @foreach($order_left as $or_left)
                                            ...
                                            @if($or_left == 5)
                                                <div id="box06" data_box="box06"
                                                    ...
                                                    <p>
                                                    <div readonly name="cv_interests"
                                                         class="box-content div_textarea"
                                                         placeholder="Đang cập nhật thông tin"
                                                    >{{!empty($cv_employee->cv_interests) ? $cv_employee->cv_interests : '' }}</div>
                                                    </p>
                                            ...
                                            @if($or_left == 6)
                                                <div id="box07" data_box="box07"
                                                    ...
                                                    <p>
                                                    <div readonly name="cv_reference_person"
...
@else
    <div class="col-md-12 bgrWhite mgt20 pd20">
        <p class="clred mgb0">Ứng viên này chưa cập nhật CV !</p>
    </div>
