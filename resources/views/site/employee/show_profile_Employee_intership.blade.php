        ...
        <div class="container-fluid ">
            <div class="row ">
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 col-12 col-12">
                    ...
                    <div class="CV bgrWhite radius5 pd20  mgb20 pdb5 UpdateUserTab mgt20">
                    ...
                    <div class="col-md-12  mgt15">
                        <div class="row">
                            ...
                            {{--<div class="col-lg-3 col-md-12 pdl15 pdRight15 text-right">--}}
                            {{--<a class="mgr15" style="color: white;;background: orange;padding: 5px 15px;"--}}
                            {{--data-toggle="modal" data-target="#notiModalEmployee">Mời ứng viên</a>--}}
                            {{--<p></p>--}}
                            {{--<a class="mgr15" style="color: white;;background: orange;padding: 5px 15px;"  data-toggle="modal" data-target="#notiModalEmployee">Thông tin liên hệ</a>--}}
                            {{--</div>--}}
                            {{--@endif--}}
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="submit_job_img">
                                                ...
                                                @if(!empty($cv_employee))
                                                    <a target="_blank"
                                                       href="{{ route('show_cv_detail_employee',['employee_id'=>$employee->employee_id]) }}">Xem
                                                        CV</a>
                                                @else
                                                    <a href="#">Đang cập
                                                        nhật</a>
                                        ...
                                        @if($employee_show_syll->show_hidden_syll == 0)
                                            <div class="text-center">
                                                ...
                                                <div class="submit_job_img">
                                                    ...
                                                    @if(!empty($check_syll))
                                                        <a target="_blank"
                                                           href="{{ route('show_syll_detail_employee',['employee_id'=>$employee->employee_id]) }}">Xem
                                                            sơ yếu lý lịch</a>
                                                    @else
                                                        <a href="#">Đang cập
                                                            nhật</a>
                    ...
                    <div class="CV bgrWhite radius5 pd20  mgb20 pdb5 UpdateUserTab">
                        <label class="clHome f20 fw6">Trạng thái hồ sơ</label>
                        <form method="post" action="{{ route('update_id_status_intership') }}">
                            {!! csrf_field() !!}
                            <select class="form-control form-control-sm js_change_select" name="id_status[{{ $intership['intership_id']}}]">
                                <option value="0" id_status="{{ $intership['id_status']}}" @if($intership['id_status'] == '0' && empty($intership['id_status']   )) selected @endif>Trạng thái</option>
                                <?php
                                ...
                                @foreach($list_status as $status)
                                    <option value="{{ isset($status->id_status) ? $status->id_status : '' }}"
                                            ...
                                            id_status="{{ $intership['id_status'] }}"
                                            @if($intership['id_status'] == $status->id_status && !empty($intership['id_status'] ))
                                            selected
                                            @endif>
                            ...
                            <button class="btnOrang mgt15" type="submit" id="js_save_submit">
                                Lưu trạng thái
                            </button>
                        </form>
