    ...
    <div class="col-lg-3 pdr0">
        <div class="imagePostSale">
            ...
            <p class="mgb0 mgt5 text-center limiEmail">
                <span class="clGreen  f14 dsInline mgr10 relative-4px"><i class="fas fa-eye f16"></i> {{ isset($employerstar->view) ? $employerstar->view : '0' }} </span>
            </p>
        </div>
    </div>
    <div class="col-lg-9">
        <div class="contentPostSale">
            <a href="{{ route('detail_intership',['slug'=>$employerstar['slug'] ]) }}" class=""><h3 class="clOrange f14 fw6 cutTitle2">{{ isset($employerstar->enterprise_name) ? $employerstar->enterprise_name : '' }}</h3></a>
            ...
            <p class="sd_item_local mgb0 f12"><i class="fas fa-map-marker-alt gray"></i> @if(isset($distinct_star->district_name))
