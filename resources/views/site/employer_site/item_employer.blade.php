    ...
    <div class="row item_intership">
        ...
        <div class="col-max-10 col-xl-9 col-lg-9 col-md-7">
            <div class="contentPostSale">
                <a href="{{ route('detail_intership',['slug'=>$employer['slug'] ]) }}" class="">
                    <h3 class="item_intership_title cutTitle">{{ isset($employer['enterprise_name']) ? $employer['enterprise_name'] : ''}}</h3>
                </a>
                ...
                <p class="mgb5">
                    ...
                    <i>
                    <span class="item_intership_local ">
                        <i class="fas fa-map-marker-alt f16"></i>
                ...
                <div class="descriptionPostSale">
                    ...
                    <div class=" text-left item_intership_star"><span class="fw6 dsnonelg" style="vertical-align: text-bottom;"> Đánh giá : </span>
                        <span class="rate-product mgr10" style=""></span>
                        <script>
                        ...
                        <span class="item_intership_view"><i class="fas fa-eye f16"></i> {{ $employer['view'] }} lượt xem</span>
                        @endif
                        @if(!empty($employer['status_allowance']))
                        <span class="item_intership_allwance"><i class="fab fa-rebel f16"></i> Có phụ cấp </span>
                            @endif
                        ...
                        @if(!empty($employer->type_of_business_id))
                            ...
                            ?>
                        <span class="item_intership_business"> <i class="far fa-building f16"></i> {{ $type_of_business->type_of_business_name }} </span>
                            @endif

                    </div>
                </div>
                <a href="{{ route('detail_intership',['slug'=>$employer['slug'] ]) }}" class="item_intership_link">Xem thêm</a>
            </div>
