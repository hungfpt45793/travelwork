<div class="row justify-content-md-center bg_list_price_pree">
    ...
    <div class="col-md-6 ">
        <div class="item_box_price box_price_right">
            ...
            <div class="button_list_price text-center">
                <a href="{{ route('detail_list_price',['slug'=>'goi-dich-vu-loc-ho-so']) }}#href_table_combo_profile">XEM
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center modal_button_header">
                    <img class="lazy" alt="" width="100%"
                         src="https://sanketoan.vn/public/library/images/home_new/Logo.png" style="">
