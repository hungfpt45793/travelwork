                                        ...
                                        <div class="page_ctr">
                                            ...
                                            <div class="p1-d1">
                                                ...
                                                <input readonly  id="mobile" name="mobile" class="line" cvo-placeholder=""
                                                       contenteditable=""
                                                       value="{{ isset($employee_curriculum->mobile) ? $employee_curriculum->mobile : $employee->phone }}">
                                                    @else
                                                    <input readonly  id="mobile" name="mobile" class="line" cvo-placeholder=""
                                                           contenteditable=""
                                                           value="********">
                                            ...
                                            <div class="p1-d1">
                                                ...
                                                @else
                                                    <?php
                                                    $replace_baotin = \App\Ultility\Ultility::replace_phone($employee_curriculum->baotin);
                                                    ?>
                                                        <textarea readonly  id="baotin" name="baotin" class="line d3"
                                                                  cvo-placeholder="" contenteditable=""
                                                                  rows="3">{!! !empty($replace_baotin)  ? $replace_baotin : '' !!}</textarea>
                                                @endif
