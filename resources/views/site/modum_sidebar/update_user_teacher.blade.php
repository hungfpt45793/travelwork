                            ...
                            <div class="col-xl-12 col-lg-12 left">
                                <form action="{{ route('updateTeacher') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row mgt20 gruopRadio">
                                        ...
                                        <div class="col-md-6">
                                            <label for="inputAddress2" class="fw6">Hình ảnh giáo viên : </label> <a href="https://sanketoan.vn/ho-tro/huong-dan-tai-anh-dai-dien-vao-ho-so-giao-vien-ung-vien-nha-tuyen-dung" target="_blank">(Hướng dẫn chọn ảnh)</a>
                                            <div class="">
                                        ...
                                        @if(empty($course))
                                            <form role="form" action="{{ route('store_Course_Teacher') }}" method="POST" class="" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <label for="inputAddress2" class="fw6">Hình ảnh : </label> <a href="https://sanketoan.vn/ho-tro/huong-dan-tai-anh-dai-dien-vao-ho-so-giao-vien-ung-vien-nha-tuyen-dung" target="_blank">(Hướng dẫn chọn ảnh)</a>
                                                        <div class="">

                                                            <div class="form-group">
                                                                <input type="button" onclick="return uploadImage(this);" value="Chọn ảnh"
                                                                       size="20"/>
                                                                <img src="{{ isset($course->course_image) ? $course->course_image : '' }}" width="80" height=""/>
                                                                <input name="images" type="hidden" value="{{ isset($course->course_image) ? $course->course_image : '' }}"/>
                                                            </div>
                                                        </div>
