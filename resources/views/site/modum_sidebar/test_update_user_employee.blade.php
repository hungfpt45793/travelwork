                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12  mgt15">
                            ...
                            <div class="col-xl-12 col-lg-12 left">
                                ...
                                <form action="{{ route('updateEmployee') }}" method="post" class="mbformUpdateEmployee"
                                    ...
                                    <div class="form-group row mgb5">
                                        ...
                                        <label for="staticEmail" class="col-sm-3 col-form-label fw6 text-right">
                                            Đính kèm Hồ sơ cá nhân : <span class="clred fw5"
                                                                           id="">(*)</span>
                                            </br>
                                            <span>(.doc, .docx hoặc .pdf)</span>
                                        </label>

                                        <div class="col-sm-9  mgt5 pdLeft0 ">
                                            @if(file_exists(public_path().'/library_cv/'.$employee->file_cv))
                                                <label>
                                                    <input type="checkbox" name="checkUploadFile" value="1" class="js_checkUploadFile">
                                                    Chọn nếu muốn thay đổi file cv
                                                </label>
                                            @else
                                                <label>
                                                    <input type="checkbox" name="checkUploadFile" value="1" checked class="js_checkUploadFile"
                                                           style="opacity:0; position:absolute; left:9999px;">
                                                </label>

                                            @endif
                                            <input type="file" name="employee_cv" class="js_employee_cv" id="exampleInputFile">
...
<script>
    ...
    $(".custom-file-input").on("change", function() {
        ...
        var employee_cv = $('.js_employee_cv').val();
        if(employee_cv.search('.doc') == -1 && employee_cv.search('.docx') == -1 && employee_cv.search('.pdf') == -1){
            $('.js_error_employee_cv').html('Bạn chỉ được tải CV với đuôi .doc, .docx hoặc .pdf');
        }else if(this.files[0].size > 5000000)
        {
            $('.js_error_employee_cv').html('Bạn chỉ được tải CV có dung lượng <= 5M');
        }
        else {
            $('.js_error_employee_cv').html('');
        }
    });
