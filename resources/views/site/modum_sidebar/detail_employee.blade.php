                ...
                <div class="col-md-7 ">
                    <div class="row">
                        <div class="col-md-3 pd0">
                            <label for="inputAddress2" class="fw6 mgl15" style="display: block;">Điểm
                                hồ sơ : </label>
                        </div>
                        <div class="col-md-9">
                            <div class="progress mgr15">
                                <div class="progress-bar progress-bar-striped bg-success"
                                     ...
                                     aria-valuemin="0"
                                     aria-valuemax="100">{{ round($employee->profile) }} điểm
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="contentJobsInteresting pdl15 pdr15 col-f14">
            <div class="row">
                @foreach($relate_employee as $relate)
                    @include('site.employee.item_employee_list',['employee' => $relate])
                @endforeach
            </div>
        </div>
    </section>
