                            ...
                            <div class="col-xl-12 col-lg-12 left">
                                ...
                                <div class="form-group mgb0">
                                    <div class="" style="margin: 10px 0">
                                        ...
                                        <span class="green">{{ !empty($employee['views']) ? $employee['views'] : '0' }} <i class="far fa-eye"></i></span>
                                    </div>
                                </div>
                                <div class="form-group mgb0">
...
<!-- Modal -->
<div class="modal fade" id="notiModalEmployee" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Chức năng này đang được xây dựng</h5>
