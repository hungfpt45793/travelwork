...
<div class="CV bgrWhite radius5 pd20  mgb20 pdb5 UpdateUserTab">
    <ul class="nav nav-tabs tabSteep" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link arrowLine @if(session('suscess_specialize'))active @endif" id="profile-tab" data-toggle="tab"
        ...
        <li class="nav-item">
            <a class="nav-link arrowLine @if(session('suscess_experience'))active @endif" id="contact-tab" data-toggle="tab"
                        ...
                        <div class="col-md-12  mgt15">
                            ...
                            <div class="col-xl-12 col-lg-12 left">
                                <form action="{{ route('updateEmployee') }}" method="post"
                                    ...
                                    <div class="form-row mgt20 gruopRadio" style="margin-bottom: 10px">
                                        <div class="col-md-2 ">
                                            <label for="inputAddress2" class="fw6 taright" style="display: block;">Hoàn thiện
                                                hồ sơ : </label>
                                        </div>
                                        <div class="col-md-4 ">
                                            <div class="progress">
                                        ...
                                        <div class="col-md-2 ">
                                            <label for="inputAddress2" class="fw6 taright" style="display: block;">Trạng thái ứng viên</label>
                                        </div>
                                    ...
                                    <div style="margin-bottom: 15px">
                                        <span class="colorGray">Chú ý: <span class="colorRed">(*)</span> Thông tin bắt buộc!</span>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputAddress2" class="col-sm-2 col-form-label fw6 taright">Họ và tên :
                                        </label>
                                        <input type="text" class="form-control col-md-6 error_border_employee_name"
                                               placeholder="Nhập tên ứng viên"
                                               name="employee_name" id="employee_name"
                                               value="{{  isset($employee->employee_name) ? $employee->employee_name : '' }}">
                                        <span class="colorRed" id="note_employee_name">(*)</span>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputAddress2" class="col-sm-2 col-form-label fw6 taright">Ngày sinh :
                                        </label>
                                        <input type="date" class="form-control col-md-6 error_border_birthday"
                                               placeholder="Ngày sinh"
                                               name="birthday" id="birthday"
                                               value="{{ isset($employee->birthday) ? $employee->birthday : ''
                                                    }}" max="{{ date("Y-m-d") }}">
                                        <span class="colorRed" id="note_birthday">(*)</span>
                                        <div class="error_message">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputAddress2" class="col-sm-2 col-form-label fw6 taright">Email:
                                        </label>
                                        <input  type="email" class="form-control col-md-6"
                                                ...
                                                readonly
                                        >
                                        <span class="colorRed" id="note_email">(*)</span>
                                        <div style="margin-top: 6px">
                                            <i class=" mgLeft5"> (Tài
                                                khoản đăng nhập ! Đổi tài khoản <a href="{{ route('management_account') }}">Tại đây</a> )</i>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputAddress2" class="col-sm-2 col-form-label fw6 taright">Số điện thoại :
                                        </label>
                                        <input type="number" class="form-control col-md-6 error_border_phone"
                                               placeholder="Nhập số điện thoại"
                                               name="phone" id="phone"
                                               value="{{ isset($employee->phone) ? $employee->phone : '' }}">
                                        <span class="colorRed" id="note_phone">(*)</span>
                                        <div class="error_message">
                                    ...
                                    <div class="form-group row gruopRadio">
                                        <label for="inputAddress2" class="col-sm-2 col-form-label fw6 taright" style="display: block;">Giới tính:
                                        </label>
                                        <div class="col-md-6">
                                            <div class="form-check" style="display: inline-block; margin-right: 15px;">
                                                <input class="form-check-input error_border_gender" type="radio" name="gender"
                                                       id="exampleRadios2"
                                        ...
                                        <span class="colorRed" id="note_gender">(*)</span>
                                        <div class="error_message">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-2 col-form-label fw6 taright">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="images" type="text"
                                                       value="{{ isset($employee->employee_image) ? $employee->employee_image: '' }}" style="border:none !important;color: #fff !important;position: absolute;left: 0;width: 84px;z-index: -9;"/>
                                    ...
                                    <!-- <div class="form-row mgt20 gruopRadio">
                                          ...
                                          <div class="col-md-4">
                                              <label for="inputAddress2" class="fw6 taright">Hình ảnh ứng viên : </label><a href="https://sanketoan.vn/ho-tro/huong-dan-tai-anh-dai-dien-vao-ho-so-giao-vien-ung-vien-nha-tuyen-dung" target="_blank">(Hướng dẫn chọn ảnh)</a>
                                    ...
                                    <div class="col-md-12">
                                        <label for="inputAddress2" class="text-bold"><i style="font-weight: 500">Địa chỉ ứng viên(vui lòng chọn đúng địa điểm để tìm việc dễ hơn)</i></label>
                                    </div>
                                    <div class="form-group row">
                                        <label for="exampleInputEmail1" class="col-sm-2 col-form-label fw6 taright">Địa chỉ cụ thể:
                                        </label>

                                        <input style="width: 100%" type="text" class="form-control col-md-6 error_border_address"
                                               placeholder="Địa chỉ "
                                               name="address"
                                               value="{{ isset($employee->address) ? $employee->address : '' }}">


                                        <span class="colorRed" id="note_address">(*)</span>
                                        <div class="error_message">
                                            <div class="mess_notice_address clearfix note_text_address"></div>
                                            <div class="error_reg_mess clearfix error_text_address"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row borderSelect2">
                                        <label for="exampleInputEmail1" class="col-sm-2 col-form-label fw6 taright">Tỉnh/Thành phố:
                                        </label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row borderSelect2">
                                        <label for="exampleInputEmail1" class="col-sm-2 col-form-label fw6 taright">Quận/Huyện: </label>
                                        <select class="form-control col-md-6 select2 error_border_district" name="district"
                                        ...
                                        <span class="colorRed" id="note_district">(*)</span>
                                        <div class="error_message">
                                    ...
                                    <div class="form-group row borderSelect2">
                                        <label for="exampleInputEmail1" class="col-sm-2 col-form-label fw6 taright">Công việc: </label>
                                        <select class="form-control col-md-6 select2 error_border_career_category_i" name="career_category_id"
                                                aria-label="Quận/Huyện"
                                                id="">
                                        ...
                                        <span class="colorRed" id="note_career_category_id">(*)</span>
                                        <div class="error_message">
                                    ...
                                    <div class="form-group row borderSelect2">
                                        <label for="exampleInputEmail1" class="col-sm-2 col-form-label fw6 taright">Mức lương: </label>
                                        <select class="form-control col-md-6 select2 error_border_salary_id" name="salary_id"
                                                aria-label="Quận/Huyện"
                                                id="">
                                        ...
                                        <span class="colorRed" id="note_salary_id">(*)</span>
                                        <div class="error_message">
                                    ...
                                    <div class="form-group row borderSelect2">
                                        <label for="exampleInputEmail1" class="col-sm-2 col-form-label fw6 taright">Trình độ: </label>
                                        ...
                                        <span class="colorRed" id="note_employee_level_id">(*)</span>
                                        <div class="error_message">
                                    ...
                                    <div class="form-group row borderSelect2">
                                        <label for="exampleInputEmail1" class="col-sm-2 col-form-label fw6 taright">Kinh nghiệm: </label>
                                        <select class="form-control col-md-6 select2 error_border_experience_id" name='experience_id'>
                                        ...
                                        <span class="colorRed" id="note_experience_id">(*)</span>
                                        <div class="error_message">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="inputAddress2" class="fw6">Địa chỉ mong muốn tìm việc</label>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group borderSelect2">
                                                <label for="exampleInputEmail1">Tỉnh/Thành phố</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="exampleInputEmail1" class="col-sm-2 col-form-label fw6 taright">Nội dung xin việc: </label>
                                        <textarea class="textarea w100 form-control"  name="information_verifier"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label fw6 taright">Bổ sung: </label>
                                        <button id="btnAdditional" type="button" class="whiteIm bgrBlueN fw7 radius5"
                                                style="border:none"><i class="fas fa-plus-square"></i></button>
                                    </div>
                                    ...
                                    <div id="additional" >
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label fw6 taright">Mã giới thiệu</label>
                                            <input type="text" class="form-control input col-md-6" placeholder="Nhập mã" title="Nhập mã giới thiệu (nếu có từ nhà tuyển dụng)"
                                                   name="code_intro"
                                                   value="{{ isset($employee->code_intro) ? $employee->code_intro : '' }}">
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label fw6 taright error_border_cmt">Chứng minh thư</label>
                                            <input type="number" class="form-control input col-md-6" placeholder="Nhập chưng minh thư nhân dân" name="cmt"
                                                   value="{{ isset($employee->cmt) ? $employee->cmt : '' }}">
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label fw6 taright">Ngày cấp</label>
                                            <input type="date" class="form-control input col-md-6 error_border_cmt_date" placeholder="Nhập ngày cấp"
                                                   name="cmt_date"
                                                   value="{{ isset($employee->cmt_date) ? $employee->cmt_date : '' }}">
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label fw6 taright">Nơi cấp</label>
                                            <input type="text" class="form-control input col-md-6 error_border_cmt_local" placeholder="Nhập nơi cấp"
                                                   name="cmt_local"
                                                   value="{{ isset($employee->cmt_local) ? $employee->cmt_local : '' }}">
                                        </div>
                                        <div class="form-group row gruopRadio">
                                            <label for="inputAddress2" class="col-sm-2 col-form-label fw6 taright" style="display: block;">Hôn nhân: </label>
                                            <div class="col-md-4">
                                                <div class="form-check" style="display: inline-block; margin-right: 10px;">
                                                    <input class="form-check-input error_border_marry" type="radio" name="marry"
                                                           id="exampleRadios4"
                                                ...
                                                <div class="error_message">
                                                    <div class="mess_notice_marry clearfix note_text_marry"></div>
                                                    <div class="error_reg_mess clearfix error_text_marry"></div>
                                                </div>
                                    ...
                                    <div class="form-group mgt15" style="margin-left: 140px">
                                        <!-- Google reCaptcha -->
                                    ...
                                    <div class="form-row mgt20" style="margin-left: 140px">
                                        <button type="submit" class="pd10-30 whiteIm bgrBlueN fw7 radius5"
                                                style="border:none" id="btnloading"> Lưu hồ sơ ứng viên
                                        </button>
                                                    ...
                                                    <div class="form-row mgt20">
                                                        ...
                                                        <div class="form-group col-lg-6 pdr2p lg-pd0Im">
                                                            ...
                                                            <select name='specialize[{{ $id }}][leve]'
                                                                    ...
                                                                    class="selectbox requiredbox form-control" style="height: 35px">
                                                                <option value="0" selected>-- Chọn Bằng cấp --</option>
                                                                @foreach(\App\Entity\Literacy::get() as $literacy)
                                                                    <option value="{{$literacy->literacy_id}}"
...
<div class="modal fade bd-example-modal-xl" id="add_specialize" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-xl">
        <form action="{{ route('store_Specialize_Employee') }}" method="post" enctype="multipart/form-data" id="update_store_specialze_employee">
            {!! csrf_field() !!}
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row mgt20">
                        <div class="form-group col-lg-6 pdr2p lg-pd0Im">
                            ...
                            <input type="text" name='star_specialize_time' class="form-control error_border_star_specialize_time" id="inputZip"
                                   placeholder="Ví dụ: 2015">
                        ...
                        <div class="form-group col-lg-6 pdr2p lg-pd0Im">
                            ...
                            <input type="text" name='end_specialize_time' class="form-control error_border_end_specialize_time" id="inputZip"
                                   placeholder="Ví dụ:  2016">
                        ...
                        <div class="form-group col-lg-6 pdr2p lg-pd0Im">
                            <label for="inputZip" class="fw6">Trình độ </label>
                            <select name='leve' id="ddlQualificationType" class="selectbox requiredbox form-control error_border_leve" style="height: 35px">
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-6 pdr2p lg-pd0Im">
                            <label for="inputZip" class="fw6">Ngành học </label>
                            <input type="text" name='majors' id="txtMajorContent" class="requiredbox form-control error_border_majors"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary bgorang" style="border-color: orange" id="btn_update_store_specialze_employee">Lưu lại</button>
                </div>
...
<div class="modal fade bd-example-modal-xl" id="add_experience" tabindex="-1" role="dialog"
     aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="{{ route('store_Experience_Employee') }}" method="post" enctype="multipart/form-data" id="store_Experience_Employee">
            {!! csrf_field() !!}
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row mgt20">
                        ...
                        <div class="form-group col-lg-4 pdr2p lg-pd0Im">
                            ...
                            <input type="text" name='star_working_time' class="form-control error_border_star_working_time" id="inputZip"
                                   placeholder="Ví dụ: 2015">
                        ...
                        <div class="form-group col-lg-4 pdr2p lg-pd0Im">
                            <label for="inputZip" class="fw6">Thời gian kết thúc - <i>tính theo năm</i> </label>
                            <input type="text" name='end_working_time' class="form-control error_border_end_working_time" id="inputZip"
                                   placeholder="Ví dụ:  2016">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                    <button type="submit" class="btn btn-primary bgorang" style="border-color: orange" id="btn_store_Experience_Employee">Lưu lại</button>
                </div>
...
<script>
    ...
    jQuery.validator.addMethod("checkName", function(value, element){
        var result = false;
        var checkName = $('#employee_name').val();
        var regex = /[^a-zA-Z]+$/;
    ...
    jQuery.validator.addMethod("checkPhone", function(value, element){
        var result = false;
        var checkPhone = $('#phone').val().split('');
        var dem = checkPhone.length;
        if (checkPhone[0]==0 && dem==10 || dem==11) {
            result = true;
        }else{
...
<script type="text/javascript">
    ...
    $("#btnAdditional").click(function(){
        ...
        $('btnAdditional').html('<i class="fas fa-plus-square"></i>')
...
<div class="modal fade notification" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                @if(session('suscess_specialize') || session('suscess'))
                    <button type="button" class="btn js_success">Để sau</button>
