                                    ...
                                    <div id="cvo-profile">
                                        <div class="box-01">
                                            <div id="cvo-profile-avatar-wraper">
                                                ...
                                                <img class="lazy"
                                                     data-src="{{ isset($cv_employee->cv_image) ? $cv_employee->cv_image : asset('assets/image/no_avatar.jpg') }}"
                                                     width="80" height=""/>
                                                            ...
                                                            @if(!empty($list_cv_spe))
                                                                @foreach($list_cv_spe as $id_spec=>$spec)
                                                                    <div id="exp{{ $id_spec + 1 }}"
                                                                        ...
                                                                        <div readonly class="exp-content div_textarea"

                                                                             placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
                                                                             name="cv_spec_desc[]">{{ !empty($spec->cv_spec_desc) ? $spec->cv_spec_desc : '' }}</div>
                                                                    </div>
                                                                @endforeach
                                                            @endif
                                                        </div>
                                                            ...
                                                            @if(!empty($list_cv_ex))
                                                                @foreach($list_cv_ex as $id_ex=>$ex)
                                                                    <div id="exp{{$id_ex + 1}}"
                                                                        ...
                                                                        <div readonly name="cv_ex_desc[]"
                                                                             class="exp-content div_textarea"

                                                                             placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc.">{{ !empty($ex->cv_ex_desc) ? $ex->cv_ex_desc : '' }} </div>
                                                                    </div>
                                                                @endforeach
                                                            @endif
                                                        </div>
                                                                ...
                                                                @foreach($list_cv_work as $id_work=>$work)
                                                                    <div id="exp{{ $id_work + 1 }}"
                                                                        ...
                                                                        <div readonly class="exp-content div_textarea"
                                                                             ...
                                                                             placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
                                                                             name="cv_work_desc[]"> {{ !empty($work->cv_work_desc) ? $work->cv_work_desc : 'Nội dung hoạt động' }}</div>
                                                                    </div>
                                                                @endforeach
                                                            @endif
                                                        </div>
                                                            ...
                                                            @if(!empty($list_cv_project))
                                                                @foreach($list_cv_project as $id_project=>$project)
                                                                    <div id="exp{{ $id_project + 1 }}"
                                                                        ...
                                                                        <div readonly name="cv_project_des[]"
                                                                             class="exp-content div_textarea"

                                                                             placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc.">{{ !empty($project->cv_project_des) ? $project->cv_project_des : 'Nội dung' }}
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                            @endif
                                                            ...
                                                            @if(!empty($list_cv_info))
                                                                @foreach($list_cv_info as $id_info=>$info)
                                                                    <div id="exp{{ $id_info + 1 }}"
                                                                        ...
                                                                        <div readonly name="cv_info_des[]"
                                                                             class="exp-content div_textarea"

                                                                             placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc.">{{ !empty($info->cv_info_des) ? $info->cv_info_des : 'Nội dung' }}</div>
                                                                    </div>
                                                                @endforeach
                                                            @endif
                                                        </div>
                                            ...
                                            <div id="sortable">
                                                <div id="box01" data_box="box01"
                                                    ...
                                                    <p class="icoweb cvi-envelope-square">
                                                        @if(!empty($check_employer_show_employee))
                                                            <input readonly
                                                                   type="email"
                                                                   id="cv-profile-email"
                                                                   placeholder="Email"
                                                    ...
                                                    <p class="icoweb cvi-map-marker div_input" style="color: black !important;word-wrap: break-word;">{{!empty($cv_employee->cv_address) ? $cv_employee->cv_address : $employee->address  }}
                                                    </p>

                                                    @if(!empty($check_employer_show_employee))
                                                        <p class="icoweb cvi-info div_input" style="color: black !important;word-wrap: break-word;">{{!empty($cv_employee->cv_facebook) ? $cv_employee->cv_facebook : $employee->my_facebook  }}
                                                        </p>
                                                    @else
                                                        <p class="icoweb cvi-info div_input" style="color: black !important;word-wrap: break-word;">***************
                                                        </p>
                                                    @endif
                                                </div>
                                                ...
                                                @foreach($order_left as $or_left)
                                                    @if($or_left == 1)
                                                        <div id="box02" data_box="box02"
                                                            ...
                                                            <div readonly name="cv_career_goals"
                                                                 class="box-content div_textarea"
                                                            >{{!empty($cv_employee->cv_career_goals) ? $cv_employee->cv_career_goals : '' }}</div>
                                                        </div>
                                                    @endif
                                                    @if($or_left == 2)
                                                    ...
                                                    @if($or_left == 3)
                                                        <div id="box04" data_box="box04"
                                                            ...
                                                            <p>
                                                            <div readonly class="box-content div_textarea"
                                                                 name="cv_interests"
                                                                 placeholder="Đang cập nhật thông tin"
                                                            >{{!empty($cv_employee->cv_interests) ? $cv_employee->cv_interests : '' }}</div>
                                                            </p>
                                                        </div>
                                                    @endif
                                                    @if($or_left == 4)
                                                        <div id="box05" data_box="box05"
                                                            ...
                                                            <p><div readonly name="cv_card" class="box-content div_textarea"
                                                                    placeholder="Đang cập nhật thông tin"
                                                            >{{!empty($cv_employee->cv_card) ? $cv_employee->cv_card : '' }} </div>
                                                            </p>
                                                        </div>
                                                    @endif
                                                    @if($or_left == 5)
                                                        <div id="box06" data_box="box06"
                                                            ...
                                                            <p><div readonly name="cv_interests"
                                                                    class="box-content div_textarea"
                                                                    placeholder="Đang cập nhật thông tin"
                                                            >{{!empty($cv_employee->cv_interests) ? $cv_employee->cv_interests : '' }}</div>
                                                            </p>
                                                    ...
                                                    @if($or_left == 6)
                                                        <div id="box07" data_box="box07"
                                                            ...
                                                            <p><div readonly name="cv_reference_person"
                                                                    class="box-content editor div_textarea"
                                                                    id="cv_reference_person"
                                                                    placeholder="Đang cập nhật thông tin"
                                                            >{{!empty($cv_employee->cv_reference_person) ? $cv_employee->cv_reference_person : '' }}</div>
                                                            </p>
                                                        </div>
                                                    @endif
                                                @endforeach
