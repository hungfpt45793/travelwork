                ...
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12  mgt15">
                            ...
                            @if(session('suscess_intership'))
                                <div class="alert alert-success alert-dismissible fade show" role="alert"
                                     style="margin-top: 15px;width: 100%">
                                    <strong>{{ session('suscess_intership') }}</strong>
                            ...
                            <div class="col-xl-12 col-lg-12 left">
                                <form action="{{ route('updateEmployeeSubmitIntership') }}" method="post" class="mbformUpdateEmployee"
                                    ...
                                    <div class="form-group row mgb5">
                                        ...
                                        <div class="col-sm-9 gruopRadio mgt5 pdLeft0 borderSelect2">
                                            <div class="col-md-12 lgw60 pdLeft0 pdRight0">
                                            <select class="form-control" id="" name="internship_time">
                                                <option value="0" @if(!empty($inter_ship) && $inter_ship->internship_time == 0) selected @endif >Part time</option>
                                                <option value="1" @if(!empty($inter_ship) && $inter_ship->internship_time == 1) selected @endif>Full time</option>
                                                <option value="2" @if(!empty($inter_ship) && $inter_ship->internship_time == 2) selected @endif>Part time && Full time</option>
                                    ...
                                    <div class="form-group row mgb5">
                                        ...
                                        <div class="col-sm-9 gruopRadio mgt5 pdLeft0 borderSelect2">
                                           <textarea class="textarea w100 form-control editor"  name="des_time" id="editor_des_time"
                                    ...
                                    <div class="form-group row mgb5">
                                        ...
                                        <div class="col-sm-9 gruopRadio mgt5 pdLeft0">
                                            <button type="submit" class="pd10-30 whiteIm bgrBlueN fw7 radius5"
                                                    style="border:none" id="btnloading"> Nộp hồ sơ thực tập
                                            </button>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    $('#btnloading').click(function () {
        if ($('#form_update_user').valid()) {
            ...
            $(this).html('<i class="fas fa-spinner fa-spin mgr5"></i>' + 'Đang gửi hồ sơ thực tập ...');
