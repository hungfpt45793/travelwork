                    ...
                    <div class="info bgrWhite pd20 radius10">
                        ...
                        <div class="content">
                            ...
                            @if(empty($vouchers->link_dowload_file))
                                ...
                                <hr>
                                <div id="fb-root"></div>
                                <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v8.0&appId=423707121644549&autoLogAppEvents=1" nonce="4Yfb5e63"></script>
                                <div class="fb-like" data-href="https://www.facebook.com/sanketoan.vn" data-width="400px" data-layout="button_count" data-action="like" data-size="small" data-share="true"></div>
                                <br>
                                <div style="display: inline-block;margin-right: 20px;">
                                    ...
                                    <i class="mgf5 mgt10">(Vui lòng like hoặc chia sẻ fanpage để được nhận tài liệu mới nhất)</i>
                                    <br>
