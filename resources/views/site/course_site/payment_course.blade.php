                            ...
                            <div class="payment_detail row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <span><b>
                                        ...
                                        <div class="col-8 mt-3">
                                            <strong><b style="color:#EB5757; font-size: 1.25rem;" class="js_course_discount">
                                                    @if(!empty($courses->course_discount))
                                                        {{ !empty($courses->course_discount) ? number_format($courses->course_discount) : 0 }}
                                                    @else
                                                        {{ !empty($courses->course_price) ? number_format($courses->course_price) : 0 }}
                                                    @endif
                                                    đ</b>
                                            </strong>
                                        </div>
                                ...
                                <div class="col-12 col-md-7">
                                    ...
                                    <textarea class="form-control input-custom-gray color_pla f14"
                                        ...
                                        <div class="form-group row select2_border">
                                            ...
                                            <div class="col-md-8 mt-md-3 ">
                                                <select class="select2 custom-select custom-select-sm  select2_border js_course_formality_id"
                                                    ...
                                                    ?>
                                                    <option id="course_formality_1" value="1" @if($course_formality_id == 1) selected @endif>Tự học</option>
                                        ...
                                        <input type="hidden" name="course_id"  value="{{ !empty($courses->course_id) ? $courses->course_id : 0 }}">
