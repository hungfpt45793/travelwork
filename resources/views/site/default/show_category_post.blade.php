                    ...
                    <div class="link bgrWhite md-mgt20 mgb10">
                        <ul class="nav">
                            ...
                            <li class="nav-item pd8">
                                ...
                                ?>
                                <a href="{{ $link_url }}" class="f18 md-f14 blueDN hvBlueDN"> <i class="fas fa-users mgr5"></i>Danh mục chia sẻ</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="main">
                        <div class="notificationBox">
                            ...
                            <ul class="nav justify-content-center">
                                <li class="nav-item">
                                    <a class="nav-link textUpper bgrBlueN white hvWhite fw5 pd15" href="{{route('show_list_post')}}"><i class="fas fa-share f18"></i> Danh sách bài viết chia sẻ</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link textUpper bgrBlueN white hvWhite fw5 pd15 mgl20 mgr20" href="{{route('show_list_job')}}"> <i class="fas fa-share f18"></i> Danh sách tin tuyển dụng chia sẻ</a>
                                </li>
                            </ul>
                            <hr>
                        </div>
