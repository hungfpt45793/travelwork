                    ...
                    <div class="link bgrWhite md-mgt20 disOnMobile">
                        <ul class="nav">
                            ...
                            @if(\Illuminate\Support\Facades\Auth::user()->role == 2)
                                <li class="nav-item pd8">
                                    <a href="{{ route('show_file_job_facebook') }}" class=" f18 md-f14 mgb0">Cập nhật hồ sơ</a>
                                </li>
                            @endif
                            ...
                            <li class="nav-item pd8">
                                <a href="#" class=" f18 md-f14 mgb0">Thông tin tài khoản</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="mgt20 js_resetButton">
                                    <div class="box_info f16">
                                        <div class="list-items mb_4">
                                            ...
                                            <a class="btnOrang_imp mgl5 js_toggle_changle_email bdr5"><i class="fas fa-pen f14"></i> Đổi Email</a>
                                        </div>
                                        ...
                                        <div id="" class="email-moi mt15 box_change_email js_box_change_email pd10 mgt10 mgb20 ">
                                            <form class="form_submit_loading" id="is_change_email" name="change_email"
                                                ...
                                                <button id="btn_changeEmail" class="btn btn-doi-email font16 bolder" style="background: #009385">
                                                    Đổi Email
                                                </button>
                                            </form>
                                        </div>
                                        <div class="list-items mb_4">
                                            ...
                                            <a href="{{ route('show_user_job_facebook') }}" class="btnOrang_imp mgl5 bdr5"><i class="fas fa-pen f14"></i> Đổi mật khẩu</a>
                                        </div>
