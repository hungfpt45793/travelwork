...
@section('title','Giáo viên Đăng ký')
    ...
    <section class="main-ctn">
        <div class="wrapper container">
            <section id="contact-content" class="w78 marginAuto">
               ...
               <div class="main">
              <form action="{{route('dang_ky_tuyen_dung')}}" id="location-form" method="post" class="dang-ky-tuyen-dung">
                  {!! csrf_field() !!}
                        ...
                        <div class="bodyBox">
                           <div class="accountInfo">
                                 <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                       <input type="text" name="name" value="{{old('name')}}" class="form-control" placeholder="Tên công ty">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                       <input type="text" name="address" id="location-input"  class="form-control" placeholder="Địa chỉ chi tiết công ty ">
                                    </div>

                                 </div>
                                
                                 <div class="form-group row">
                                    <label for="staticEmail" class="col-12 text-left lable">Tên người đại diện <span>*</span> </label>
                                    <div class="col-12">
                                       <input type="text"  name="employer_name"  value="{{old('employer_name')}}" class="form-control" placeholder="Tên người phụ trách">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label class="col-12 text-left lable">Số điện thoại liên hệ<span>*</span> </label>
                                    <div class="col-12">
                                       <input type="text"  name='phone' value="{{old('phone')}}"  class="form-control" placeholder="Số điện thoại liên hệ">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label class="col-12 text-left lable">Tài khoản Email<span>*</span> </label>
                                    <div class="col-12">
                                       <input type="text"  name='email' value="{{old('email')}}"  class="form-control" placeholder="Email là tài khoản đăng nhập">
                                    </div>
                                 </div>
                                 <div class="form-group row">
