        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="hd_left">
                    <div class="hd_logo">
                        <a href="/">
                            <img class="lazy" data-src="{{ !empty($information['logo-pc-new']) ? asset($information['logo-pc-new']) : asset('assets/image/new/Logo.png') }}" alt="" width="100%">
                        </a>
                    </div>
                </div>
                <div class="hd_right">
        ...
        <div class="row">
            ...
            <div class="col-4 cus_mobile_new">
                @if (!\Illuminate\Support\Facades\Auth::check())
                    <div class="header_new_mobile_center">
                        <a href="/">
                            <img class="lazy" data-src="{{ !empty($information['logo-mobile-new']) ? asset($information['logo-mobile-new']) : asset('assets/image/new/logo_mobile.png') }}" alt="" width="100%">
                        </a>
                    </div>
            ...
            <div class="col-md-12 col-12 header_new_mobile_box_menu dsNone js_header_new_mobile_box_menu">
                <div class="menu_mobile_logo">
                    <a href="/"> <img class="lazy" data-src="{{ !empty($information['logo-mobile-new']) ? asset($information['logo-mobile-new']) : asset('assets/image/new/logo_mobile.png') }}"></a>
