        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="hd_left">
                    <div class="hd_logo">
                        <a href="/">
                            <img class="lazy" data-src="{{ \App\Ultility\Ultility::assetUrl(data_get($information, 'logo-pc-new'), 'assets/image/new/Logo.png') }}" alt="Travelwork" width="100%">
                        </a>
                    </div>
                </div>
                <div class="hd_right">
                    <div class="hd_category">
                        <div class="hd_menu">
                            <ul>
                                <a href="{{ route('list_job_face') }}" title="Việc làm về du lịch">
                                    <li>
                                        <i class="fas fa-briefcase"></i>
                                        <h2>Việc làm về du lịch</h2>
                                    </li>
                                </a>
                                <a  href="{{ route('course_index') }}" title="Khóa học">
                                    <li>
                                ...
                                <a href="/mau-chung-tu/kho-tai-lieu" title="Kho tài liệu">
                                    <li>
                                        {{--<i class="fas-solid fa-person-dots-from-line"></i>--}}
                                        <i class="fas fa-play"></i>
                                        <h2>Kho tài liệu</h2>
                                    </li>
                                </a>

                                <a target="_blank" ref="nofollow" href="{{ route('getTestAllExam') }}" title="Trắc nghiệm">
                                    <li>
        ...
        <div class="row">
            ...
            <div class="col-4 cus_mobile_new">
                @if (!\Illuminate\Support\Facades\Auth::check())
                    <div class="header_new_mobile_center">
                        <a href="/">
                            <img class="lazy" data-src="{{ \App\Ultility\Ultility::assetUrl(data_get($information, 'logo-mobile-new'), 'assets/image/new/logo_mobile.png') }}" alt="Travelwork" width="100%">
                        </a>
                    </div>
            ...
            <div class="col-md-12 col-12 header_new_mobile_box_menu dsNone js_header_new_mobile_box_menu">
                <div class="menu_mobile_logo">
                    <a href="/"> <img class="lazy" data-src="{{ \App\Ultility\Ultility::assetUrl(data_get($information, 'logo-mobile-new'), 'assets/image/new/logo_mobile.png') }}" alt="Travelwork"></a>
                ...
                <div class="menu_mobile_login">
                    ...
                    <ul>
                        <li class="hd_button_login">
                            <a class="modal_moblie" data-toggle="modal" title="Đăng nhập"
                               data-target="#loginTiva">Đăng nhập</a>
                        </li>
                        <li class="hd_button_res">
                            <a class="mobile_register" href="{{ route('register')}}" title="Đăng ký">Đăng ký</a>
                        ...
                        <ul>
                            <li class="hd_button_res">
                                <a title="Câu hỏi hỗ trợ" style="width: 100%;border-radius: 0px" href="{{ route('site_category_post',['slug_cate'=> 'ho-tro']) }}" class="showsupport mobile_button_question" id="showsupport">Câu hỏi hỗ trợ <i class="fas fa-question"></i></a>
                            </li>
                        </ul>
                    @endif
                ...
                <div class="menu_mobile_list">
                    <ul>
                        <a href="{{ route('list_job_face') }}" title="Việc làm kế toán">
                            <li>
                                <i class="fas fa-briefcase"></i>
                                <span>Việc làm du lịch</span>
                            </li>
                        </a>
                        <a  href="{{ route('course_index') }}" title="Khóa học">
                            <li>
...
{{--                        <a href="{{ route('video_skt') }}" title="Video kế toán trưởng">--}}
{{--                            <li>--}}
{{--                                --}}{{--<i class="fas-solid fa-person-dots-from-line"></i>--}}
{{--                                <i class="fas fa-play"></i>--}}
{{--                                <span>Video kế toán trưởng</span>--}}
{{--                            </li>--}}
{{--                        </a>--}}

{{--                        <a target="_blank" ref="nofollow" href="{{ route('user_support_advise') }}" title="Gia sư 1 - 1">--}}
{{--                            <li>--}}
{{--                                <i class="fas fa-user-friends"></i>--}}
{{--                                <span>Gia sư 1 - 1</span>--}}
{{--                            </li>--}}
{{--                        </a>--}}
                ...
                <div class="menu_mobile_footer">
                    <div class="footer_new_dowload">
                        ...
                        <div class="footer_new_dowload_app">
                            <a class="d-sm-inline"  href="{{ isset($information['link-tai-app-androi']) ?  $information['link-tai-app-androi'] : '' }}" ref="nofollow"><img src="{{ asset('assets/image/android.png') }}" class="lazy" data-src="{{ asset('assets/image/android.png') }}"></a>
                            <a class="d-sm-inline"  href="{{ isset($information['link-tai-app-ios']) ?  $information['link-tai-app-ios'] : '' }}" ref="nofollow"><img src="{{ asset('assets/image/ios.png') }}" class="lazy" data-src="{{ asset('assets/image/ios.png') }}"></a>
                        </div>
                    </div>
