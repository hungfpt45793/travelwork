                ...
                <div class="col-xl-9 col-lg-8 col-md-12 createProfileOnline ">
                    <div class="link bgrWhite md-mgt20">
                        <ul class="nav">
                            ...
                            <li class="nav-item pd8">
                                <a href="{{ route('list_type_job') }}" class=" f18 md-f14 mgb0">Danh sách từ khóa
                                    công việc</a>
                            </li>
                            <li class="nav-item pd8">
                                <p class="mgb0 md-f13 md-mgt2 blueDN"><i class="fas fa-chevron-right"></i></p>
                            ...
                            <li class="nav-item pd8">
                                <a href="#"
                                   ...
                                   {{ isset($category_tag->tag_title) ? $category_tag->tag_title : 'từ khóa tài liệu' }}
                                </a>
                            </li>
                        </ul>
                    </div>
