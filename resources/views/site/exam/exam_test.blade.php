                    ...
                    <div class="link bgrWhite md-mgt20 disOnMobile" style="margin-bottom: 20px;">
                        <ul class="nav">
                            ...
                            <li class="nav-item pd8">
                                ...
                                ?>
                                <a href="{{ $link_url }}" class="f18 md-f14 blueDN hvBlueDN"> Đề thi thử</a>
                            </li>
            ...
            <div class="row mgt15">
                <div class="col-lg-4 col-md-4 leftSidebar">
                    ...
                    @if($exam['status_exam']  == 1)
                        <div class="panelBox">
                            <a href="{{ route('getTestQuestion',['slug_exam' => $exam['slug_exam'] ] ) }}" class="star bgRed">Bắt đầu làm bài thi</a>
                        </div>
                    @else
                        <div class="panelBox">
                        ...
                        <ul class="listExam">
                            ...
                            @if($conments)
                                @foreach($conments as $id=>$conment)
                                    ...
                                    <li>
                                        <?php $user_comment = \App\Entity\User::getUser($conment->id_user);?>
