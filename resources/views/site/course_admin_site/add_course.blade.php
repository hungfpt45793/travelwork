                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12 col-12">
                                    ...
                                    <div class="CV bgrWhite radius5 pd20 mgt20 mgb20 pdb5">
                                        ...
                                        <div class="content">
                                            ...
                                            <form role="form" action="{{ route('course.store') }}" method="POST" class="">
                                                {!! csrf_field() !!}
                                                {{ method_field('POST') }}
                                                <div class="form-group mgt15">
                                                    <label for="exampleInputEmail1">Tên Khóa học</label>
                                                    <input type="text" class="form-control" name="course_name" placeholder="Tên khóa học" value="{{old('course_name')}}" >
                                                </div>
                                                <div class="form-group mgt15">
                                                    <label for="exampleInputEmail1">Thời gian khóa học</label>
                                                    <input type="text" class="form-control" name="course_time" placeholder="Thời gian khóa học" value="{{old('course_time')}}" >
                                                </div>

                                                <div class="form-group Giá khóa học">
                                                    <label for="exampleInputEmail1">Giá khóa học ( đ )</label>
                                                    <input type="text" class="form-control formatPrice" name="course_price" placeholder="0" min="1" >
                                                </div>
                                                <script>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div id="uploadImage" style="display: inline-block">
                                                            ...
                                                            <img src="" class="thumbnail lazy" style="width: 70px">
                                                                ...
                                                                if (input.files && input.files[0]) {
                                                                    for(var i = 0; i< input.files.length; i++)
                                                                    {
                                                                        ...
                                                                        picReader.addEventListener("load",function(event){
                                                                            ...
                                                                            $('#uploadImage').append("<img class='thumbnail lazy' src='" + picFile.result + "'" +
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="course_intro" class="w-100" id="" rows="5" cols="80">{{ old('course_intro')  }}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="course_content" class="editor" id="editor1" rows="10" cols="80">{!!  old('course_content') !!}</textarea>
                                                    {{--<textarea id="txtNote" name="content" rows="6" class="textarea col-12 bdLightGray radius5"></textarea>--}}
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-primary btnOrange">Lưu khóa học </button>
                                                </div>
                                            </form>
