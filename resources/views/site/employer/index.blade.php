@extends('site.layout.site') @section('title','Information')
@section('meta_description', isset($information['meta_description']) ? $information['meta_description'] : '')
@section('keywords', isset($information['meta_keyword']) ? $information['meta_keyword'] : '') @section('content')
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-sm-9 row">
                                            <div class="camera col-sm-3" style="">
                                                <img class="lazy" id="avatar-webcam" width="150" oldimg="" data-src="{{ isset($employer->image) ? $employer->image : '/CV/noimage.png' }}">
                                            </div>
