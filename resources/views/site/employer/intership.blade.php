                    ...
                    <div class="link bgrWhite md-mgt20">
                        <ul class="nav">
                            ...
                            <li class="nav-item pd8">
                                ...
                                ?>
                                <a href="{{ $link_url }}" class="f18 md-f14 blueDN hvBlueDN"> <i class="fas fa-link white mgr5"></i> Cổng thực tập</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach($listtype as $type)
                                                ...
                                                @if($total_type_of_business_id != 0)
                                                <div class="col-lg-4 col-md-6 col-6">

                                                    <a class="linkFillter" href="{{ route('search_intership',['slug'=> $text]) }}"> <p class=" mgb10"><i class="far fa-building f14 mgr5"></i>{{ $type->type_of_business_name }} <sup class="blueN fw6">({{ $total_type_of_business_id }})</sup>
                                                        </p>
                                                    </a>
                                                </div>
                                                @endif
