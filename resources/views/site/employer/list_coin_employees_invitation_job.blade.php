                            ...
                            @foreach($jobs as $job)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(strtotime($today) > strtotime($date_end))
                                            <p class="clred f12">
                                                Tin hết hạn không thể mời ứng tuyển
                                            </p>
                                        @else


                                        <a href="{{ route('list_coin_employees_invitation_job_apply',['job_id'=>$job->job_id ]) }}"  class="btn btn-info  clwhite"  style="padding: 2px 10px;" target="_blank">Mời ứng viên
                                        </a>
                                        @endif
                                    </td>
                                </tr>
