                    ...
                    <div class="link bgrWhite md-mgt20 mgb10">
                        <ul class="nav">
                            ...
                            <li class="nav-item pd8">
                                ...
                                ?>
                                <a href="{{ $link_url }}" class="f18 md-f14 blueDN hvBlueDN"> <i class="fas fa-users mgr5"></i>Giáo viên đăng ký</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="bodyBox">
                                    <div class="accountInfo">
                                        <div class="form-group row mgb10">
                                            <label class="col-12 text-left lable">Tên Giáo viên<span>*</span> </label>
                                            <div class="col-12">
                                                <input type="text" name="teacher_name" value="{{old('teacher_name')}}"
                                                       class="form-control error_border_teacher_name" placeholder="Tên Giáo viên" required>
                                        ...
                                        <div class="form-group row mgb10">
                                            <label for="staticEmail" class="col-12 text-left lable">Địa chỉ Giáo viên
                                                <span>*</span>
                                            </label>
                                    ...
                                    $( "#location-form" ).validate({
                                        ...
                                        messages: {
                                            teacher_name: {
                                                ...
                                                minlength: 'Tên Giáo viên phải tối thiểu 10 ký tự.',
                                            },
                                            province: {
