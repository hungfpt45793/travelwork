                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-12 col-12">
                    <div class="link bgrWhite md-mgt20 disOnMobile mgb10">
                        <ul class="nav">
                            ...
                            <li class="nav-item pd8">
                                <a href="{{ route('show_detail_emplooyee',['employee_id'=> $employee->employee_id]) }}" class=" f18 md-f14 mgb0">Hồ sơ ứng viên</a>
                            </li>
                            <li class="nav-item pd8">
                                <p class="mgb0 md-f13 md-mgt2 blueDN"><i class="fas fa-chevron-right"></i></p>
                            </li>
                    ...
                    @include('site.modum_sidebar.cv_detail_employee')
                </div>
            </div>
        </div>
    </section>
