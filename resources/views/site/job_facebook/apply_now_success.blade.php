...
@section('content')
    ...
    <?php
    $date = date_create($job_facebook->updated_at);
    $date_line = date_create($job_facebook->deadline_submit_profile);
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 col-12 col-12">
                    ...
                    <div class="cvbox borderTopLeftRight10 bg-white pd15 pdb20 mgTop20">
                        ...
                        <p>Hồ sơ của bạn đã được gửi thành công đến vị trí
                            <strong>{{ isset($job_facebook->title) ? $job_facebook->title : '' }}</strong>
                        </p>
