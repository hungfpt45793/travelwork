...
{{--@section('title', 'Gia sư kế toán Online 1-1 , Kế toán cần hỗ trợ')--}}
{{--@section('meta_description', 'Gia sư kế toán Online 1-1 , Kế toán cần hỗ trợ')--}}
{{--@section('keywords', 'Gia sư kế toán Online 1-1 , Kế toán cần hỗ trợ')--}}
                            ...
                            @foreach($list_advise as $id_a=>$advise)
                                <div class="item_box_advise">
                                    ...
                                    @if($advise->role == 3)
                                        ...
                                        <div class="box_advise_hd">
                                            <img class=" rounded-circle user_thump "
                                                 src="{{ !empty($tea->teacher_images) ? asset($tea->teacher_images) : asset('assets/image/avatarteacher.png') }}"
                                                 alt="{{ !empty($advise->name) ? $advise->name : '' }}">
                                            <span>{{ !empty($advise->name) ? $advise->name : '' }}</span>
                                        </div>
                            ...
                            @foreach($list_support as $id_p=>$sup)
                                <div class="item_box_advise">
                                    ...
                                    @if($sup->role == 2)
                                        ...
                                        <div class="box_advise_hd">
                                            <img class=" rounded-circle user_thump "
                                                 src="{{ !empty($employer->image) ? asset($employer->image) : asset('assets/image/avatarteacher.png') }}"
                                                 alt="{{ !empty($sup->name) ? $sup->name : '' }}">
                                            <span>{{ !empty($sup->name) ? $sup->name : '' }}</span>
                                        </div>
                                        <div class="box_advise_content">
