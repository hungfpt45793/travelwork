        ...
        <div class="container">
                ...
                <div class="col-lg-12" style="padding: 0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a class="clHome" href="{{ route('getResultExam',['id_room' => $result_room->id_room ]) }}">Danh sách kết quả ứng viên</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Chi tiết kết quả phòng thi</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-12 categoryQuestion text-center">
                    ...
                    <p class="mgBottom0 f15"><strong>Ứng viên thi : </strong><span style="color: white; padding: 2px 5px;background: #009385;">  <?php echo $user_room_exam->name; ?> </span> </p>
                </div>
            ...
            <div class="row mgTop15">
                <div class="col-lg-3 col-md-3 leftSidebar">
                    <div class="panelBox">
                        ...
                        ?>
                        {{--@if($checkStarExam < 1 )--}}
                        {{--<a class="btn bgHome mgTop10" style="color: yellow;"  data-toggle="modal" data-target="#starExam"><i class="fa fa-star" aria-hidden="true"></i> Đánh giá đề thi </a>--}}
                        {{--@endif--}}
                        {{--@if($checkComment < 1)--}}
                        {{--<a class="btn bgHome mgTop10" style="background-color:rebeccapurple;"  data-toggle="modal" data-target="#commentExam">  <i class="fa fa-comments-o" aria-hidden="true"></i> Bình luận đề thi</a>--}}
                        {{--@endif--}}
                    </div>
                </div>
...
@endif" id="">
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                ...
                                <div class="TabContent">
                                    <div class="row" id="scollProduct1">
                                        <div class="col-lg-9 maxHeightcol">
                                            <div class="listQuestion bg-white">
                                                @if(!empty($question_2))
                                                    <h3 class="f18 text-left pd10 ds-inline" style="background: #ddd">
...
@endif" id="">
                                        ...
                                        <div class="col-lg-3 maxHeightcol bg-white ListQuestionRight" style="">
                                            <div class="ListItemQues" id="sidebar1">
                                                <h3 class="f18 text-center pd10 ds-inline mgTB10"
                                                    style="background: #ddd">Danh sách câu
                                                    hỏi</h3>
                                                <div class="listhrel sidebar__inner1">
                                                    @if(!empty($question_2))
                                                        <ul id="scroll">
                                                            @foreach($question_2 as $id1 => $question2)
                                                                <li>
                            ...
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel"
                                ...
                                <div class="TabContent">
                                    <div class="row" id="scollProduct2">
                                        <div class="col-lg-9 maxHeightcol">
                                            <div class="listQuestion bg-white">
                                                @if(!empty($question_3))
                                                    <h3 class="f18 text-left pd10 ds-inline" style="background: #ddd">
                                        ...
                                        <div class="col-lg-3 maxHeightcol bg-white ListQuestionRight" style="">
                                            <div class="ListItemQues" id="sidebar2">
                                                <h3 class="f18 text-center pd10 ds-inline mgTB10"
                                                    style="background: #ddd">Danh sách câu
                                                    hỏi</h3>
                                                <div class="listhrel sidebar__inner2">
                                                    @if(!empty($question_3))
                                                        <ul id="scroll">
                                                            @foreach($question_3 as $id1 => $question3)
                                                                <li>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                if (windowsize >= 1000) {
                    ...
                    var stickySidebar1 = new StickySidebar('#sidebar1', {
                        topSpacing: 50,
                        bottomSpacing: 40,
                        containerSelector: '#scollProduct1',
                        innerWrapperSelector: '.sidebar__inner1'
                    });
                    var stickySidebar2 = new StickySidebar('#sidebar2', {
                        topSpacing: 50,
                        bottomSpacing: 40,
                        containerSelector: '#scollProduct2',
