...
@section('title', 'thêm mới phòng thi')
                                            ...
                                            <div class="col-lg-12" style="padding: 0">
                                                <nav aria-label="breadcrumb">
                                                    <ol class="breadcrumb">
                                                        ...
                                                        <li class="breadcrumb-item active" aria-current="page">Thêm phòng thi</li>
                                                    </ol>
                                                </nav>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        <textarea class="w100" name="des_room"
                                                                  rows="4" style="padding: 10px">{{ old('des_room') }}</textarea>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        <input type="text" class="form-control" id="inputEmail3"
                                                               ...
                                                               required value="{{ old('password_room') }}">
                                                    </div>
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <span class="glyphicon glyphicon-time"></span>
                                                            ...
                                                            <input type='time' class="form-control"
                                                                   name="time_star_room"
                                                                   required value="{{ old('time_star_room') }}"
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <span class="glyphicon glyphicon-time"></span>
                                                            ...
                                                            <input type='time' class="form-control" name="time_end_room"
                                                                   required value="{{ old('time_end_room') }}"
                                                ...
                                                <div class="form-group dsNone">
                                                    ...
                                                    <div>
                                                        <label class="answerRadio dsInline mgRight30">
                                                            <input type="radio" name="type_exam" value="0" class="flat-red resetchecked " style="width: 17px;vertical-align: bottom; height: 17px;" checked>
                                                            Thi đề ngẫu nhiên
                                                        </label>
                                                        <label class="answerRadio dsInline">
                                                            <input type="radio" name="type_exam" value="1" class="flat-red resetchecked " style="width: 17px;vertical-align: bottom; height: 17px;">
