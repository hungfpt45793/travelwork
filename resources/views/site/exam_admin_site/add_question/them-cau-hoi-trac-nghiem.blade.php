...
@section('content')
        ...
        <div class="container">
                ...
                <div class="col-lg-12" style="padding: 0;">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-white">
                            <li class="breadcrumb-item"><a class="clHome" href="{{ route('showExam') }}">Danh sách đề
                                    thi </a></li>
                            <li class="breadcrumb-item"><a class="clHome"
                                                           href="{{ route('site_exam.edit',['site_exam' => $exam->id_exam]) }}">Đề
                                    thi {{ $exam->code_exam }}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Thêm mới câu hỏi</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 RightLink mgTB5  bg-white">
                    <div class="mgTB15">
                        <p class="mgBottom0">
                        <h2 class="f20 dsInline">Thêm mới câu hỏi cho mã đề thi</h2> <a
                    ...
                    <div class="pdBottom5">
                        <a href="{{ route('getAllQuestionsZero',['id_exam'=>$exam->id_exam]) }}"
                           class="btn btnSmall @if($type == 0) btnGreen clwhite  @else btnNoGreen @endif">Câu hỏi trắc
                            nghiệm({{ $countZero }})</a>
                        <a href="{{ route('getAllQuestionsOne',['id_exam'=>$exam->id_exam]) }}"
                           class="btn btnSmall @if($type == 1) btnGreen clwhite  @else btnNoGreen @endif ">Câu hỏi đúng
                            sai({{ $countOne }})</a>
                        <a href="{{ route('getAllQuestionsTwo',['id_exam'=>$exam->id_exam]) }}"
                           class="btn btnSmall @if($type == 2) btnGreen clwhite  @else btnNoGreen @endif ">Câu hỏi tự
                            luận({{ $countTwo }})</a>
    ...
    <section class="ListQuestionExam" id="ListQuestionExam">
        <div class="container">
            <form role="form" action="{{ route('site_question.store') }}" method="POST" id=""
                  class="formQuestion">
                {!! csrf_field() !!}
                {{ method_field('POST') }}
                {{--cau hoi trac nghiem--}}
                        ...
                        <div class="col-lg-6">
                            <div class="addQuestionZelo">
                                <div class="form-group">
                                    ...
                                    <textarea rows="10" cols="50" name="name_ques" class="editor w checkeditor"
                                              id="addzero" required>
                                        {!!  old('name_ques') !!}
                                    </textarea>
                                    ...
                                    <div class="form-group mgTop5">
                                        ...
                                        <label class="mgRight10 w100">
                                            <input type="radio" name="show_answer_ques" class="flat-red"
                                                   value="0" @if(old('show_answer_ques') == 0) checked
                                                   @else checked @endif >
                                        ...
                                        <label class="mgRight10 w100">
                                            <input type="radio" name="show_answer_ques" class="flat-red" value="1"
                                                   @if(old('show_answer_ques') == 1) checked @endif>
                                    ...
                                    <div class="form-group mgBottom0">
                                        ...
                                        <label class="mgRight10">
                                            <input type="radio" name="correct_answer" class="flat-red"
                                                   value="answer1" @if(old('correct_answer') == 'answer1') checked
                                                   @else checked @endif>
                                            <!--  <input type="radio" name="r1" checked="checked"> -->
                                            <span>Đáp án A </span>
                                        </label>
                                        <label class="mgRight10">
                                            <input type="radio" name="correct_answer" class="flat-red"
                                                   value="answer2"
                                                   @if(old('correct_answer') == 'answer2') checked @endif>
                                            <span>Đáp án B </span>
                                        </label>
                                        <label class="mgRight10">
                                            <input type="radio" name="correct_answer" class="flat-red"
                                                   value="answer3"
                                                   @if(old('correct_answer') == 'answer3') checked @endif>
                                            <span>Đáp án C </span>
                                        </label>
                                        <label class="mgRight10">
                                            <input type="radio" name="correct_answer" class="flat-red"
                                                   value="answer4"
                                                   @if(old('correct_answer') == 'answer4') checked @endif>
                                            <span>Đáp án D </span>
                                        </label>
                                    </div>
                            ...
                            <div class="addQuestionZelo">
                                <div class="form-group  mgBottom0 pdTop0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="8" cols="50" name="correct_answer" class="w100 pd10"></textarea>
                                    </div>
