                    ...
                    <div class="bg-white pd15">
                        ...
                        <div class="mgBottom10">
                            ...
                            <a href="{{ route('getAllQuestionsOne',['id_exam'=>$exam->id_exam]) }}"
                               class="btn btnSmall btnGreen clwhite ">Câu hỏi đúng sai({{ $countOne }})</a>
                        ...
                        @endif
                         ...
                         @if($checklever == 0)
                        <a href="{{ route('createQuestion',['id_exam' => $exam->id_exam]) }}?type=1"
                                    ...
                                    @foreach($question_1 as $id1 => $question1)
                                     ...
                                     Câu hỏi {{ $id1 + 1 }}
                                                ...
                                                <a href="{{ route('editQuestion',['id_ques' => $question1['id_ques'] ]) }}"
                                                   class="edit_question" title="Sửa câu hỏi"><i class="fa fa-edit"></i></a>
