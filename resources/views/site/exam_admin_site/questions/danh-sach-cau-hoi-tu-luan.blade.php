                    ...
                    <div class="bg-white pd15">
                        ...
                        <div class="mgBottom10">
                            <a href="{{ route('getAllQuestionsZero',['id_exam'=>$exam->id_exam]) }}"
                               class="btn btnSmall btnNoGreen">Câu hỏi trắc nghiệm({{ $countZero }})</a>
                            ...
                            <a href="{{ route('getAllQuestionsTwo',['id_exam'=>$exam->id_exam]) }}"
                               class="btn btnSmall btnGreen clwhite ">Câu hỏi tự luận({{ $countTwo }})</a>
                        </div>
                        ...
                        @if($checklever == 0)
                        <a href="{{ route('createQuestion',['id_exam' => $exam->id_exam]) }}?type=2"
