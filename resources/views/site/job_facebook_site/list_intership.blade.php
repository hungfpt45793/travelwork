                            ...
                            <div class="link_breakcrum mbdsNone">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item pd8">
                                        <a href="{{ $link_url }}">Danh sách hồ sơ thực tậ</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="contentJobsInteresting pdl15 pdr15 col-f14">
                            <div class="row">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 150px;vertical-align: inherit;">
                                                                @if(!empty($inter->des_time))
                                                                    @endif
                                                                    <a class="btnOrange" data-toggle="modal" data-target="#show_time{{$id_inter}}" style="padding: 4px 7px">
                                                                        Xem chi tiết
                                                                    </a>
                                                            ...
                                                            <td style="width: 120px;vertical-align: inherit;">
                                                                <div class="EditDelete">
                                                                    <a href="{{ route('detail_employee_show',['employee_slug'=>$inter['employee_slug']]) }}" target="_blank"
                                                                       title="Xem hồ sơ"
                                ...
                                <div class="col-12 text-center">
                                    @include('site.default.item_pani',['page_link' => $intership])
                                </div>
                            </div>
                        </div>
                    </section>
