...
@section('title', 'Danh sách đơn hàng khiếu nại')
...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Danh sách đơn hàng khiếu nại</a></li>
        </ol>
    </section>
                    ...
                    <div class="box-body">
                        <table id="jobs" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>4.000.000</td>
                                <td>3.000.000</td>
                                <td>bên tuyển dụng khác trêu</td>
                                <td class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#">Xóa</a></li>
                                        <li><a href="#">chuyển đơn hàng trùng</a></li>
                                    </ul>
                                </td>
                            </tr>
                            </tbody>
