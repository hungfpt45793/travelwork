...
_.initUploadButton = function() {
    ...
    $('#toolbar').prepend('<div id="upload" style="top:' + top + 'px;width:' + width + 'px;height:' + height + 'px"><form enctype="multipart/form-data" id="uploadImagekcfinder" method="post" target="uploadResponse" action="' + _.getURL('upload') + '"><input type="file" name="upload[]" onchange="_.uploadFile();" style="height:' + height + 'px" multiple="multiple" /><input type="hidden" name="dir" value="" /></form></div>');
...
_.uploadFile = function() {
	var form = document.getElementById('uploadImagekcfinder');
    if (!_.dirWritable) {
