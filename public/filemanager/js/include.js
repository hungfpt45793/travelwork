...
!function (e, a, r) {
    ...
    var k = "9.12.1", C = !0, T = null, I = null, S = function () {
        var e = 0;
        return function (a, r) {
        ...
        contextActions: {
            copy_url: function (e) {
                ...
                var a, r = U(e), t = jQuery("#field_id").val(), n = jQuery("#return_relative_url").val();
            ...
            jQuery("#filter-input").on("keyup", function () {
                ...
                jQuery(this).val(r), a && S(function () {
                ...
                var e = _(jQuery("#filter-input").val()), a = jQuery("#current_url").val();
            ...
            jQuery("#fileupload").fileupload({
                ...
                a.formData = {fldr: jQuery("#sub_folder").val() + jQuery("#fldr_value").val() + a.files[0].relativePath}
            ...
            jQuery("#uploadURL").on("click", function (a) {
                a.preventDefault();
                var r = jQuery("#url").val(), t = jQuery("#fldr_value").val();
                show_animation(), e.ajax({type: "POST", url: "upload.php", data: {fldr: t, url: r}}).done(function (e) {
    ...
    jQuery(document).ready(function () {
        if (C && R.makeContextMenu(), "undefined" != typeof Storage && 1 != jQuery("#type_param").val() && 3 != jQuery("#type_param").val()) {
        ...
        if (jQuery("#full-img").on("click", function () {
            ...
            }), R.bindGridEvents(), parseInt(jQuery("#file_number").val()) > parseInt(jQuery("#file_number_limit_js").val()))var o = !1; else var o = !0;
        if (R.makeSort(o), R.makeFilters(o), R.uploadURL(), jQuery("#info").on("click", function () {
                ...
                l()
            }), R.makeUploader(), jQuery("body").on("keypress", function (e) {
        ...
        }), T = new LazyLoad, I = new Clipboard(".btn")
        ...
        var n = jQuery("#callback").val(), i = jQuery("#cur_dir").val(),
            l = (jQuery("#subdir").val(), jQuery("#base_url").val()), o = a.substr(0, a.lastIndexOf(".")),
            u = a.split(".").pop();
        u = u.toLowerCase();
        var c = "", s = ["ogg", "mp3", "wav"], d = ["mp4", "ogg", "webm"];
        if (1 == jQuery("#ftp").val())var f = encodeURL(jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val() + a); else var p = jQuery("#return_relative_url").val(),
            f = encodeURL((1 == p ? i : l + i) + a);
        if ("" != r)if (1 == jQuery("#crossdomain").val()) t.postMessage({
            sender: "responsivefilemanager",
            url: f,
            field_id: r
        }, "*"); else {
            var y = jQuery("#" + r, t.document);
            y.val(f).trigger("change"), 0 == n ? "function" == typeof t.responsive_filemanager_callback && t.responsive_filemanager_callback(r) : "function" == typeof t[n] && t[n](r), Q()
        } else e.inArray(u, ext_img) > -1 ? (f = f + "?" + (new Date).getTime(), c = '<img src="' + f + '" alt="' + o + '" />') : e.inArray(u, d) > -1 ? c = '<video controls source src="' + f + '" type="video/' + u + '">' + o + "</video>" : e.inArray(u, s) > -1 ? ("mp3" == u && (u = "mpeg"), c = '<audio controls src="' + f + '" type="audio/' + u + '">' + o + "</audio>") : c = '<a href="' + f + '" title="' + o + '">' + o + "</a>", 1 == jQuery("#crossdomain").val() ? t.postMessage({
            sender: "responsivefilemanager",
            url: f,
            field_id: null,
            html: c
