...
(function (factory) {
    ...
    var Comments = {
        ...
        showMainCommentingField: function(ev) {
            ...
            if (!$(".formCommentEmail")[0]){
                mainTextarea.parent().prepend('<input type="email" class="formComment formCommentEmail" value="" placeholder="Email" required/>');
            }

            if (!$(".formCommentPhone")[0]){
                mainTextarea.parent().prepend('<input type="number" class="formComment formCommentPhone" value="" placeholder="Số điện thoại" required/>');
            }
            if (!$(".formCommentName")[0]){
                mainTextarea.parent().prepend('<input type="text" class="formComment formCommentName" value="" placeholder="Họ và tên" required/>');
            }
        ...
        postComment: function(ev) {
            ...
            var textarea = commentingField.find('.textarea');
            var email = commentingField.find('input[type=email]').val();
            var name = commentingField.find('input[type=text]').val();
            var phone = commentingField.find('input[type=number]').val();
            ...
            // Create comment JSON
            var commentJSON = this.createCommentJSON(textarea, name, phone, email);
        ...
        createCommentJSON: function(textarea, name = "", phone = "", email = "") {
